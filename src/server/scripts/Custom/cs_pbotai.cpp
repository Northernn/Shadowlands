...
//                msg << "Casting spell " << pCurrentSpell->m_spellInfo->Id << ", Target " << pCurrentSpell->m_targets.GetUnitTargetGUID().GetCounter() << ".";
...
//
//        std::ostringstream msg;
//        msg << "Has diminishing index " << i << " - LV " << diminiLevel << ".";
//        handler->SendSysMessage(msg.str().c_str());
//	}
...
//	{
//        std::ostringstream msg;
//        msg << "Search GO entry " << pGameObject->GetEntry() << ".";
//        handler->SendSysMessage(msg.str().c_str());
//	}
