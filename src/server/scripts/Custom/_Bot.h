...
//#include "../game/Handlers/LoginQueryHolder.h"
//
//class Object;
//class WorldPacket;
//class WorldSession;
...
//		void HandlePlayerBotLogin(CharacterQueryHolder* holder);
