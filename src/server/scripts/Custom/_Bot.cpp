...
//	QueryResult result;
//
//	if (result = WorldDatabase.PQuery("SELECT Account_ID FROM dummy"))
//	{
//		do
//		{
...
//	}
//
//	if (result = WorldDatabase.PQuery("SELECT Map_ID, X_coordinates, y_coordinates, Z_coordinates, O_coordinates FROM dummy"))
//	{
//		do
//		{
