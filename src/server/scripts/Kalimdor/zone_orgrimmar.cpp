...
class npc_thrallmar_mage_150131 : public ScriptedAI
{
public:
    npc_thrallmar_mage_150131(Creature* creature) : ScriptedAI(creature) { }
    ...
    {
        if (player->HasQuest(QUEST_TO_OUTLAND))
        {
            player->ForceCompleteQuest(QUEST_TO_OUTLAND);
            player->TeleportTo(530, -239.702f, 1025.526f, 54.324f, 1.725f);
        }
        return true;
    }
};
...
void AddSC_orgrimmar()
{
    ...
    RegisterCreatureAI(npc_thrallmar_mage_150131);
}
