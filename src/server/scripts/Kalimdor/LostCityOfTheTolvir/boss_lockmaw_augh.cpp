...
public:
    ...
    struct boss_lockmawAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* /*pWho*/) override
        {
            ...
            events.ScheduleEvent(EVENT_START_DUST_FLAIL, 8s);
            events.ScheduleEvent(EVENT_VISCOUS_POISON, 3s);
            events.ScheduleEvent(EVENT_SUMMON_CROCOLISK, 15s);
        }
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_START_DUST_FLAIL:
                        ...
                        events.ScheduleEvent(EVENT_START_DUST_FLAIL, 20s);
                        break;
                    case EVENT_VISCOUS_POISON:
                        {
                            ...
                            events.ScheduleEvent(EVENT_VISCOUS_POISON, 7s);
                        }
                        break;
                    case EVENT_SUMMON_CROCOLISK:
                        {
                            events.ScheduleEvent(EVENT_SUMMON_RANDOM_AUGH_1, 1s);
                    ...
                    case EVENT_SUMMON_RANDOM_AUGH_1:
                        events.ScheduleEvent(EVENT_SUMMON_RANDOM_AUGH_2, 20s);
                        SummonAugh();
                        break;
                    case EVENT_SUMMON_RANDOM_AUGH_2:
                        events.ScheduleEvent(EVENT_SUMMON_CROCOLISK, 17s);
                        SummonAugh();
                        break;
                }
            }
...
public:
    ...
    struct npc_frenzied_crocAI : public ScriptedAI
    {
        npc_frenzied_crocAI(Creature* creature) : ScriptedAI(creature)
        {
            ...
            events.ScheduleEvent(EVENT_VICIOUS_CROC_UPDATE_THREAT, 1s);
            events.ScheduleEvent(EVENT_VICIOUS_CROC_VICIOUS_BITE, 7s);
...
public:
    ...
    struct boss_aughAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* /*pWho*/) override
        {
            ...
            events.ScheduleEvent(EVENT_WHITLWIND, 7s);
            events.ScheduleEvent(EVENT_BLOW_DART, 7s);
            events.ScheduleEvent(EVENT_DRAGONS_BREATH, 7s);
            events.ScheduleEvent(EVENT_SMOKE_BOMB,6s);
            events.ScheduleEvent(EVENT_SAY_AAA, 19s);
        }
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_WHITLWIND:
                    {
                        ...
                        me->AddAura(91408, me);
                        events.ScheduleEvent(EVENT_WHITLWIND, 22s);
                        break;
                    }
                    case EVENT_BLOW_DART:
                        if (SelectTarget(SelectTargetMethod::Random, 0, 100.0f, true))
                            me->CastSpell(me->GetVictim(), SPELL_PARALYTIC_BLOW_DART, false);

                        events.ScheduleEvent(EVENT_BLOW_DART, 8s);
                        break;
                    ...
                    case EVENT_SMOKE_BOMB:
                        me->CastSpell(me, SPELL_SMOKE_BOMB, false);
                        events.ScheduleEvent(EVENT_SMOKE_BOMB, 9s);
                        break;
                    case EVENT_SAY_AAA:
                        Talk(AUGH_SAY_AAA);
                        events.ScheduleEvent(EVENT_SAY_AAA, 22s);
                        break;
                }
            }
