    ...
    public:
        ...
        struct boss_hagara_the_stormbinderAI : public BossAI
        {
            ...
            void Reset() override
            {
                ...
                if (instance->GetData(DATA_HAGARA_EVENT) != DONE)
                {
                  ...
                  //  me->SummonGameObject(GO_THE_FOCUSING_IRIS, centerPos.GetPositionX(), centerPos.GetPositionY(), centerPos.GetPositionZ(), 0.f, QuaternionData(), WEEK);
                }
                else
                {
                    bEventDone = true;
            ...
            void JustEngagedWith(Unit* /*who*/) override
            {
                ...
                events.ScheduleEvent(EVENT_BERSERK, 8s);
                if (urand(0, 1))
                {
                ...
                events.ScheduleEvent(EVENT_SHATTERED_ICE, 12s);
            ...
            void DoAction(const int32 action) override
            {
                if (action == ACTION_START_EVENT && !bEvent && !bEventDone)
                {
                    ...
                    events.ScheduleEvent(EVENT_SUMMON_ADDS_1, 3s);
                }
                ...
                switch (phase)
                {
                    case 1:
                        if (summonCount <= 1)
                        {
                            ...
                            events.ScheduleEvent(EVENT_SUMMON_ADDS_4, 3s);
                        }
                        else
                            summonCount--;
                        break;
                    case 2:
                        if (summonCount <= 1)
                        {
                            summonCount = 0;
                            summons.DespawnEntry(NPC_HAGARA_TRASH_TWILIGHT_PORTAL);
                            events.ScheduleEvent(EVENT_SUMMON_ADDS_5, 3s);
                        }
                        else
                            summonCount--;
                        break;
                    case 3:
                        if (summonCount <= 1)
                        {
                            summonCount = 0;
                            summons.DespawnEntry(NPC_HAGARA_TRASH_TWILIGHT_PORTAL);
                            events.ScheduleEvent(EVENT_SUMMON_ADDS_6, 3s);
                        }
                        else
                            summonCount--;
                        break;
                    case 4:
                        ...
                        {
                            summonCount = 0;
                            events.ScheduleEvent(EVENT_SUMMON_ADDS_7, 3s);
                        }
                        else
                            summonCount--;
                        break;
                    case 5:
                        if (summonCount <= 1)
                        {
                            ...
                            summonCount = 0;
                            summons.DespawnEntry(NPC_HAGARA_TRASH_TWILIGHT_PORTAL);
                            events.ScheduleEvent(EVENT_SUMMON_ADDS_8, 3s);
                        }
                    default:
                        break;
                }
                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_SUMMON_ADDS_1:
                            Talk(SAY_ADDS_1);
                            events.ScheduleEvent(EVENT_SUMMON_ADDS_2, 7s);
                            break;
                        case EVENT_SUMMON_ADDS_2:
                            me->SummonCreature(NPC_HAGARA_TRASH_TWILIGHT_PORTAL, portalPos[1]);
                            events.ScheduleEvent(EVENT_SUMMON_ADDS_3, 3s);
                            break;
                        case EVENT_SUMMON_ADDS_3:
                            phase = 1;
                            summonCount = 4;
                            me->SummonCreature(NPC_TWILIGHT_FROST_EVOKER, portalPos[1].GetPositionX(), portalPos[1].GetPositionY() + 4.0f, portalPos[1].GetPositionZ() + 1.0f, portalPos[1].GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);
                            me->SummonCreature(NPC_STORMBORN_MYRMIDON, portalPos[1].GetPositionX(), portalPos[1].GetPositionY() + 2.0f, portalPos[1].GetPositionZ() + 1.0f, portalPos[1].GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);
                            me->SummonCreature(NPC_STORMBORN_MYRMIDON, portalPos[1].GetPositionX(), portalPos[1].GetPositionY() - 2.0f, portalPos[1].GetPositionZ() + 1.0f, portalPos[1].GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);
                            me->SummonCreature(NPC_TWILIGHT_FROST_EVOKER, portalPos[1].GetPositionX(), portalPos[1].GetPositionY() - 4.0f, portalPos[1].GetPositionZ() + 1.0f, portalPos[1].GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);
                            break;
                        case EVENT_SUMMON_ADDS_4:
                            ...
                            me->SummonCreature(NPC_STORMBINDER_ADEPT, portalPos[0], TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);
                            for (uint8 i = 0; i < 5; ++i)
                                me->SummonCreature(NPC_CORRUPTED_FRAGMENT, portalPos[0].GetPositionX()+ frand(-2.0f, 2.0f), portalPos[0].GetPositionY() + frand(-2.0f, 2.0f), portalPos[0].GetPositionZ() + 1.0f, portalPos[0].GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);

                            me->SummonCreature(NPC_HAGARA_TRASH_TWILIGHT_PORTAL, portalPos[2]);
                            me->SummonCreature(NPC_STORMBINDER_ADEPT, portalPos[2], TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);
                            for (uint8 i = 0; i < 5; ++i)
                                me->SummonCreature(NPC_CORRUPTED_FRAGMENT, portalPos[2].GetPositionX()+ frand(-2.0f, 2.0f), portalPos[2].GetPositionY() + frand(-2.0f, 2.0f), portalPos[2].GetPositionZ() + 1.0f, portalPos[2].GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);
                            break;
                        case EVENT_SUMMON_ADDS_5:
                            ...
                            me->SummonCreature(NPC_HAGARA_TRASH_TWILIGHT_PORTAL, portalPos[0]);
                            me->SummonCreature(NPC_STORMBINDER_ADEPT, portalPos[0], TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);
                            me->SummonCreature(NPC_TWILIGHT_FROST_EVOKER, portalPos[0].GetPositionX(), portalPos[0].GetPositionY() + 4.0f, portalPos[0].GetPositionZ() + 1.0f, portalPos[0].GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);
                            me->SummonCreature(NPC_STORMBORN_MYRMIDON, portalPos[0].GetPositionX(), portalPos[0].GetPositionY() + 2.0f, portalPos[0].GetPositionZ() + 1.0f, portalPos[0].GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);

                            me->SummonCreature(NPC_HAGARA_TRASH_TWILIGHT_PORTAL, portalPos[2], TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);
                            me->SummonCreature(NPC_STORMBINDER_ADEPT, portalPos[2]);
                            me->SummonCreature(NPC_TWILIGHT_FROST_EVOKER, portalPos[2].GetPositionX(), portalPos[2].GetPositionY() - 4.0f, portalPos[2].GetPositionZ() + 1.0f, portalPos[2].GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);
                            me->SummonCreature(NPC_STORMBORN_MYRMIDON, portalPos[2].GetPositionX(), portalPos[2].GetPositionY() - 2.0f, portalPos[2].GetPositionZ() + 1.0f, portalPos[2].GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);
                            break;
                        case EVENT_SUMMON_ADDS_6:
                            ...
                            for (uint8 i = 0; i < 10; ++i)
                                me->SummonCreature(NPC_CORRUPTED_FRAGMENT, portalPos[1].GetPositionX()+ frand(-2.0f, 2.0f), portalPos[1].GetPositionY() + frand(-2.0f, 2.0f), portalPos[1].GetPositionZ() + 1.0f, portalPos[1].GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);
                            break;
                        case EVENT_SUMMON_ADDS_7:
                            Talk(SAY_ADDS_4);
                            phase = 5;
                            summonCount = 1;
                            me->SummonCreature(NPC_LIEUTENANT_SHARA, portalPos[1], TEMPSUMMON_CORPSE_TIMED_DESPAWN, 3s);
                            break;
                        ...
                        {
                            Unit* pTarget = NULL;
                            pTarget = SelectTarget(SelectTargetMethod::Random, 1, 0.0f, true);
                            if (!pTarget)
                                pTarget = SelectTarget(SelectTargetMethod::Random, 0, 0.0f, true);

                            if (pTarget)
                                DoCast(pTarget, SPELL_SHATTERED_ICE);

                            events.ScheduleEvent(EVENT_SHATTERED_ICE, 10s);
                            break;
                        }
                        ...
                        {
                            UnitList targets;
                          //  SelectTargetList(targets, 3, SelectTargetMethod::MinDistance, 0.0f, true);
                            if (targets.empty())
                                break;
                        ...
                        case EVENT_FROZEN_TEMPEST_1:
                            ...
                            events.ScheduleEvent(EVENT_FROZEN_TEMPEST_2, 2s);
                            break;
                        case EVENT_FROZEN_TEMPEST_2:
                            ...
                            events.ScheduleEvent(EVENT_END_SPECIAL_PHASE, 30s);
                            if (IsHeroic())
                                events.ScheduleEvent(EVENT_FROSTFLAKE, 3s);
                            break;
                        ...
                        {
                            UnitList targets;
                         //   SelectTargetList(targets, RAID_MODE(3, 7), SelectTargetMethod::Random, 0.0f, true);
                            if (!targets.empty())
                                for (UnitList::const_iterator itr = targets.begin(); itr != targets.end(); ++itr)
                                    DoCast((*itr), SPELL_ICICLE, true);
                            events.ScheduleEvent(EVENT_ICICLE, 8s);
                            break;
                        }
                        case EVENT_FROSTFLAKE:
                            DoCastAOE(SPELL_FROSTFLAKE, true);
                            events.ScheduleEvent(EVENT_FROSTFLAKE, 11s);
                            break;
                        case EVENT_ELECTRICAL_STORM_1:
                            ...
                            me->AttackStop();
                            me->NearTeleportTo(centerPos.GetPositionX(), centerPos.GetPositionY(), centerPos.GetPositionZ(), centerPos.GetOrientation());
                            events.ScheduleEvent(EVENT_ELECTRICAL_STORM_2, 2s);
                            break;
                        ...
                        case EVENT_STORM_PILLARS:
                            ...
                            events.ScheduleEvent(EVENT_STORM_PILLARS, 8s);
                            break;
        ...
        private:
            ...
            void SpecialPhaseEnd()
            {
                ...
                events.ScheduleEvent(EVENT_ICY_TOMB, 20s);
                events.ScheduleEvent(EVENT_FOCUSED_ASSAULT, 15s);
                events.ScheduleEvent(EVENT_SHATTERED_ICE, 25s);

                if (phase == 10)
                {
                    events.ScheduleEvent(EVENT_FROZEN_TEMPEST_1, 6s);
...
class npc_hagara_the_stormbinder_stormborn_myrmidon : public CreatureScript
{
    public:
        ...
        struct npc_hagara_the_stormbinder_stormborn_myrmidonAI : public ScriptedAI
        {
            ...
            void JustEngagedWith(Unit* /*who*/) override
            {
                events.ScheduleEvent(EVENT_SPARK, 5s);
                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_SPARK:
                            ...
                            events.ScheduleEvent(EVENT_SPARK, 7s);
                            break;
                        case EVENT_CHAIN_LIGHTNING:
                            if (Unit* pTarget = SelectTarget(SelectTargetMethod::Random, 0, 0.0f, true))
                                DoCast(pTarget, SPELL_CHAIN_LIGHTNING);
                            events.ScheduleEvent(EVENT_CHAIN_LIGHTNING,  7s);
                            break;
                        default:
                            break;
                    }
...
class npc_hagara_the_stormbinder_stormbinder_adept : public CreatureScript
{
    public:
        ...
        struct npc_hagara_the_stormbinder_stormbinder_adeptAI : public ScriptedAI
        {
            ...
            void JustEngagedWith(Unit* /*who*/) override
            {
                events.ScheduleEvent(EVENT_TORNADO, 15s);
            }
...
class npc_hagara_the_stormbinder_tornado_stalker : public CreatureScript
{
    public:
        ...
        {
            npc_hagara_the_stormbinder_tornado_stalkerAI(Creature* pCreature) : ScriptedAI(pCreature)
            {
                me->SetReactState(REACT_PASSIVE);
            }
            ...
            void IsSummonedBy(WorldObject* /*owner*/) override
            {
                ...
                events.ScheduleEvent(EVENT_TORNADO, 3s);
            }
...
class npc_hagara_the_stormbinder_twilight_frost_evoker : public CreatureScript
{
    public:
        ...
        struct npc_hagara_the_stormbinder_twilight_frost_evokerAI : public ScriptedAI
        {
            ...
            void JustEngagedWith(Unit* /*who*/) override
            {
                events.ScheduleEvent(EVENT_FROST_BOLT, 1s);
                events.ScheduleEvent(EVENT_BLIZZARD, 15s);
                events.ScheduleEvent(EVENT_SHACKLES_OF_ICE, 15s);
            }
                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_FROST_BOLT:
                            ...
                            events.ScheduleEvent(EVENT_FROST_BOLT, 16s);
                            break;
                        case EVENT_BLIZZARD:
                        {
                            Unit* pTarget = NULL;
                            pTarget = SelectTarget(SelectTargetMethod::Random, 0, 20.0f, true);
                            if (!pTarget)
                                return;

                                DoCast(pTarget, SPELL_BLIZZARD);

                            events.ScheduleEvent(EVENT_BLIZZARD, 16s);
                            break;
                        }
                        case EVENT_SHACKLES_OF_ICE:
                        {
                            ...
                            events.ScheduleEvent(EVENT_SHACKLES_OF_ICE, 12s);
                            break;
                        }
                        default:
                            break;
...
class npc_hagara_the_stormbinder_lieutenant_shara : public CreatureScript
{
    public:
        ...
        struct npc_hagara_the_stormbinder_lieutenant_sharaAI : public ScriptedAI
        {
            ...
            void JustEngagedWith(Unit* /*who*/) override
            {
                events.ScheduleEvent(EVENT_SHATTER,  6s);
                events.ScheduleEvent(EVENT_FROST_CORRUPTION, 3s);
                events.ScheduleEvent(EVENT_FROZEN_GRASP, 8s);
            }
                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_SHATTER:
                            ...
                            events.ScheduleEvent(EVENT_SHATTER, 13s);
                            break;
                        case EVENT_FROST_CORRUPTION:
                            if (Unit* pTarget = SelectTarget(SelectTargetMethod::Random, 0, 0.0f, true))
                                DoCast(pTarget, SPELL_FROST_CORRUPTION);
                            events.ScheduleEvent(EVENT_FROST_CORRUPTION, 15s);
                            break;
                        case EVENT_FROZEN_GRASP:
                            if (Unit* pTarget = SelectTarget(SelectTargetMethod::MaxDistance, 0, 0.0f, true))
                                DoCast(pTarget, SPELL_FROZEN_GRASP);
                            events.ScheduleEvent(EVENT_FROZEN_GRASP, 31s);
                            break;
                        default:
                            break;
                    }
...
class npc_hagara_the_stormbinder_collapsing_icicle : public CreatureScript
{
    public:
        ...
        struct npc_hagara_the_stormbinder_collapsing_icicleAI : public ScriptedAI
        {
            ...
            void IsSummonedBy(WorldObject* /*owner*/) override
            {
                events.ScheduleEvent(EVENT_ICICLE, 6s);
            }
...
class npc_hagara_the_stormbinder_crystal_conductor : public CreatureScript
{
    public:
        ...
        struct npc_hagara_the_stormbinder_crystal_conductorAI : public ScriptedAI
        {
            ...
            void SpellHit(WorldObject* /*who*/, const SpellInfo* spellInfo) override
            {
...
struct go_hagara_the_stormbinder_the_focusing_iris : public GameObjectAI
{
        go_hagara_the_stormbinder_the_focusing_iris(GameObject* go) : GameObjectAI(go) { }
        ...
        bool OnGossipHello(Player* /*pPlayer*/) override
        {
            if (InstanceScript* pInstance = me->GetInstanceScript())
            {
                ...
                {
                    pInstance->DoNearTeleportPlayers(teleportPos[0], false);
                    return true;
                }
...
class spell_hagara_the_stormbinder_ice_lance_target : public SpellScriptLoader
{
    public:
        ...
        class spell_hagara_the_stormbinder_ice_lance_target_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_hagara_the_stormbinder_ice_lance_target_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_CONE_ENEMY_24);
...
void AddSC_boss_hagara_the_stormbinder()
{
    ...
    RegisterGameObjectAI(go_hagara_the_stormbinder_the_focusing_iris);
