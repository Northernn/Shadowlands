    ...
    public:
        ...
        struct boss_madness_of_deathwingAI : public BossAI
        {
            ...
            void IsSummonedBy(WorldObject* /*owner*/) override
            {
                ...
                events.ScheduleEvent(EVENT_SPAWN_LIMBS_1, 1s);
                events.ScheduleEvent(EVENT_BERSERK, 90s);
            }
            ...
            void SetData(uint32 type, uint32 data) override
            {
                if (type == DATA_ASSAULT_PLATFORM)
                {
                    ...
                    events.ScheduleEvent(EVENT_ASSAULT_ASPECTS_1, 5s);
                }
            ...
            void SpellHit(WorldObject* /*who*/, const SpellInfo* spellInfo) override
            {
                if (spellInfo->Id == SPELL_AGONIZING_PAIN)
                {
                        ...
                        (m_destroyed_platform & (1 << 4)) > 0)
                    {
                        ...
                        events.ScheduleEvent(EVENT_SLUMP, 7s);
                        Talk(SAY_DEATHWING_PHASE);
                    }
                    else
                        events.ScheduleEvent(EVENT_ASSAULT_ASPECTS, 7s);
                }
                else if (spellInfo->Id == SPELL_FIRE_DRAGON_SOUL_SCRIPT)
                {
                    ...
                    events.ScheduleEvent(EVENT_FINISH, 6s);
                }
            }
                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_SPAWN_LIMBS_1:
                            ...
                            events.ScheduleEvent(EVENT_SPAWN_LIMBS_2, 1s);
                            break;
                        case EVENT_SPAWN_LIMBS_2:
                            ...
                            events.ScheduleEvent(EVENT_SPAWN_LIMBS_3, 5s);
                            break;
                        case EVENT_SPAWN_LIMBS_3:
                            ...
                            events.ScheduleEvent(EVENT_ASSAULT_ASPECTS, 2s);
                            break;
                        ...
                        case EVENT_ASSAULT_ASPECTS_1:
                        {
                            ...
                            events.ScheduleEvent(EVENT_ELEMENTIUM_BOLT, m_isFirst ? (40s - 10s) : (55s - 10s));
                            events.ScheduleEvent(EVENT_CATACLYSM, m_isFirst ? (11s - 10s) : (13s - 10s));
                        ...
                        case EVENT_SLUMP:
                            ...
                            events.ScheduleEvent(EVENT_ASPECT_TALK_2, 10s);
                            events.ScheduleEvent(EVENT_TIME_ZONE_2, 1s);
                            break;
...
struct npc_dragon_soul_thrall_1 : public CreatureScript
{
        ...
        bool OnGossipHello(Player* pPlayer, Creature* pCreature)
        {
            ...
            if (InstanceScript* pInstance = pCreature->GetInstanceScript())
            {
                ...
                AddGossipItemFor(pPlayer, GossipOptionNpc::None, GOSSIP_OPTION_1, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
        ...
        //bool OnGossipSelect(Player* pPlayer, * pCreature, uint32 /*sender*/, uint32 action) override
        //{
        ...
        struct npc_dragon_soul_thrall_1AI : public ScriptedAI
        {
            ...
            void DoAction(const int32 action) override
            {
                ...
                else if (action == ACTION_END_BATTLE)
                {
                    ...
                    events.ScheduleEvent(EVENT_END_BATTLE, 2s);
            ...
            void UpdateAI(const uint32 diff) override
            {
                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    ...
                    else if (eventId == EVENT_END_BATTLE)
                    {
                        ...
                        events.ScheduleEvent(EVENT_DRAGON_SOUL, 1s);
                    }
...
class npc_madness_of_deathwing_mutated_corruption : public CreatureScript
{
    public:
        ...
        {
            npc_madness_of_deathwing_mutated_corruptionAI(Creature* pCreature) : ScriptedAI(pCreature)
            {
                me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_STUN, true);
            ...
            void JustEngagedWith(Unit* /*who*/) override
            {
                if (me->IsVisible())
                {
                    events.ScheduleEvent(EVENT_CRUSH, 12s);
                    events.ScheduleEvent(EVENT_IMPALE, 12s);
                    events.ScheduleEvent(EVENT_SELECT_VICTIM, 5s);
                }
            }
                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_CRUSH:
                            ...
                            events.ScheduleEvent(EVENT_CRUSH, 8s);
                            break;
                        case EVENT_IMPALE:
                        {
                            ...
                            {
                                Unit* pNearest = SelectTarget(SelectTargetMethod::MinDistance, 0, 0.0f, true);
                                if (pNearest)
                                    pTarget = pNearest;
                            }

                            DoCast(pTarget, SPELL_IMPALE);
                            events.ScheduleEvent(EVENT_IMPALE, 35s);
                            break;
                        }
                        case EVENT_SELECT_VICTIM:
                        {
                            ...
                            {
                                pNearest = SelectTarget(SelectTargetMethod::MinDistance, 0, 0.0f, true);
                            ...
                            events.ScheduleEvent(EVENT_SELECT_VICTIM, 2s);
                            break;
                        }
                    }
                }
...
class npc_madness_of_deathwing_crush_target : public CreatureScript
{
    public:
        ...
        {
            npc_madness_of_deathwing_crush_targetAI(Creature* pCreature) : ScriptedAI(pCreature)
            {
                me->SetReactState(REACT_PASSIVE);
            }
...
class npc_madness_of_deathwing_limb_tentacle : public CreatureScript
{
    public:
        ...
        {
            npc_madness_of_deathwing_limb_tentacleAI(Creature* pCreature) : ScriptedAI(pCreature)
            {
                me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_STUN, true);
            ...
            void DoAction(const int32 action) override
            {
                ...
                {
                    events.ScheduleEvent(EVENT_ASSAULT_ASPECTS, 1s);
                    events.ScheduleEvent(EVENT_UPDATE_HEALTH, 1s);
                    events.ScheduleEvent(EVENT_HEMORRHAGE, IsHeroic() ? (55s - 10s) : (85s - 10s));
                    if (IsHeroic())
                    {
                        events.ScheduleEvent(EVENT_CORRUPTING_PARASITE, 12s - 10s);
                        events.ScheduleEvent(EVENT_CORRUPTING_PARASITE, 72s - 10s);
                    }
                }
                else if (action == ACTION_ASSAULT_ASPECTS)
                {
                    events.ScheduleEvent(EVENT_ASSAULT_ASPECTS, 1s);
                    events.ScheduleEvent(EVENT_UPDATE_HEALTH, 1s);
                    events.ScheduleEvent(EVENT_HEMORRHAGE, IsHeroic() ? (70s - 10s) : (100s - 10s));
                    if (IsHeroic())
                    {
                        events.ScheduleEvent(EVENT_CORRUPTING_PARASITE, 22s - 10s);
                        events.ScheduleEvent(EVENT_CORRUPTING_PARASITE, 82s - 10s);
                    }
                }
            }
                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_HEMORRHAGE:
                            if (m_current_platform > 0)
                                me->SummonCreature(NPC_HEMORRHAGE_TARGET, hemorrhagePos[m_current_platform - 1], TEMPSUMMON_TIMED_DESPAWN, 10s);
                        ...
                        case EVENT_CORRUPTING_PARASITE:
                            //me->CastSpell(SPELL_CORRUPTING_PARASITE_AOE, SPELLVALUE_MAX_TARGETS, 1, NULL, true);
                            break;
                    }
                }
            }
...
class npc_madness_of_deathwing_blistering_tentacle : public CreatureScript
{
    public:
        ...
        {
            npc_madness_of_deathwing_blistering_tentacleAI(Creature* pCreature) : ScriptedAI(pCreature)
            {
                me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_STUN, true);
        ...
        struct npc_madness_of_deathwing_corrupting_parasiteAI : public ScriptedAI
        {
            ...
            void DoAction(const int32 action) override
            {
                if (action == ACTION_PARASITIC_BACKSLASH && !m_unstable)
                {
                    ...
                    events.ScheduleEvent(EVENT_UNSTABLE_CORRUPTION, 1s);
...
class npc_madness_of_deathwing_deathwing : public CreatureScript
{
    public:
        ...
        {
            npc_madness_of_deathwing_deathwingAI(Creature* pCreature) : ScriptedAI(pCreature)
            {
                me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_STUN, true);
            ...
            void DoAction(const int32 action) override
            {
                ...
                {
                    phase = 0;
                    events.ScheduleEvent(EVENT_UPDATE_HEALTH, 5s);
                    events.ScheduleEvent(EVENT_ELEMENTIUM_FRAGMENT, 10s);
                    events.ScheduleEvent(EVENT_ELEMENTIUM_TERROR, 35s);
                }
                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_ELEMENTIUM_FRAGMENT:
                        {
                            ...
                            events.ScheduleEvent(EVENT_ELEMENTIUM_FRAGMENT, 90s);
                            break;
                        }
                        case EVENT_ELEMENTIUM_TERROR:
                        {
                            ...
                            events.ScheduleEvent(EVENT_ELEMENTIUM_TERROR, 90s);
                            break;
                        }
                    }
                }
...
class npc_madness_of_deathwing_impaling_tentacle : public CreatureScript
{
    public:
        ...
        struct npc_madness_of_deathwing_impaling_tentacleAI : public ScriptedAI
        {
            npc_madness_of_deathwing_impaling_tentacleAI(Creature* pCreature) : ScriptedAI(pCreature)
            {
                me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_STUN, true);
            ...
            void SetGUID(ObjectGuid const& guid, int32 type) override
            {
                if (type == DATA_SHRAPNEL)
                {
                    ...
                    {
                        targetGuid = guid;
                        events.ScheduleEvent(EVENT_SHRAPNEL, 2s);
                    }
                }
            }
            void UpdateAI(const uint32 diff) override
...
class npc_madness_of_deathwing_elementium_terror : public CreatureScript
{
    public:
        ...
        struct npc_madness_of_deathwing_elementium_terrorAI : public ScriptedAI
        {
            ...
            void IsSummonedBy(WorldObject* /*owner*/) override
            {
                events.ScheduleEvent(EVENT_START_MOVE, 1s);
            }
            ...
            void MovementInform(uint32 type, uint32 data) override
            {
                if (type == POINT_MOTION_TYPE)
                    if (data == DATA_BLOOD_POINT)
                        events.ScheduleEvent(EVENT_CONGEALING_BLOOD_HEAL, 1s);
            }
...
class npc_dragon_soul_alexstrasza_dragon : public CreatureScript
{
    public:
        ...
        {
            npc_dragon_soul_alexstrasza_dragonAI(Creature* pCreature) : ScriptedAI(pCreature)
            {
                me->setActive(true);
                me->SetCanFly(true);
                me->SetDisableGravity(true);
            ...
            void DoAction(const int32 action) override
            {
                if (isActive && action == ACTION_CAUTERIZE)
                    events.ScheduleEvent(EVENT_CAUTERIZE, 2s);
                else if (isActive && action == ACTION_CAUTERIZE_PARASITE)
                    events.ScheduleEvent(EVENT_CAUTERIZE_PARASITE, 1s);
...
class npc_dragon_soul_nozdormu_dragon : public CreatureScript
{
    public:
        ...
        {
            npc_dragon_soul_nozdormu_dragonAI(Creature* pCreature) : ScriptedAI(pCreature), summons(me)
            {
                me->setActive(true);
                me->SetCanFly(true);
                me->SetDisableGravity(true);
            ...
            void DoAction(const int32 action) override
            {
                ...
                {
                    summons.DespawnEntry(NPC_TIME_ZONE);
                    events.ScheduleEvent(EVENT_TIME_ZONE, 5s);
                }
                else if (action == ACTION_TIME_ZONE_2)
                {
                    summons.DespawnEntry(NPC_TIME_ZONE);
                    events.ScheduleEvent(EVENT_TIME_ZONE_2, 5s);
                }
            }
                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_TIME_ZONE_2:
                            ...
                            events.ScheduleEvent(EVENT_TIME_ZONE_2, 30s);
                            break;
                    }
                }
            }
...
class npc_dragon_soul_ysera_dragon : public CreatureScript
{
    public:
        ...
        {
            npc_dragon_soul_ysera_dragonAI(Creature* pCreature) : ScriptedAI(pCreature)
            {
                me->setActive(true);
                me->SetCanFly(true);
                me->SetDisableGravity(true);
...
class npc_dragon_soul_kalecgos_dragon : public CreatureScript
{
    public:
        ...
        {
            npc_dragon_soul_kalecgos_dragonAI(Creature* pCreature) : ScriptedAI(pCreature)
            {
                me->setActive(true);
                me->SetCanFly(true);
                me->SetDisableGravity(true);
...
class npc_madness_of_deathwing_jump_pad : public CreatureScript
{
    public:
        ...
        {
            npc_madness_of_deathwing_jump_padAI(Creature* pCreature) : ScriptedAI(pCreature)
            {
                me->SetReactState(REACT_PASSIVE);
                checkTimer = 500;
                pos = 0;
        ...
        class spell_madness_of_deathwing_unstable_corruption_SpellScript : public SpellScript
        {
            ...
            void HandleCast()
            {
                ...
                if (Creature* pParasite = GetCaster()->ToCreature())
                    pParasite->DespawnOrUnsummon(2s);
            }
