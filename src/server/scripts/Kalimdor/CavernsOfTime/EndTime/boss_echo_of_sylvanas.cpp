    ...
    public:
        ...
        struct boss_echo_of_sylvanasAI : public BossAI
        {
            ...
            void JustEngagedWith(Unit* /*who*/) override
            {
                ...
                events.ScheduleEvent(EVENT_SHRIEK_HIGHBORNE, 8s);
                events.ScheduleEvent(EVENT_BLACK_ARROW, 5s);
                events.ScheduleEvent(EVENT_UNHOLY_SHOT,9s);
                events.ScheduleEvent(EVENT_TELEPORT, 40s);
                events.ScheduleEvent(EVENT_BLIGHTED_JUMP, 12s);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_TELEPORT:
                            ...
                            events.ScheduleEvent(EVENT_DEATH_GRIP, 2s);
                        ...
                        case EVENT_DEATH_GRIP:
                            ...
                            events.ScheduleEvent(EVENT_SACRIFICE, 33s);
                            break;
                        case EVENT_SACRIFICE:
                            ...
                            events.ScheduleEvent(EVENT_SHRIEK_HIGHBORNE, 8s);
                            events.ScheduleEvent(EVENT_BLACK_ARROW, 5s);
                            events.ScheduleEvent(EVENT_UNHOLY_SHOT, 4s);
                            events.ScheduleEvent(EVENT_TELEPORT, 40s);
                            break;
                        ...
                        case EVENT_BLACK_ARROW:
                            ...
                            events.ScheduleEvent(EVENT_BLIGHTED_ARROW,12s);
                            events.ScheduleEvent(EVENT_UNHOLY_SHOT, 13s);
                            break;
                        case EVENT_UNHOLY_SHOT:
                            ...
                            events.CancelEvent(EVENT_BLIGHTED_ARROW);
                            events.ScheduleEvent(EVENT_BLIGHTED_ARROW, 13s);
                            events.ScheduleEvent(EVENT_BLACK_ARROW, 15s);
                            break;
                        ...
                        case EVENT_BLIGHTED_ARROW:
                            events.CancelEvent(EVENT_UNHOLY_SHOT);
                            events.CancelEvent(EVENT_BLACK_ARROW);
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxDistance, 0, 100, true))
                            {
    ...
    public:
        ...
        struct mob_ghoul_summonerAI : public ScriptedAI
        {
            ...
            void IsSummonedBy(WorldObject* /*summoner*/) override
            {
                ...
                events.ScheduleEvent(EVENT_SUMMON_GHOUL, 10s);
                events.ScheduleEvent(EVENT_CALLING_SHADOWS, 7s);
                events.ScheduleEvent(EVENT_DESPAWN, 33s);
            }
    ...
    public:
        ...
        struct mob_risen_ghoulAI : public ScriptedAI
        {
            ...
            void IsSummonedBy(WorldObject* /*summoner*/) override
            {
                ...
                me->SetSpeed(MOVE_WALK, 0.4f);
                me->SetWalk(true);
                events.ScheduleEvent(EVENT_WRACKING_PAIN_LINK, 4s);
                events.ScheduleEvent(EVENT_DESPAWN, 33s);
                checkTimer = 5000;
                arc = float(M_PI);
                checkDistance = 50.0f;
    ...
    public:
        ...
        struct mob_blighted_arrowsAI : public ScriptedAI
        {
            ...
            void IsSummonedBy(WorldObject* /*summoner*/) override
            {
                ...
                events.ScheduleEvent(EVENT_EXPLODE, 5s);
                events.ScheduleEvent(EVENT_DESPAWN, 10s);
            }
