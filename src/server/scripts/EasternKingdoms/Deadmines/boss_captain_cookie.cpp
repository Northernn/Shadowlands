    ...
    public:
        ...
        struct boss_captain_cookieAI : public BossAI
        {
            ...
            void JustEngagedWith(Unit* who) override
            {
                ...
                events.RescheduleEvent(EVENT_MOVE, 1s);
            ...
            void MovementInform(uint32 type, uint32 data) override
            {
                if (type == POINT_MOTION_TYPE)
                    if (data == POINT_MOVE)
                        events.RescheduleEvent(EVENT_CAULDRON_1, 2s);
            }
                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_CAULDRON_1:
                            DoCastRandom(SPELL_CAULDRON, true);
                            events.RescheduleEvent(EVENT_CAULDRON_2, 2s);
                            break;
                        case EVENT_CAULDRON_2:
                            ...
                            events.RescheduleEvent(EVENT_THROW_FOOD, 3s);
                            break;
                        case EVENT_THROW_FOOD:
                            DoCastAOE(ThrowFoodSpells[urand(0, 11)]);
                            events.RescheduleEvent(EVENT_THROW_FOOD, 4s);
                            break;
                    }
                }
            }
