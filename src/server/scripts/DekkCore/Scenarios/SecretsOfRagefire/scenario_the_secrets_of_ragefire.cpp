...
class scenario_the_secrets_of_ragefire : public InstanceMapScript
{
public:
    scenario_the_secrets_of_ragefire() : InstanceMapScript(SORGF, 1131) { }

struct scenario_the_secrets_of_ragefire_InstanceScript : public InstanceScript
{
    scenario_the_secrets_of_ragefire_InstanceScript(InstanceMap* map) : InstanceScript(map)
    {
...
{
    return new scenario_the_secrets_of_ragefire_InstanceScript(map);
}
};
    ...
    struct ragefire_core_npc_patchAI : public ScriptedAI
    {
        ...
        void DoAction(const int32 action) override
        {
            ...
            case 2:
                ...
                break;
            case 3:
                events.ScheduleEvent(7, 1s);
                break;
            case 4:
                Talk(7);//73092
                events.ScheduleEvent(8, 10s);
                break;
            case 5:
                events.ScheduleEvent(9, 4s);
                break;
            case 6:
            ...
            case 9:
                ...
                events.ScheduleEvent(13, 2s);
                break;
            case 12:
                me->Say("These supply crates came from Orgrimmar. What is Garrosh planning to do with so many war supplies?", LANG_UNIVERSAL);
                break;
            case 13:
        ...
        void UpdateAI(const uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                {
                case 1:
                   me->Say("Newt, get that door open.", LANG_UNIVERSAL);
                    me->PlayOneShotAnimKitId(25); //point
                    if (Creature* c = me->FindNearestCreature(NPC_NEWT, 100.f))
                        c->GetAI()->DoAction(1);
                    break;
                case 2:
                    me->Say("Grit, Ticker and Volt, you three back her up.", LANG_UNIVERSAL);
                    if (Creature* c = me->FindNearestCreature(NPC_TICKER, 100.f))
                        c->GetAI()->DoAction(1);
                    break;
                case 3:
                    if (Player* p = me->SelectNearestPlayer(150.0f))//warning gms will trigger this
                        me->Say("Recruit $n, you're with me", LANG_UNIVERSAL);
                    events.ScheduleEvent(4, 3s);
                    break;
                case 4:
                    me->Say("We've tracked the recent disappearences in Durotar to this abandoned section of Ragefire.", LANG_UNIVERSAL);
                    events.ScheduleEvent(5, 4s);
                    break;
                case 5:
                    me->Say("It's our job to find out who's behind these abductions and put a stop to them.", LANG_UNIVERSAL);
                    events.ScheduleEvent(6, 4s);
                    break;
                case 6:
                    me->Say("Stay close.", LANG_UNIVERSAL);
                ...
                case 8:
                    ...
                    break;
                case 9:
                    me->Yell("Gob Squad, defend yourselves!", LANG_UNIVERSAL);
                    if (instance)
                        instance->SetData(me->GetEntry(), IN_PROGRESS);
                    break;
                case 10:
                    me->Yell("We arn't your enemy, Xorenth!", LANG_UNIVERSAL);
                    events.ScheduleEvent(11, 3s);
                    break;
                case 11:
                    ...
                    break;
                case 12:
                    me->Yell("We'll show you who's lesser!", LANG_UNIVERSAL);
                    break;
                case 13:
                    me->Say("This is bad.", LANG_UNIVERSAL);
                    events.ScheduleEvent(14, 2s);
                    break;
                case 14:
                    me->Say("All of you fan out and search the chamber. If Garrosh is behind this we're going to need proof.", LANG_UNIVERSAL); 
                    break;
                }
                if (UpdateVictim())
    ...
    struct ragefire_core_npc_newtAI : public ScriptedAI
    {
        ...
        void MovementInform(uint32 /*type*/, uint32 id)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                me->Say("The charges are all set; hit the detonator as soon as you're ready!", LANG_UNIVERSAL);
        ...
        void UpdateAI(const uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case 5://planting bombs TODO
                    break;
                case 6:
                    me->Say("I'm setting the last charge now, sir!", LANG_UNIVERSAL);
    ...
    struct ragefire_core_npc_tickerAI : public ScriptedAI
    {
        ...
        void MovementInform(uint32 /*type*/, uint32 id)
        {
            ...
            case 5:
                ...
                me->Say("Recruit, bring me that pool pony, three cannon balls, two batteries and some of that protodrake egg yolk.", LANG_UNIVERSAL);
        ...
        void UpdateAI(const uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    me->Yell("Sir, these Kor'kron don't seem very friendly!", LANG_UNIVERSAL);
                    if (Creature* c = me->FindNearestCreature(NPC_PATCH, 100.f))
                        c->GetAI()->DoAction(5);
                    break;
                ...
                case 20://move to ticker LOL
                    if (_count >= 7)
                    {
                        me->Yell("My masterpiece is finished!", LANG_UNIVERSAL);
                        events.ScheduleEvent(21, 2s);
                    }
                    else
                        events.ScheduleEvent(20, 3s);
                    break;
                case 21:
                    if (Creature* c = me->FindNearestCreature(NPC_VOLT, 100.f))
                        c->Yell("It's... it's beautiful!", LANG_UNIVERSAL);
                    if (Creature* c = me->FindNearestCreature(NPC_NEWT, 100.f))
                        c->Say("What the heck is the pool pony for?", LANG_UNIVERSAL);
                    events.ScheduleEvent(22, 2s);
                    break;
                case 22:
                    me->Say("Don't question my genius!", LANG_UNIVERSAL);
                    events.ScheduleEvent(23, 2s);
                    break;
                case 23:
                    if (Creature* c = me->FindNearestCreature(NPC_PATCH, 100.f))
                        c->Say("I don't care what it's for, is it going to get this door open?", LANG_UNIVERSAL);
                    events.ScheduleEvent(24, 4s);
                    break;
                case 24:
                    me->Say("This thing could open Gallywix's personal safe!", LANG_UNIVERSAL);
                    if (Creature* c = me->FindNearestCreature(NPC_MATID_BOMB, 100.f))
                        c->CastSpell(c, SPELL_MASSIVE_EXPLOSION);

                    events.ScheduleEvent(25, 2s);
                    break;
                case 25:
                    if (Creature* c = me->FindNearestCreature(NPC_MATID_BOMB, 100.f))
                        c->GetAI()->DoAction(1);
                    me->Say("Once the detonator goes off in... err... NOW!", LANG_UNIVERSAL);
                    break;
                }
            }
            if (UpdateVictim())
        ...
        bool OnGossipHello(Player* player) override
        {
            ...
            if (player->HasAura(SPELL_CANNON_BALL))
            {
                ...
                if (_cannonBalls < 3)
                {
                    ...
                    {
                    case 0:
                        me->Say("That's exactly what we needed!", LANG_UNIVERSAL);
                        break;
                    case 1:
                        me->Say("Careful! This isn't a toy!", LANG_UNIVERSAL);
                        break;
                    case 2:
                        me->Say("This may be my greatest work yet!", LANG_UNIVERSAL);
                        break;
                    }
                    ++_cannonBalls;
                }
            ...
            if (player->HasAura(SPELL_BATTERY))
            {
                ...
                if (_batteries < 2)
                {
                    ...
                    {
                    case 0:
                        me->Say("Just a little more power...", LANG_UNIVERSAL);
                        break;
                    case 1:
                        me->Say("This should give us enough power to disable the stabilization matrix", LANG_UNIVERSAL);
                        break;
                    }
                    _batteries++;
                }
            ...
            if (player->HasAura(SPELL_POOL_PONY))
            {
                ...
                if (!_poolPony)
                {
                    me->Say("The most important ingredient!", LANG_UNIVERSAL);
            ...
            if (player->HasAura(SPELL_EGG_YOLK))
            {
                ...
                if (!_eggYolk)
                {
                    ...
                    me->Say("You carried that with your hands?! Uh... you should probably see a medic when we get back...", LANG_UNIVERSAL);
                    instance->SetData(NPC_EGG_YOLK, DONE);
                }
            }
...
public:
    ...
    struct ragefire_core_npc_voltAI : public ScriptedAI
    {
        ...
        void DoAction(const int32 action) override
        {
            ...
            case 9:
                if (Creature* c = me->FindNearestCreature(NPC_TICKER, 100.f))
                    me->Say("Sir these are Garrosh's men.", LANG_UNIVERSAL);
                me->GetMotionMaster()->Clear();
    ...
    struct boss_ragefire_dark_shaman_xorenthAI : public BossAI
    {
        ...
        void DoAction(const int32 action) override
        {
            ...
            case 1:
                ...
                {
                    intro = true;
                    me->Yell("Intruders! Stop them!", LANG_UNIVERSAL);
                }
                if (instance)
                    instance->SetData(me->GetEntry(), IN_PROGRESS);
                break;
            case 2:
                ...
                break;
            case 3:
                me->Yell("All lesser races are enemies of the true horde!", LANG_UNIVERSAL);
                if (Creature* c = me->FindNearestCreature(NPC_PATCH, 100.f))
                    c->GetAI()->DoAction(8);
                break;
            }
        ...
        void JustEngagedWith(Unit* /*attacker*/) override
        {
            ...
            {
                _startCombat = true;
                me->Yell("Seal the gate, and inform the overseer immediately.", LANG_UNIVERSAL);
            ...
            events.ScheduleEvent(2, 17s);
            events.ScheduleEvent(3, 8s);
            events.ScheduleEvent(4, 10s);//not correct at all but it should be fine for now, more of a visual
        }
...
public:
    ...
    struct ragefire_core_npc_korkron_dark_shamanAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* /*attacker*/) override
        {
            ...
            events.ScheduleEvent(2, 7s);//reset 8 sec
            events.ScheduleEvent(3, 25s); //reset 25
        }
        ...
        bool OnGossipHello(Player* player) override
        {
            if (!pGossip)
            {
                ...
                if (instance)
                    instance->SetData(me->GetEntry(), DONE);
                if (Creature* c = me->FindNearestCreature(NPC_VOLT, 100.f))
                    c->Say("These supply crates came from Orgrimmar. What is Garrosh planning to do with so many war supplies?", LANG_UNIVERSAL);
            }
        ...
        bool OnGossipHello(Player* player) override
        {
            if (!pGossip)
            {
                ...
                if (instance)
                    instance->SetData(me->GetEntry(), DONE);
                if (Creature* c = me->FindNearestCreature(NPC_GRIT, 100.f))
                    c->Say("Protodrakes eggs... Is Garrosh working with the Dragonmaw? Orcs on protodrakes sounds bad to me, $n, very bad.", LANG_UNIVERSAL);
            }
            SendGossipMenuFor(player, player->GetEntry(), me->GetGUID());
        ...
        bool OnGossipHello(Player* player) override
        {
            if (!pGossip)
            {
                ...
                if (instance)
                    instance->SetData(me->GetEntry(), DONE);
                if (Creature* c = me->FindNearestCreature(NPC_VOLT, 100.f))
                    c->Say("These are from the dig site in the Vale of Eternal Blossoms. What is Garrosh trying to find there?", LANG_UNIVERSAL);
            }
            SendGossipMenuFor(player, player->GetEntry(), me->GetGUID());
        ...
        void UpdateAI(const uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case 1:
                    ...
                    events.ScheduleEvent(1, 15s);
                    break;
                case 2:
                    DoCast(SPELL_SHATTERING_STOMP);
                    events.ScheduleEvent(2, 15s);
                    break;
                }
            }
            DoMeleeAttackIfReady();
    ...
    struct npc_eredar_felcaller_98005AI : public ScriptedAI
    {
        ...
        void UpdateAI(const uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case 1:
                    if (Player* player = me->SelectNearestPlayer(200.0f))
                        me->Say("Very nice young $c", LANG_UNIVERSAL);
                    me->HandleEmoteCommand(Emote::EMOTE_ONESHOT_TALK);
                    events.ScheduleEvent(2, 4s);
                    break;

                case 2:
                    me->Say("Now for my next task.", LANG_UNIVERSAL);
                    break;
                }
            }
        }
...
{
    new scenario_the_secrets_of_ragefire();
   ...
   // RegisterCreatureAI(npc_eredar_felcaller_98005);
}
