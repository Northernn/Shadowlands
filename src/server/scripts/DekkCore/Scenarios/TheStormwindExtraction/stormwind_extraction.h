...
enum Npcs
{
    ...
    NPC_MAGE_COMMANDER_LYRA =134163,
};
...
enum CriteriaTrees
{
    CRITERIA_TREE_INFILTRATE_STORMWIND_CITY = 65339,
    CRITERIA_TREE_OPEN_SEWERS = 65350,
    CRITERIA_TREE_ENTER_THE_STOCKADES = 65341,
    CRITERIA_TREE_INFILTRATE_THE_STOCKADES = 65352,
    CRITERIA_TREE_RELEASE_SAURFANG = 65388,
};
