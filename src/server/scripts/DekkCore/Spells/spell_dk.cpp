...
public:
    ...
    class spell_dk_blood_gorged_AuraScript : public AuraScript
    {
        ...
        void HandleProc(AuraEffect* aurEff, ProcEventInfo& eventInfo)
        {
            ...
            GetTarget()->CastSpell(_procTarget, SPELL_DK_BLOOD_GORGED_HEAL, CastSpellExtraArgs(TRIGGERED_FULL_MASK).AddSpellBP0(heal).SetTriggeringAura(aurEff));
        }
...
class spell_dk_glacial_advance : public SpellScript
{
    ...
    void HandleHit(SpellEffIndex /*effIndex*/)
    {
        ...
        Position collisonPos = caster->GetFirstCollisionPosition(GetEffectInfo().MaxRadiusEntry->RadiusMax, DIFFICULTY_NONE);
