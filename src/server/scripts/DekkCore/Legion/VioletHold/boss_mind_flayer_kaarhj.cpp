...
public:
    ...
    struct boss_mindflayer_kaahrjAI : public BossAI
    {
            ...
            //49:10
        {
            ...
            events.RescheduleEvent(EVENT_SHADOW_CRASH, 4s); //49:14, 49:26, 49:50, 50:03
            events.RescheduleEvent(EVENT_DOOM, 8s);         //49:18, 49:30, 49:38, 49:54, 50:06
            events.RescheduleEvent(EVENT_HYSTERIA, 13s);    //49:23, 49:35, 49:59, 50:11
            events.RescheduleEvent(EVENT_ETERNAL_DARKNESS, 30s); //49:41, 50:17, 50:55
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_SHADOW_CRASH:
                    ...
                    events.RescheduleEvent(EVENT_SHADOW_CRASH, 12s);
                    break;
                case EVENT_DOOM:
                    DoCastVictim(SPELL_DOOM);
                    events.RescheduleEvent(EVENT_DOOM, 12s);
                    break;
                case EVENT_HYSTERIA:
                    if (Unit* pTarget = SelectTarget(SelectTargetMethod::Random, 0, 60.0f, true))
                        DoCast(pTarget, SPELL_HYSTERIA);
                    events.RescheduleEvent(EVENT_HYSTERIA, 12s);
                    break;
                case EVENT_ETERNAL_DARKNESS:
                    ...
                    events.RescheduleEvent(EVENT_ETERNAL_DARKNESS, 36s);
                    break;
                }
            }
