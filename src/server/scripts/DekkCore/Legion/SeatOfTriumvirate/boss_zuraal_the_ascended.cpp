...
struct boss_zuraal_the_ascended : public BossAI
{
    ...
    void ExecuteEvent(uint32 eventId) override
    {
        ...
        case SPELL_UMBRA_SHIFT:
        {
            ...
            if (Unit* target = SelectTarget(SelectTargetMethod::Random, 1, 0.f, true, true, -SPELL_UMBRA_SHIFT))
...
class aura_void_phased : public AuraScript
{
    ...
    void OnRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
    {
        ...
        target->RemoveUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_UNINTERACTIBLE | UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_IMMUNE_TO_NPC));
    }
...
void AddSC_boss_zuraal_the_ascended()
{
    ...
    RegisterSpellScript(aura_void_phased);
