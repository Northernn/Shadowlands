...
public:
    ...
    struct npc_torm_the_bruteAI : public ScriptedAI
    {
        ...
        {
            events.SetPhase(1);
            events.ScheduleEvent(EVENT_TORM_CRASH_DOOR, 25s);
        }

        void JustEngagedWith(Unit* who) override
        {
            events.SetPhase(2);
            events.ScheduleEvent(EVENT_DEVASTATING_STRIKE, 6s);
            events.ScheduleEvent(EVENT_BOULDER_STRIKE, 13s);
            events.ScheduleEvent(EVENT_RUMBLING_BLOW, 17s);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_TORM_CRASH_DOOR:
                    ...
                    events.ScheduleEvent(EVENT_TORM_CRASH_DOOR, 15s);
                    break;
                case EVENT_DEVASTATING_STRIKE:
                    DoCastVictim(SPELL_DEVASTATING_STRIKE);
                    events.ScheduleEvent(EVENT_DEVASTATING_STRIKE, 22s);
                    break;
                case EVENT_BOULDER_STRIKE:
                    if (auto target = SelectTarget(SelectTargetMethod::Random, 0, NonTankTargetSelector(me)))
                        DoCast(target, SPELL_BOULDER_STRIKE);
                    events.ScheduleEvent(EVENT_BOULDER_STRIKE, 11s);
                    break;
                case EVENT_RUMBLING_BLOW:
                    DoCastSelf(SPELL_RUMBLING_BLOW);
                    events.ScheduleEvent(EVENT_RUMBLING_BLOW, 18s);
                    break;
                default:
                    break;
                }
...
public:
    ...
    struct npc_fulminantAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            events.ScheduleEvent(EVENT_SCATTER, 10s);
            events.ScheduleEvent(EVENT_FULMINATE, 25s);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_SCATTER:
                    ...
                    events.ScheduleEvent(EVENT_SCATTER, 6s);
                    break;
...
public:
    ...
    struct npc_pulsauronAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            me->GetMotionMaster()->MoveRotate(1, 180000, urand(0, 1) ? ROTATE_DIRECTION_LEFT : ROTATE_DIRECTION_RIGHT);
            events.ScheduleEvent(EVENT_PULSAURON_BEAM, 5s);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_PULSAURON_BEAM:
                    ...
                    events.ScheduleEvent(EVENT_PULSAURON_BEAM, 30s);
                    break;
                default:
                    break;
                }
...
public:
    ...
    struct npc_chaotoidAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            events.ScheduleEvent(EVENT_RELEASE_THE_VOID, 20s);
            events.ScheduleEvent(EVENT_COMPRESS_THE_VOID_GRIP, 25s);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_RELEASE_THE_VOID:
                    ...
                    events.ScheduleEvent(EVENT_RELEASE_THE_VOID, 25s);
                    break;
                case EVENT_COMPRESS_THE_VOID_GRIP:
                    DoCastSelf(SPELL_COMPRESS_THE_VOID_GRIP);
                    events.ScheduleEvent(EVENT_COMPRESS_THE_VOID_GRIP, 35s);
                    break;
                default:
                    break;
                }
