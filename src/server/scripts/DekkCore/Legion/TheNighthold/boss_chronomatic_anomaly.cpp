...
public:
    ...
    struct boss_chronomatic_anomalyAI : BossAI
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            {
                burstTimer = 3000;
                events.RescheduleEvent(EVENT_BURST_OF_TIME, 2s);
                events.RescheduleEvent(EVENT_CHANGE_SPEED, 12s);
            }
            else if (IsHeroicRaid())
            {
                burstTimer = 4000;
                events.RescheduleEvent(EVENT_BURST_OF_TIME, 8s);
            }
            else
            {
                burstTimer = 5000;
                events.RescheduleEvent(EVENT_BURST_OF_TIME, 14s);
            }
        }
        ...
        void SpellHitTarget(WorldObject* target, const SpellInfo* spell) override
        {
            if (spell->Id == SPELL_BURST_OF_TIME)
                DoCast(target->ToUnit(), burstSpell, true);
        }
        ...
        void SetAnomalySpeed(bool mythicFast = false)
        {
            ...
            {
                anomalySpeed = SPELL_SPEED_FAST;
                events.RescheduleEvent(EVENT_SUM_SLOW_ADD, 7s);
                events.RescheduleEvent(EVENT_POWER_OVERWHELMING, 22s);
            }

            events.RescheduleEvent(EVENT_CHRONOMETRIC_PARTICLES, 10s);
            ...
            case SPELL_SPEED_SLOW:
                ...
                if (IsMythicRaid())
                {
                    events.RescheduleEvent(EVENT_TIME_RELEASE, 14s);
                    events.RescheduleEvent(EVENT_TIME_BOMB, 16s);
                    events.RescheduleEvent(EVENT_POWER_OVERWHELMING, 28s);
                    events.RescheduleEvent(EVENT_TEMPORAL_ORB, 8s);
                    if (speedCounter > 3)
                        events.RescheduleEvent(EVENT_SUM_SLOW_ADD, 18s);
                }
                else if (IsHeroicRaid())
                {
                    events.RescheduleEvent(EVENT_TIME_RELEASE, 10s);
                    events.RescheduleEvent(EVENT_TIME_BOMB, 15s);
                    events.RescheduleEvent(EVENT_SUM_SLOW_ADD, 43s);
                    events.RescheduleEvent(EVENT_TEMPORAL_ORB, 20s);
                    events.RescheduleEvent(EVENT_POWER_OVERWHELMING, 53s);
                }
                else
                {
                    events.RescheduleEvent(EVENT_TIME_RELEASE, 5s);
                    events.RescheduleEvent(EVENT_TIME_BOMB, 20s);
                    events.RescheduleEvent(EVENT_SUM_SLOW_ADD, 38s);
                    events.RescheduleEvent(EVENT_POWER_OVERWHELMING, 60s);
                    events.RescheduleEvent(EVENT_TEMPORAL_ORB, 30s);
                }
                Talk(SAY_TIME_SLOW);
            ...
            case SPELL_SPEED_NORMAL:
                ...
                {
                    events.RescheduleEvent(EVENT_TIME_RELEASE, 10s);
                    events.RescheduleEvent(EVENT_TIME_BOMB, 5s);
                    events.RescheduleEvent(EVENT_POWER_OVERWHELMING, 20s);
                }
                else if (IsHeroicRaid())
                {
                    events.RescheduleEvent(EVENT_TIME_RELEASE, 8s);
                    events.RescheduleEvent(EVENT_TIME_BOMB, 28s);
                    events.RescheduleEvent(EVENT_SUM_SLOW_ADD, 23s);
                    events.RescheduleEvent(EVENT_TEMPORAL_ORB, 38s);
                    events.RescheduleEvent(EVENT_POWER_OVERWHELMING, 53s);
                }
                else
                {
                    events.RescheduleEvent(EVENT_TIME_RELEASE, 8s);
                    events.RescheduleEvent(EVENT_TIME_BOMB, 35s);
                    events.RescheduleEvent(EVENT_SUM_SLOW_ADD, 28s);
                    events.RescheduleEvent(EVENT_POWER_OVERWHELMING, 60s);
                    events.RescheduleEvent(EVENT_TEMPORAL_ORB, 48s);
                }
            ...
            case SPELL_SPEED_FAST:
                ...
                if (IsMythicRaid())
                {
                    ...
                    if (speedCounter == 3 || speedCounter == 6)
                        events.RescheduleEvent(EVENT_SUM_SLOW_ADD, 23s);
                    events.RescheduleEvent(EVENT_POWER_OVERWHELMING, 30s);
                }
                else if (IsHeroicRaid())
                {
                    events.RescheduleEvent(EVENT_TIME_RELEASE, 5s);
                    events.RescheduleEvent(EVENT_TIME_BOMB, 17s);
                    events.RescheduleEvent(EVENT_SUM_SLOW_ADD, 38s);
                    events.RescheduleEvent(EVENT_POWER_OVERWHELMING, 53s);
                }
                else
                {
                    events.RescheduleEvent(EVENT_TIME_RELEASE, 10s);
                    events.RescheduleEvent(EVENT_SUM_SLOW_ADD, 28s);
                    events.RescheduleEvent(EVENT_TEMPORAL_ORB, 15s);
                    events.RescheduleEvent(EVENT_POWER_OVERWHELMING, 60s);
                }
                Talk(SAY_TIME_FAST);
                Talk(SAY_ADDITIONAL);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_CHRONOMETRIC_PARTICLES:
                    ...
                    events.RescheduleEvent(EVENT_CHRONOMETRIC_PARTICLES, 6s);
                    break;
                case EVENT_TIME_RELEASE:
                    ...
                    if (timerBombCounter == 1)
                    {
                        ...
                        {
                            if (IsMythicRaid())
                                events.RescheduleEvent(EVENT_TIME_RELEASE, 2s);
                            else if (IsHeroicRaid())
                                events.RescheduleEvent(EVENT_TIME_RELEASE, 30s);
                            else
                                events.RescheduleEvent(EVENT_TIME_RELEASE, 16s);
                        }
                        else if (anomalySpeed == SPELL_SPEED_SLOW)
                        {
                            if (IsMythicRaid())
                                events.RescheduleEvent(EVENT_TIME_RELEASE, 7s);
                            else if (IsHeroicRaid())
                                events.RescheduleEvent(EVENT_TIME_RELEASE, 5s);
                        }
                    }
                ...
                case EVENT_TIME_BOMB:
                    ...
                    if (timerBombCounter == 1)
                    {
                        ...
                        {
                            if (IsMythicRaid())
                                events.RescheduleEvent(EVENT_TIME_BOMB, 12s);
                            else if (IsHeroicRaid())
                                events.RescheduleEvent(EVENT_TIME_BOMB, 5s);
                        }
                        else if (anomalySpeed == SPELL_SPEED_SLOW)
                        {
                            if (IsMythicRaid())
                                events.RescheduleEvent(EVENT_TIME_BOMB, 2s);
                            else if (IsHeroicRaid())
                                events.RescheduleEvent(EVENT_TIME_BOMB, 20s);
                        }
                        ...
                        {
                            if (IsHeroicRaid())
                                events.RescheduleEvent(EVENT_TIME_BOMB, 30s);
                        }
                    }
                    else if (timerBombCounter == 2)
                    {
                        ...
                        {
                            if (IsMythicRaid())
                                events.RescheduleEvent(EVENT_TIME_BOMB, 7s);
                        }
                    }
                    ...
                    else if (timerBombCounter == 4)
                    {
                        ...
                        {
                            if (IsMythicRaid())
                                events.RescheduleEvent(EVENT_TIME_BOMB, 3s);
                        }
                    }
                    break;
                ...
                case EVENT_TEMPORAL_ORB:
                {
                    ...
                    if (temporalOrbCounter == 1)
                    {
                        ...
                        {
                            if (IsMythicRaid())
                                events.RescheduleEvent(EVENT_TEMPORAL_ORB, 14s);
                        }
                        else if (anomalySpeed == SPELL_SPEED_SLOW)
                        {
                            if (IsHeroicPlusRaid())
    ...
    void DamageTaken(Unit* /*attacker*/, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
        {
            ...
            if (damage >= me->GetHealth())
            {
                ...
                if (!despawn)
                {
                    ...
                    {
                        me->CastSpell(me, SPELL_SUM_TEMPORAL_RIFT, CastSpellExtraArgs(TRIGGERED_FULL_MASK).SetOriginalCaster(owner->GetGUID()));
                        Position pos;
                        float angle = 1.57f;
                        for (uint8 i = 0; i < 4; i++)
                        {
    ...
    class spell_anomaly_time_release_AuraScript : public AuraScript
    {
            ...
            if (GetTarget())
            {
                ...
                if (newAbsorb > absorb * 0.66)
                {
                    if (GetTarget()->HasAura(SPELL_TIME_RELEASE_RED))
                    {
                        ...
                        GetTarget()->CastSpell(GetTarget(), SPELL_TIME_RELEASE_RED, CastSpellExtraArgs().AddSpellBP0(newAbsorb));
                }
                else if (newAbsorb > absorb * 0.33)
                {
                    if (GetTarget()->HasAura(SPELL_TIME_RELEASE_YELLOW))
                    {
                        ...
                        GetTarget()->CastSpell(GetTarget(), SPELL_TIME_RELEASE_YELLOW, CastSpellExtraArgs().AddSpellBP0(newAbsorb));
                }
                else
                {
                    if (GetTarget()->HasAura(SPELL_TIME_RELEASE_GREEN))
                    {
                        ...
                        GetTarget()->CastSpell(GetTarget(), SPELL_TIME_RELEASE_GREEN, CastSpellExtraArgs().AddSpellBP0(newAbsorb));
                }
            }
        }
        ...
        void OnApply(AuraEffect const* aurEff, AuraEffectHandleModes /*mode*/)
        {
            if (GetTarget() && !absorb)
            {
                ...
                GetTarget()->CastSpell(GetTarget(), SPELL_TIME_RELEASE_RED, CastSpellExtraArgs().AddSpellBP0(absorb));
            }
        }
        ...
        if (InstanceScript* instance = GetTarget()->GetInstanceScript())
            if (Creature* anomaly = instance->instance->GetCreature(instance->GetGuidData(DATA_ANOMALY)))
                if (instance->GetBossState(DATA_ANOMALY) == IN_PROGRESS)
                    GetTarget()->CastSpell(GetTarget(), SPELL_SUM_TEMPORAL_RIFT, CastSpellExtraArgs(TRIGGERED_FULL_MASK).SetOriginalCaster(anomaly->GetGUID()));
    }
...
void AddSC_boss_chronomatic_anomaly()
{
    ...
    RegisterSpellScript(spell_anomaly_temporal_charge_remove);
}
