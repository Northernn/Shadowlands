...
public:
    ...
    struct boss_tirathon_saltherilAI : public BossAI
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.RescheduleEvent(EVENT_DARKSTRIKES, 16s);
            events.RescheduleEvent(EVENT_SWOOP, 22s);
            events.RescheduleEvent(EVENT_FEL_MORTAR, 10s);
        }
    ...
    void DamageTaken(Unit* /*attacker*/, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
        {
            ...
            {
                phaseSecond = true;
                events.RescheduleEvent(EVENT_METAMORPHOSIS, 0s);
                Talk(SAY_METAMORPH);
            }
        }
        ...
        void SpellHitTarget(WorldObject* target, const SpellInfo* spell) override
        {
            ...
            case SPELL_FEL_MORTAR:
            {
                ...
                me->CastSpell(pos, 202920, true); //Fel Mortar
                break;
            }
            }
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_DARKSTRIKES:
                    ...
                    events.RescheduleEvent(EVENT_DARKSTRIKES, 60s);
                    break;
                case EVENT_SWOOP:
                    DoCast(SPELL_SWOOP);
                    events.RescheduleEvent(EVENT_SWOOP, 30s);
                    break;
                case EVENT_METAMORPHOSIS:
                    if (!randMetamorph)
                    {
                        DoCast(SPELL_METAMORPHOSIS_HAVOC);
                        events.RescheduleEvent(EVENT_LASER_BEAM, 24s);
                    }
                    else
                    {
                ...
                case EVENT_FEL_MORTAR:
                    ...
                    events.RescheduleEvent(EVENT_FEL_MORTAR, 16s);
                    break;
                case EVENT_LASER_BEAM:
                    me->AttackStop();
                    if (auto target = SelectTarget(SelectTargetMethod::Random, 0, 50.0f, true))
                        DoCast(target, SPELL_SUMMON_LASER_BEAM, true);
                    events.RescheduleEvent(EVENT_LASER_BEAM, 30s);
                    break;
                }
            }
...
public:
    ...
    struct npc_glayvianna_soulrenderAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.RescheduleEvent(EVENT_5, 14s);
            phaseSecond = false;
            phaseThree = false;
        }
    ...
    void DamageTaken(Unit* attacker, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
        {
            ...
            {
                phaseSecond = true;
                events.RescheduleEvent(EVENT_2, 0s);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_3:
                    DoCast(193609);
                    events.RescheduleEvent(EVENT_4, 12s);
                    break;
                case EVENT_4:
                    DoCast(193615);
                    events.RescheduleEvent(EVENT_4, 12s);
...
void AddSC_boss_tirathon_saltheril()
{
    ...
    RegisterSpellScript(spell_tirathon_darkstrikes);
