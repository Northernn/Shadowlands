...
public:
    ...
    struct boss_ana_muzAI : public ScriptedAI
    {
        ...
        {
            events.RescheduleEvent(1, 4s); // SPELL_FEL_GEYZER
            events.RescheduleEvent(3, 7s); // SPELL_GASEOUS_BREATH
            events.RescheduleEvent(4, 31s); // SPELL_MOTHERS_EMBRACE
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case 3:
                    ...
                    events.RescheduleEvent(3, 31s);
                    break;
                case 4:
                    DoCast(SPELL_MOTHERS_EMBRACE);
                    events.RescheduleEvent(4, 65s);
                    break;
                }
            }
