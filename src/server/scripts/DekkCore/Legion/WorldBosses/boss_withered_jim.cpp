...
public:
    ...
    struct boss_withered_jimAI : public ScriptedAI
    {
        ...
        void JustDied(Unit* who) override
        {
          ...
          void DamageTaken(Unit* /*attacker*/ attacker,  uint32& /*damage*/, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
        
        {
            ...
            if (attacker->GetPositionZ() >= 60.0f)
                me->Kill(me, attacker); //cheaters and others
        }
