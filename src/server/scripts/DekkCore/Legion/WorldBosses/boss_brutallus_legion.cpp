...
public:
    ...
    class spell_brutallus_meteor_slash_SpellScript : public SpellScript
    {
        ...
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_brutallus_meteor_slash_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_CONE_CASTER_TO_DEST_ENEMY);
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_brutallus_meteor_slash_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_CONE_CASTER_TO_DEST_ENEMY);
