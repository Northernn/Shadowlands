...
public:
    ...
    {
        return new npc_40618_artifactAI(creature);
    }

    struct npc_40618_artifactAI : public ScriptedAI
    {
        npc_40618_artifactAI(Creature* creature) : ScriptedAI(creature) { }
    ...
    bool OnGossipHello(Player* player) override
    {
        ...
        if (player->HasQuest(40618) &&
            ...
            AddGossipItemFor(player, GossipOptionNpc::None, "I would like to review weapons we might pursue.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
        }
