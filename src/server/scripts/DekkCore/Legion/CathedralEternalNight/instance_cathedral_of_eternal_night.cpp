        ...
        void OnUnitDeath(Unit* creature) override
        {
            ...
            case NPC_GAZERAX:
                ...
                if (Creature* thrashbite = instance->GetCreature(ThrashbiteGuid))
                {
                        ...
                        thrashbite->RemoveUnitFlag(UNIT_FLAG_UNINTERACTIBLE);
            ...
            case NPC_BATS_INTRO:
            {
                ...
                if (deads_npc >= 4)
                {
                    ...
                    if (Creature* mephistroth = instance->GetCreature(MephistrothGuid))
                    {
                        ...
                        mephistroth->RemoveUnitFlag(UNIT_FLAG_UNINTERACTIBLE);
            ...
            case DATA_DOMATRAX:
                ...
                case NOT_STARTED:
                {
                    if (Creature* egida = instance->GetCreature(EgidaDomatraxStarterGuid))
                    {
                        ...
                        egida->SetNpcFlag(UNIT_NPC_FLAG_GOSSIP);
