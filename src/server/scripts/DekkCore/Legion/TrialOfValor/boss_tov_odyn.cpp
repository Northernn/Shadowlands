...
struct boss_tov_odyn : BossAI
{
    ...
    void MoveInLineOfSight(Unit* who) override
    {
        ...
        if ((instance->GetBossState(Data::BossIDs::OdynID) != DONE) && (instance->GetData(Data::DataMisc::OdynIntroEvent) != DONE))
        {
            ...
            events.RescheduleEvent(EVENT_INTRO, 55s);
    ...
    void SpellHitTarget(WorldObject* target, SpellInfo const* spell) override
    {
        ...
        case SpellTestForPlayersMythic:
            if (target->IsPlayer())
                DoCast(target->ToUnit(), SpellTestOfTheChosen, true);
            break;
...
void DamageTaken(Unit* /*attacker*/, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
    {
        ...
        if (me->HealthBelowPct(10) && !encounterComplete)
        {
            ...
            DespawnAllSummons();
            RemoveDebuffsOnPlayer();
            instance->DoUpdateCriteria(CriteriaType::DefeatDungeonEncounter, 1958, 0, 0);
        }
    ...
    void DoAction(int32 const action) override
    {
        ...
        case ACTION_1:
            if ((instance->GetData(Data::DataMisc::OdynEventComplete1) == DONE) && (instance->GetData(Data::DataMisc::OdynEventComplete2) == DONE))
            {
                ...
                disableEvade = true;
                events.RescheduleEvent(EVENT_START_ODYN, 7s);
                events.CancelEvent(EVENT_FELMAGNARON_RUNE);
            }
            break;
        case ACTION_3:
            BossAI::EnterEvadeMode();
            events.RescheduleEvent(EVENT_INTRO, 0s);
            break;
        case ACTION_4:
            StartEvents(PHASE_1);
            break;
    ...
    void StartEvents(uint8 phase)
    {
        ...
        case PHASE_1:
            ...
            events.RescheduleEvent(EVENT_FELMAGNARON_RUNE, 40s);
            break;
        case PHASE_2:
            ...
            events.RescheduleEvent(EVENT_SPEAR_OF_LIGHT, 5s);
            events.RescheduleEvent(EVENT_ODYNS_TEST, 30s);
            events.RescheduleEvent(EVENT_FELMAGNARON_RUNE, 40s);

            if (IsHeroicPlusRaid())
            {
                instance->SetData(Data::DataMisc::OdynTestOfAges, DONE);
                events.RescheduleEvent(EVENT_PHASE_TWO_HYRJA, 10s);
                events.RescheduleEvent(EVENT_PHASE_TWO_HYMDALL, 76s);
            }
        ...
        case PHASE_3:
            ...
            me->AttackStop();
            DespawnAllSummons();
            events.RescheduleEvent(EVENT_START_THIRD_PHASE, 4s);
            break;
        }
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        if (uint32 eventId = events.ExecuteEvent())
        {
            ...
            case EVENT_START_ODYN:
                ...
                events.RescheduleEvent(EVENT_START_SECOND_PHASE, 2s);
                break;
            ...
            case EVENT_START_THIRD_PHASE:
                ...
                events.RescheduleEvent(EVENT_STORM_OF_JUSTICE, 4s);
                events.RescheduleEvent(EVENT_STORM_FORGED_SPEAR, 14s);
                events.RescheduleEvent(EVENT_CLEANSING_FLAME_AT_1, 1s);
                events.RescheduleEvent(EVENT_ARCING_STORM_BUFF, 6s);
                break;
            case EVENT_FELMAGNARON_RUNE:
                ...
                events.RescheduleEvent(EVENT_FELMAGNARON_RUNE, 70s);
                break;
            case EVENT_ODYNS_TEST:
                DoCast(SpellOdynsTest);

                if (IsMythicRaid())
                    events.RescheduleEvent(EVENT_ODYNS_TEST, 80s);
                else
                    events.RescheduleEvent(EVENT_ODYNS_TEST, 70s);
                break;
            case EVENT_STORM_FORGED_SPEAR:
                DoCast(SpellStormForgedSpear);
                events.RescheduleEvent(EVENT_STORM_FORGED_SPEAR, 11s);
                break;
            case EVENT_STORM_OF_JUSTICE:
                DoCast(SpellStormOfJustice);
                events.RescheduleEvent(EVENT_STORM_OF_JUSTICE, 12s);
                break;
        ...
        //            if (auto itr = Trinity::Containers::SelectRandomContainerElement(threatlist))
           ...
           //             threatlist.remove(itr);
                ...
                events.RescheduleEvent(EVENT_SPEAR_OF_LIGHT, 10s);
                break;
            }
            case EVENT_CLEANSING_FLAME_AT_1:
                DoCast(SpellCleansingFlameAT_1);
                events.RescheduleEvent(EVENT_CLEANSING_FLAME_AT_1, 105s);
                events.RescheduleEvent(EVENT_CLEANSING_FLAME_AT_2, 35s);
                break;
            case EVENT_CLEANSING_FLAME_AT_2:
                DoCast(SpellCleansingFlameAT_2);
                events.RescheduleEvent(EVENT_CLEANSING_FLAME_AT_2, 105s);
                events.RescheduleEvent(EVENT_CLEANSING_FLAME_AT_3, 35s);
                break;
            case EVENT_CLEANSING_FLAME_AT_3:
                DoCast(SpellCleansingFlameAT_3);
                events.RescheduleEvent(EVENT_CLEANSING_FLAME_AT_3, 105s);
                events.RescheduleEvent(EVENT_CLEANSING_FLAME_AT_1, 35s);
                break;
            case EVENT_PHASE_TWO_HYMDALL:
                ...
                events.RescheduleEvent(EVENT_PHASE_TWO_HYMDALL, 135s);
                break;
            case EVENT_PHASE_TWO_HYRJA:
                ...
                events.RescheduleEvent(EVENT_PHASE_TWO_HYRJA, 135s);
                break;
            case EVENT_ARCING_STORM_BUFF:
                DoCast(me, SpellArcingStormBuff, false);
                events.RescheduleEvent(EVENT_ARCING_STORM_BUFF, 9s);
                break;
            }
        }
...
struct npc_tov_hymdall : ScriptedAI
{
    ...
    void JustEngagedWith(Unit* who) override
    {
        ...
        if (IsMythicRaid())
        {
            events.RescheduleEvent(EVENT_HORN_OF_VALOUR, 8s);
            events.RescheduleEvent(EVENT_DANCING_BLADE, 15s);
        }
        else if (IsHeroicRaid())
        {
            events.RescheduleEvent(EVENT_HORN_OF_VALOUR, 8s);
            events.RescheduleEvent(EVENT_DANCING_BLADE, 16s);
        }
        else if (IsNormalRaid() || IsLFR())
        {
            events.RescheduleEvent(EVENT_HORN_OF_VALOUR, 10s);
            events.RescheduleEvent(EVENT_DANCING_BLADE, 20s);
        }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        if (uint32 eventId = events.ExecuteEvent())
        {
            ...
            case EVENT_HORN_OF_VALOUR:
                ...
                if (IsMythicRaid())
                    events.RescheduleEvent(EVENT_HORN_OF_VALOUR, 22s);
                else if (IsHeroicRaid())
                    events.RescheduleEvent(EVENT_HORN_OF_VALOUR, 27s);
                else if (IsLFR() || IsNormalRaid())
                    events.RescheduleEvent(EVENT_HORN_OF_VALOUR, 69s);

                break;
            case EVENT_DANCING_BLADE:
                if (auto target = SelectTarget(SelectTargetMethod::Random,0, 100.0f, true, 0))
                    DoCast(target, SpellDancingBlade, false);

                if (IsMythicRaid())
                    events.RescheduleEvent(EVENT_DANCING_BLADE, 20s);
                else
                    events.RescheduleEvent(EVENT_DANCING_BLADE, 30s);
                break;
            }
        }
        DoMeleeAttackIfReady();
...
struct npc_tov_hyrja : ScriptedAI
{
    ...
    void JustEngagedWith(Unit* who) override
    {
        ...
        if (IsMythicRaid())
        {
            events.RescheduleEvent(EVENT_SHIELD_OF_LIGHT, 20s);
            events.RescheduleEvent(EVENT_EXPEL_LIGHT, 25s);
        }
        else if (IsHeroicRaid())
        {
            events.RescheduleEvent(EVENT_SHIELD_OF_LIGHT, 23s);
            events.RescheduleEvent(EVENT_EXPEL_LIGHT, 32s);
        }
        else if (IsNormalRaid() || IsLFR())
        {
            events.RescheduleEvent(EVENT_SHIELD_OF_LIGHT, 30s);
            events.RescheduleEvent(EVENT_EXPEL_LIGHT, 40s);
        }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        if (uint32 eventId = events.ExecuteEvent())
        {
            ...
            case EVENT_EXPEL_LIGHT:
                if (auto target = SelectTarget(SelectTargetMethod::Random, 0, 300.0f, true))
                    DoCast(target, SpellExpelLight, false);

                if (IsMythicRaid())
                    events.RescheduleEvent(EVENT_EXPEL_LIGHT, 20s);
                else if (IsHeroicRaid())
                    events.RescheduleEvent(EVENT_EXPEL_LIGHT, 32s);
                else if (IsLFR() || IsNormalRaid())
                    events.RescheduleEvent(EVENT_EXPEL_LIGHT, 19s);
                break;
            case EVENT_SHIELD_OF_LIGHT:
                if (auto target = SelectTarget(SelectTargetMethod::Random, 0, 60.0f, true, 0))
                {
                    me->SetReactState(REACT_PASSIVE);
                    events.RescheduleEvent(EVENT_SHIELD_OF_LIGHT_REACT, 5s);
                ...
                if (IsMythicRaid())
                    ...
                    events.RescheduleEvent(EVENT_SHIELD_OF_LIGHT, 32s);
                break;
...
struct npc_tov_spear_of_light : ScriptedAI
{
    ...
    void IsSummonedBy(WorldObject* /*owner*/) override
    {
        for (uint8 i = 0; i < (IsLFR() ? 3 : 5); ++i)
        {
            ...
            Position pos = me->GetNearPosition(3.0f, angle);
            ...
            if (auto odyn = instance->instance->GetCreature(instance->GetGuidData(Data::Creatures::Odyn)))
            {
                ...
                odyn->CastSpell(pos, SpellGlowingFragment, true);
            }
        }
...
void AddSC_boss_odyn_tov()
{
    ...
    RegisterSpellScript(spell_odyn_power_regen);
    RegisterSpellScript(spell_odyn_test);
    RegisterSpellScript(spell_odyn_power_regen_mythic);
    RegisterSpellScript(spell_odyn_branded_event);
