...
public:
    ...
    CreatureAI* GetAI(Creature* creature) const override
    {
        return new npc_96675AI(creature);
    }

    struct npc_96675AI : public ScriptedAI
    {
        npc_96675AI(Creature* creature) : ScriptedAI(creature) { }
    };
...
public:
    ...
    struct go_244455AI : public GameObjectAI
    {
        go_244455AI(GameObject* go) : GameObjectAI(go) { }
...
public:
    ...
    CreatureAI* GetAI(Creature* creature) const override
    {
        return new npc_97644AI(creature);
    }

    struct npc_97644AI : public ScriptedAI
    {
        npc_97644AI(Creature* creature) : ScriptedAI(creature) { }
    };
...
public:
    ...
    struct go_244923AI : public GameObjectAI
    {
        go_244923AI(GameObject* go) : GameObjectAI(go) { }
    };

    GameObjectAI* GetAI(GameObject* go) const override
    {
        return new go_244923AI(go);
    }
    ...
    bool OnQuestReward(Player* player, GameObject* go, Quest const* quest, uint32) override
    {
        if (quest->GetQuestId() == 38672)
        {
            ...
            if (GameObject* vaultdoors = player->SummonGameObject(399999, 4325.98f, -578.061f, -281.808f, 1.62673f, QuaternionData(-0.0f, -0.0f, -0.726604f, -0.687056f), 0s))
            {
...
public:
    ...
    struct go_244582AI : public GameObjectAI
    {
        go_244582AI(GameObject* go) : GameObjectAI(go) { }
...
public:
    ...
    struct go_244588AI : public GameObjectAI
    {
        go_244588AI(GameObject* go) : GameObjectAI(go) { }
...
public:
    ...
    struct go_245467AI : public GameObjectAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            std::list<Player*> list;
            list.clear();
            me->GetPlayerListInGrid(list, 50.0f);
            if (!list.empty())
            {
                for (std::list<Player*>::const_iterator itr = list.begin(); itr != list.end(); ++itr)
                {
...
public:
    ...
    struct npc_96783AI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* victim) override
        {
            ...
            events.RescheduleEvent(3, 15s);
            events.RescheduleEvent(4, 23s);
        }
