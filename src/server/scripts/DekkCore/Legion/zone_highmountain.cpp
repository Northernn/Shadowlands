...
public:
    ...
    struct go_quest_40219_highmountain_brazierAI : public GameObjectAI
    {
        go_quest_40219_highmountain_brazierAI(GameObject* go) : GameObjectAI(go) { }

        bool OnGossipHello(Player* player) override
        {
            GameObject* go = me->ToGameObject();

            if (go->GetEntry() == 250916)
            {
                //Visión de escala
                Creature* Igrul = player->SummonCreature(96387, Position(3547.78f, 4373.75f, 663.031f, 0.977324f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
                Creature* Huln = player->SummonCreature(96318, Position(3550.959f, 4379.73f, 663.475f, 4.30743f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
                Creature* Warbrave01 = player->SummonCreature(98788, Position(3551.889f, 4382.259f, 663.932f, 3.94186f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
                Creature* Warbrave02 = player->SummonCreature(98788, Position(3555.33f, 4380.189f, 663.773f, 3.5473f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
                Igrul->Say(100465);
                ...
                Igrul->DespawnOrUnsummon(25s);
                Huln->DespawnOrUnsummon(25s);
                Warbrave01->DespawnOrUnsummon(25s);
                Warbrave02->DespawnOrUnsummon(25s);
            ...
            if (go->GetEntry() == 250978)
            {
                ...
                Creature* Igrul = player->SummonCreature(96387, Position(3649.409f, 4265.33f, 665.0189f, 1.53473f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
                Creature* Huln = player->SummonCreature(96318, Position(3644.1f, 4270.6f, 665.405f, 0.4333f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
            ...
            if (go->GetEntry() == 250979)
            {
                ...
                Creature* Igrul = player->SummonCreature(96387, Position(3508.34f, 4295.92f, 682.3648f, 5.6015f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
                Creature* Huln = player->SummonCreature(96318, Position(3514.82f, 4297.66f, 681.512f, 2.66739f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
                Creature* Warbrave01 = player->SummonCreature(98788, Position(3507.429f, 4288.99f, 681.276f, 1.34693f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
                Creature* Warbrave02 = player->SummonCreature(98788, Position(3519.07f, 4295.7f, 680.42f, 2.621f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
                Igrul->Say(100831);
                player->GetScheduler().Schedule(Milliseconds(10000), [Huln](TaskContext context)
                    {
                        Huln->Say(100832);
    ...
    {
        return new go_quest_40219_highmountain_brazierAI(go);
    }
};
...
public:
    ...
    struct go_quest_39578_highmountain_brazierAI : public GameObjectAI
    {
        go_quest_39578_highmountain_brazierAI(GameObject* go) : GameObjectAI(go) { }

        bool OnGossipHello(Player* player) override
        {
            if (GameObject* go = me->ToGameObject())
            if (go->GetEntry() == 250994)
            {
                player->RemoveAurasDueToSpell(191564);
                Creature* Ebonhorn = player->SummonCreature(99190, Position(3419.129f, 4297.44f, 704.041f, 4.68f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
                Creature* Igrul = player->SummonCreature(96387, Position(3427.0f, 4254.979f, 704.059f, 1.551f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
                Creature* Huln = player->SummonCreature(96318, Position(3425.44f, 4296.27f, 704.379f, 4.53f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
                Creature* Mayla = player->SummonCreature(96523, Position(3430.49f, 4295.62f, 703.898f, 4.34947f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);

                Creature* Deathwing = player->SummonCreature(97056, Position(3427.34f, 4272.229f, 704.005f, 1.57f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
                Deathwing->Say(98359);
                ...
                Creature* Drogbar01 = player->SummonCreature(99138, Position(3410.1f, 4272.1098f, 704.4719f, 0.0069f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
                Creature* Drogbar02 = player->SummonCreature(99138, Position(3412.22f, 4263.99f, 705.056f, 0.49896f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0);
                Huln->AddAura(193622, Huln);

                Drogbar02->DespawnOrUnsummon(25s);
                Drogbar01->DespawnOrUnsummon(25s);
                Igrul->DespawnOrUnsummon(25s);
                Huln->DespawnOrUnsummon(65s);
                Mayla->DespawnOrUnsummon(25s);
                Ebonhorn->DespawnOrUnsummon(65s);
            }
            return false;
        }
    };
    ...
    GameObjectAI* GetAI(GameObject* go) const override
    {
        return new go_quest_39578_highmountain_brazierAI(go);
    }
};
...
public:
    ...
    struct go_quest_39577_highmountain_brazierAI : public GameObjectAI
    {
        go_quest_39577_highmountain_brazierAI(GameObject* go) : GameObjectAI(go) { }
        ...
        bool OnGossipHello(Player* player) override
        {
            ...
            {
                //108199,96270
                if (Creature* Igrul = player->SummonCreature(96387, Position(3547.78f, 4373.75f, 663.031f, 0.977324f), TEMPSUMMON_MANUAL_DESPAWN, 0s, 0))
                {
                    Igrul->AI()->Talk(0);
                    go->GetScheduler().Schedule(10s, [Igrul, player](TaskContext /*context*/)
                        {
                            Igrul->AI()->Talk(1);
                            Igrul->DespawnOrUnsummon(5s);
                        });
                }
                player->GetScheduler().Schedule(12s, [player](TaskContext /*context*/)
                    {
                        ...
                        if (!_list.empty())
                            for (Creature* mob : _list)
                                mob->RemoveUnitFlag(UnitFlags(UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_IMMUNE_TO_NPC | UNIT_FLAG_UNINTERACTIBLE));
                    });
    ...
    GameObjectAI* GetAI(GameObject* go) const override
    {
        return new go_quest_39577_highmountain_brazierAI(go);
    }
};
...
public:
    ...
    struct go_quest_39455_altarAI : public GameObjectAI
    {
        go_quest_39455_altarAI(GameObject* go) : GameObjectAI(go) { }

        bool OnGossipHello(Player* player) override
        {
            if (me->ToGameObject()->GetEntry() == 244564)
            {
    ...
    GameObjectAI* GetAI(GameObject* go) const override
    {
        return new go_quest_39455_altarAI(go);
    }
};
