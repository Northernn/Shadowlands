...
public:
    ...
    struct boss_vizaduum_the_watcherAI : public BossAI
    {
        ...
        void DefaultEvent(uint8 phase)
        {
            ...
            {
            case PHASE_1:
                events.RescheduleEvent(EVENT_BURNING_BLAST, 2s);
                events.RescheduleEvent(EVENT_COMMAND_FEL_BEAM, 6s);
                events.RescheduleEvent(EVENT_DISINTEGRATE, 11s);
                events.RescheduleEvent(EVENT_CHAOTIC_SHADOWS, 16s);
                events.RescheduleEvent(EVENT_COMMAND_BOMBARDMENT, 26s);
                break;
            case PHASE_2:
                events.RescheduleEvent(EVENT_BURNING_BLAST, 2s);
                events.RescheduleEvent(EVENT_DISINTEGRATE, 11s);
            ...
            case PHASE_3:
                ...
                events.RescheduleEvent(EVENT_DISINTEGRATE, 11s);
                events.RescheduleEvent(EVENT_CHAOTIC_SHADOWS, 16s);
                events.RescheduleEvent(EVENT_SUMMON_GUARD, 2s);
                break;
            case PHASE_CHANGE:
                if (healthPct == 33)
                    Talk(SAY_DEMONIC_PORTAL);
                events.RescheduleEvent(EVENT_DEMONIC_PORTAL_1, 1s);
                break;
            }
        }
        ...
        void SpellHitTarget(WorldObject* target, const SpellInfo* spell) override
        {
            ...
            case SPELL_DISINTEGRATE_FILTER:
            {
                ...
                if (vPhase >= 2)
                    ...
                    DoCast(target->ToUnit(), SPELL_DISINTEGRATE);
                break;
            }
        ...
        void MovementInform(uint32 type, uint32 id) override
        {
            if (type == WAYPOINT_MOTION_TYPE)
            {
               ...
               //     DoResetThreat();
                    ...
                    events.RescheduleEvent(EVENT_CHECK_PLAYER, 1s);
                    eventCheckPlayer = true;

                    if (!healthPct)
                    {
                        me->SetFacingTo(1.1f);
                        events.RescheduleEvent(EVENT_STABILIZE_RIFT, 2s);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_CHAOTIC_SHADOWS:
                    ...
                    events.RescheduleEvent(EVENT_CHAOTIC_SHADOWS, 30s);
                    break;
                case EVENT_COMMAND_BOMBARDMENT:
                    DoCast(SPELL_COMMAND_BOMBARDMENT);
                    events.RescheduleEvent(EVENT_COMMAND_BOMBARDMENT, 25s);
                    break;
                case EVENT_DEMONIC_PORTAL_1:
                {
                    ...
                    //>>> HACK!!!
                    float x, y, z;
                    me->GetClosePoint(x, y, z, me->GetCombatReach(), 4.0f);
                    me->SummonCreature(NPC_DEMONIC_PORTAL, x, y, me->GetPositionZ(), 0.0f, TEMPSUMMON_TIMED_DESPAWN, 10s);
                    Talk(SAY_DEMONIC_PORTAL_WARN);
                    ///<<<
                    events.RescheduleEvent(EVENT_DEMONIC_PORTAL_2, 5s);
                    break;
                }
                case EVENT_DEMONIC_PORTAL_2:
                    me->CastSpell(me, SPELL_DEMONIC_PORTAL_AT, true);
                    events.RescheduleEvent(EVENT_DEMONIC_PORTAL_3, 3s);
                    break;
                ...
                case EVENT_CHECK_PLAYER:
                    ...
                    else
                    {
                        ...
                        events.RescheduleEvent(EVENT_CHECK_PLAYER, 3s);
                    }
                    break;
    ...
    struct npc_archmage_khadgar_medivh_vizaduumAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            case NPC_ARCHMAGE_KHADGAR_VIZADUUM:
                events.RescheduleEvent(EVENT_1, 3s);
                DelayTalk(me, 4, 0s, nullptr);
                DelayTalk(me, 24, 1s, nullptr);
                DelayTalk(me, 43, 2s, nullptr);
                DelayTalk(me, 76, 3s, nullptr);
                events.RescheduleEvent(EVENT_2, 80s);
                break;
            case NPC_MEDIVH_VIZADUUM:
                DelayTalk(me, 15, 0s, nullptr);
                DelayTalk(me, 30, 1s, nullptr);
                DelayTalk(me, 49, 2s, nullptr);
                DelayTalk(me, 55, 3s, nullptr);
                DelayTalk(me, 67, 4s, nullptr);
                break;
            }
        }
