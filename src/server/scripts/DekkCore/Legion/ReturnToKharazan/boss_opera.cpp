...
public:
    ...
    struct npc_rtk_barnes_encounter_starterAI : public ScriptedAI
    {
        ...
        bool OnGossipSelect(Player* player, uint32 sender, uint32 action) override
        {
            if (!startEvent && sender == 20468)
            {
                ...
                //> DEBUG!!!
                    ...
                    //return;
                //< DEBUG!!!
                events.RescheduleEvent(EVENT_START_TALK, 1s);

                switch (instance->GetData(DATA_OPERA_HALL_SCENE))
                {
                case DATA_OPERA_HALL_WIKKET:
                    events.RescheduleEvent(EVENT_WIKKET_1, 10s);
                    break;
                case DATA_OPERA_HALL_WESTFALL:
                    events.RescheduleEvent(EVENT_WESTFALL, 10s);
                    break;
                case DATA_OPERA_HALL_BEAUTIFUL_BEAST:
                    events.RescheduleEvent(EVENT_BEAUTIFUL_BEAST, 10s);
                    break;
                default:
                    break;
                }
        ...
        void MovementInform(uint32 type, uint32 id) override
        {
            if (type == POINT_MOTION_TYPE)
            {
                if (id == 1)
                {
                    ...
                    events.RescheduleEvent(EVENT_TELEPORT, 1s);
                }
            }
        }
        ...
        {
            if (Creature* spotlight = me->SummonCreature(NPC_THEATRE_SPOTLIGHT, me->GetPosition(), TEMPSUMMON_TIMED_DESPAWN, Seconds(spotlightTimer)))
            ...
            for (uint8 i = 0; i < 4; ++i)
                DelayTalk(me, (westfall ? 8 : 12) * i, Seconds(i + textIdx));

            events.RescheduleEvent(EVENT_END_TALK, (westfall ? 38s : 44s));
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_WIKKET_1:
                    ...
                    TextEvent(5000, 0);
                    events.RescheduleEvent(EVENT_WIKKET_2, 1s);
                    break;
                case EVENT_WIKKET_2:
                    Talk(1); // Welcome, ladies and gentlemen, to our--OOF!
                    events.RescheduleEvent(EVENT_WIKKET_3, 4s);
                    break;
                case EVENT_WIKKET_3:
    ...
    struct npc_rtk_monkey_kingAI : public ScriptedAI
    {
        ...
        void MovementInform(uint32 type, uint32 id) override
        {
            if (type == EFFECT_MOTION_TYPE)
            {
                ...
                case 2:
                {
                    events.RescheduleEvent(EVENT_5, 30s);
                    break;
                }
                case 3:
                    events.RescheduleEvent(EVENT_6, 2s);
                    break;
                }
            }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_2:
                    ...
                    break;
                case EVENT_3:
                    events.RescheduleEvent(EVENT_4, 2s);
                    break;
                case EVENT_4:
    ...
    struct boss_rtk_galindreAI : public boss_opera_encounters
    {
        ...
        void Reset() override
        {
            ...
            if (instance->GetData(DATA_OPERA_HALL_INTRO) != IN_PROGRESS)
            {
                ...
                events.RescheduleEvent(EVENT_WIK_GALINDRE_1, 5s);
                events.RescheduleEvent(EVENT_WIK_GALINDRE_2, 12s);
            }
        }
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.RescheduleEvent(EVENT_WIK_GALINDRE_AGGRO_TALK, 3s);
            events.RescheduleEvent(EVENT_WIK_GALINDRE_FLASHY_BOLT, 1s);
            events.RescheduleEvent(EVENT_WIK_GALINDRE_WONDROUS_RADIANCE, 8s);
            events.RescheduleEvent(EVENT_WIK_GALINDRE_MAGIC_MAGNIFICENT, 48s);
        }
        ...
        void MovementInform(uint32 type, uint32 id) override
        {
            if (type == EFFECT_MOTION_TYPE)
            {
                if (id == 1)
                {
                    ...
                    events.RescheduleEvent(EVENT_WIK_GALINDRE_3, 6s);
                }
            }
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_WIK_GALINDRE_3:
                    ...
                    events.RescheduleEvent(EVENT_WIK_GALINDRE_4, 10s);
                    break;
                ...
                case EVENT_WIK_GALINDRE_FLASHY_BOLT:
                    ...
                    events.RescheduleEvent(EVENT_WIK_GALINDRE_FLASHY_BOLT, 4s);
                    break;
                case EVENT_WIK_GALINDRE_WONDROUS_RADIANCE:
                    DoCastVictim(SPELL_WONDROUS_RADIANCE);
                    events.RescheduleEvent(EVENT_WIK_GALINDRE_WONDROUS_RADIANCE, 10s);
                    break;
...
public:
    ...
    struct boss_rtk_elfyraAI : public boss_opera_encounters
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.RescheduleEvent(EVENT_WIK_ELFYRA_DREARY_BOLT, 4s);
            events.RescheduleEvent(EVENT_WIK_ELFYRA_SUM_ASSISTANTS, 30s);
            events.RescheduleEvent(EVENT_WIK_ELFYRA_DEFY_GRAVITY, 11s);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_WIK_ELFYRA_SUM_ASSISTANTS:
                    ...
                    events.RescheduleEvent(EVENT_WIK_ELFYRA_SUM_ASSISTANTS, 32s);
                    events.RescheduleEvent(EVENT_WIK_ELFYRA_SUM_ASSISTANTS_2, 1s);
                    break;
                case EVENT_WIK_ELFYRA_SUM_ASSISTANTS_2:
                {
                    ...
                    for (uint8 i = 0; i < 3; i++)
                    {
                        ...
                        if (Creature* assistants = me->SummonCreature(NPC_WINGED_ASSISTANT, pos))
                        {
                            ...
                            assistants->AI()->DoZoneInCombat(assistants);
                        }
                    }
                    break;
                }
                case EVENT_WIK_ELFYRA_DEFY_GRAVITY:
                    ...
                    events.RescheduleEvent(EVENT_WIK_ELFYRA_DEFY_GRAVITY, 19s);
                    break;
                }
            }
            DoMeleeAttackIfReady();
...
public:
    ...
    struct boss_rtk_toe_kneeAI : public boss_opera_encounters
    {
        ...
        void RunEvents()
        {
            events.RescheduleEvent(EVENT_TOE_BURNING_LEG_SWEEP, 10s);
            events.RescheduleEvent(EVENT_TOE_DASHING_FLAME_GALE, 22s);
        }
        ...
        void SpellHitTarget(WorldObject* target, const SpellInfo* spell) override
        {
            ...
            case SPELL_DASHING_FLAME_GALE_FILTER:
                DoCast(target->ToUnit(), SPELL_DASHING_FLAME_GALE_CHARGE, true);
                break;
            case SPELL_DASHING_FLAME_GALE_CHARGE:
                DoCast(target->ToUnit(), SPELL_DASHING_FLAME_GALE_AT, true);
                events.RescheduleEvent(EVENT_TOE_DASHING_FLAME_GALE_CHARGE, 1s);
                break;
            }
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_TOE_BURNING_LEG_SWEEP:
                    ...
                    events.RescheduleEvent(EVENT_TOE_BURNING_LEG_SWEEP, 20s);
                    break;
                case EVENT_TOE_DASHING_FLAME_GALE:
                    Talk(SAY_TOE_FLAME_GALE);
                    DoCast(SPELL_DASHING_FLAME_GALE);
                    events.RescheduleEvent(EVENT_TOE_DASHING_FLAME_GALE, 30s);
                    events.RescheduleEvent(EVENT_TOE_DASHING_FLAME_GALE_CHARGE, 1s);
                    break;
...
public:
    ...
    struct boss_rtk_mrrgriaAI : public boss_opera_encounters
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.RescheduleEvent(EVENT_MRRG_THUNDER_RITUAL, 8s);
            events.RescheduleEvent(EVENT_MRRG_WASH_AWAY, 16s);
        }
        ...
        void DoAction(int32 const action) override
        {
            ...
            if (action == ACTION_3 && surrend)
            {
                ...
                {
                    Toe->SetDynamicFlag(UNIT_DYNFLAG_LOOTABLE);
                    boss_opera_encounters::JustDied(NULL);
                }
    ...
    void DamageTaken(Unit* /*attacker*/, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
        ...
        void SpellHitTarget(WorldObject* target, const SpellInfo* spell) override
        {
            ...
            case SPELL_WASH_AWAY_FILTER:
                target->CastSpell(target, SPELL_WASH_AWAY_AT, true);
                break;
            }
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_MRRG_THUNDER_RITUAL:
                    ...
                    events.RescheduleEvent(EVENT_MRRG_THUNDER_RITUAL, 18s);
                    break;
                case EVENT_MRRG_WASH_AWAY:
                    DoCast(SPELL_WASH_AWAY_FILTER);
                    events.RescheduleEvent(EVENT_MRRG_WASH_AWAY, 23s);
                    break;
                }
            }
            DoMeleeAttackIfReady();
            ...
            if (action == ACTION_3)
            {
                ...
                if (diedCountBB == 2)
                {
                    if (Creature* coggleston = instance->instance->GetCreature(instance->GetGuidData(NPC_COGGLESTON)))
                    {
                        ...
                        events.RescheduleEvent(EVENT_COGGLESTON_DENT_ARMOR, 9s);
                        events.RescheduleEvent(EVENT_SUMMON_HELPERS, 2s);
                        events.RescheduleEvent(EVENT_DINNER_BELL, 12s);
                    }
                }
                diedCountBB++;
            }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_DINNER_BELL:
                    ...
                    events.RescheduleEvent(EVENT_DINNER_BELL, 20s);
                    break;
                }
            }
            DoMeleeAttackIfReady();
...
public:
    ...
    struct boss_rtk_luminoreAI : public boss_opera_encounters
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.RescheduleEvent(EVENT_LUMINORE_BURNING_BLAZE, 2s);
            events.RescheduleEvent(EVENT_LUMINORE_HEAT_WAVE, 30s);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_LUMINORE_BURNING_BLAZE:
                    ...
                    {
                        castCount = 0;
                        events.RescheduleEvent(EVENT_LUMINORE_BURNING_BLAZE, 9s);
                    }
                    else
                        events.RescheduleEvent(EVENT_LUMINORE_BURNING_BLAZE, 3s);
                    break;
...
public:
    ...
    struct boss_rtk_babbletAI : public boss_opera_encounters
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.RescheduleEvent(EVENT_BABBLET_FIXATE, 1s);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_BABBLET_FIXATE:
                    playerGUID.Clear();
                    me->StopMoving();
                    if (Unit* target = SelectTarget(SelectTargetMethod::Random, 0, 60.0f, true, true, -SPELL_FIXATE))
                    {
                    ...
                    events.RescheduleEvent(EVENT_BABBLET_FIXATE, 11s);
                    events.RescheduleEvent(EVENT_BABBLET_FOLLOW_TARGET, 1s);
                    break;
                case EVENT_BABBLET_FOLLOW_TARGET:
                    ...
                    events.RescheduleEvent(EVENT_BABBLET_FOLLOW_TARGET, 5s);
                    break;
                }
            }
            DoMeleeAttackIfReady();
...
public:
    ...
    struct boss_rtk_cauldronsAI : public boss_opera_encounters
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.RescheduleEvent(EVENT_CAULDRON_SOUP_SPRAY, 1s);
            events.RescheduleEvent(EVENT_CAULDRON_LEFTOVERS, 8s);
        }
        ...
        void SpellHitTarget(WorldObject* target, const SpellInfo* spell) override
        {
            if (spell->Id == SPELL_SOUP_SPRAY)
                DoCast(target->ToUnit(), SPELL_DRENCHED, true);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_CAULDRON_SOUP_SPRAY:
                    ...
                    events.RescheduleEvent(EVENT_CAULDRON_SOUP_SPRAY, 3s);
                    break;
                case EVENT_CAULDRON_LEFTOVERS:
                    if (urand(0, 1))
                        Talk(SAY_CAULDRONS_LEFTOVERS);
                    DoCast(SPELL_LEFTOVERS);
                    events.RescheduleEvent(EVENT_CAULDRON_LEFTOVERS, 18s);
                    break;
                }
            }
            DoMeleeAttackIfReady();
    ...
    struct npc_rtk_west_generic_trashAI : public ScriptedAI
    {
        ...
        void SpellHitTarget(WorldObject* target, const SpellInfo* spell) override
        {
            ...
            case SPELL_POISONOUS_SHANK_FILTER:
                DoCast(target->ToUnit(), SPELL_POISONOUS_SHANK_TP, true);
                DoCast(target->ToUnit(), SPELL_POISONOUS_SHANK_DMG, true);
                break;
            }
        }
...
public:
    ...
    public:
        void HandleOnCast()
        {
            ...
            for (uint8 i = 0; i < 3; ++i)
                GetCaster()->SummonCreature(NPC_WINGED_ASSISTANT, GetCaster()->GetRandomNearPosition(frand(10.f, 15.f)), TEMPSUMMON_CORPSE_DESPAWN, 5s);
        }
