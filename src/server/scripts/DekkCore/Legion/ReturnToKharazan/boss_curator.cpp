...
public:
    ...
    struct boss_the_curatorAI : public BossAI
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.RescheduleEvent(EVENT_MANA_CHECK, 5s);
        }

        void DefaultEvent()
        {
            events.RescheduleEvent(EVENT_SUM_VOLATILE_ENERGY, 6s);
            events.RescheduleEvent(EVENT_POWER_DISCHARGE, 13s);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_SUM_VOLATILE_ENERGY:
                    ...
                    events.RescheduleEvent(EVENT_SUM_VOLATILE_ENERGY, 10s);
                    break;
                case EVENT_POWER_DISCHARGE:
                    DoCast(me, SPELL_POWER_DISCHARGE_FILTER, true);
                    events.RescheduleEvent(EVENT_POWER_DISCHARGE, 14s);
                    break;
...
public:
    ...
    struct npc_curator_volatile_energyAI : public ScriptedAI
    {
            ...
            //47:50
        {
            ...
            events.RescheduleEvent(EVENT_1, 7s); //47:57
        }
