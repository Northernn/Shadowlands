...
public:
    ...
    struct boss_mana_devourerAI : public BossAI
    {
        ...
        void JustEngagedWith (Unit* who) override
        {
            ...
            events.RescheduleEvent(EVENT_ARCANE_BOMB, 8s);
            events.RescheduleEvent(EVENT_ENERGY_VOID, 15s);
            events.RescheduleEvent(EVENT_ENERGY_DISCHARGE, 22s);
            events.RescheduleEvent(EVENT_COALESCE_POWER, 30s);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_ARCANE_BOMB:
                    ...
                    events.RescheduleEvent(EVENT_ARCANE_BOMB, 14s);
                    break;
                case EVENT_ENERGY_VOID:
                {
                    ...
                    events.RescheduleEvent(EVENT_ENERGY_VOID, 22s);
                    break;
                }
                case EVENT_ENERGY_DISCHARGE:
                    ...
                    events.RescheduleEvent(EVENT_ENERGY_DISCHARGE, 27s);
                    break;
