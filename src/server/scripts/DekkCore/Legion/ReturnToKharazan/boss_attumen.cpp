...
public:
    ...
    struct boss_rtk_midnightAI : public BossAI
    {
        ...
        void DefaultEvents(uint8 phaseEvent)
        {
            ...
            {
            case PHASE_1:
                events.RescheduleEvent(EVENT_INTANGIBLE_PRESENCE, 6s);
                events.RescheduleEvent(EVENT_MIGHTY_STOMP, 14s);
                //events.RescheduleEvent(EVENT_SPECTRAL_CHARGE, 47s); //47s
                break;
            case PHASE_2:
                events.RescheduleEvent(EVENT_CHECK_HEALTH, 1s);
                events.RescheduleEvent(EVENT_MEZAIR, 3s);
                break;
            }
        }
    ...
    void DamageTaken(Unit* /*attacker*/, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
        ...
        void MovementInform(uint32 type, uint32 id) override
        {
            if (type == POINT_MOTION_TYPE && id == 1003) // charge - SPELL_MEZAIR
                events.RescheduleEvent(EVENT_MOVING_TO_HUNTSMAN, 5s);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_INTANGIBLE_PRESENCE:
                {
                    ...
                    events.RescheduleEvent(EVENT_INTANGIBLE_PRESENCE, 58s);
                    break;
                }
                ...
                case EVENT_SPECTRAL_CHARGE:
                    ...
                    events.RescheduleEvent(EVENT_SPECTRAL_CHARGE, 47s);
                    break;
                ...
                case EVENT_MEZAIR:
                    ...
                    events.RescheduleEvent(EVENT_MEZAIR, 6s);
                    break;
...
public:
    ...
    struct npc_attumen_the_huntsmanAI : public ScriptedAI
    {
        ...
        {
            Talk(SAY_AGGRO);
            events.RescheduleEvent(EVENT_CHECK_VICTIM, 1s);
        }
        ...
        void DoAction(int32 const action) override
        {
            ...
            case ACTION_1:
                ...
                ride = false;
                me->RemoveUnitFlag(UNIT_FLAG_UNINTERACTIBLE);
                events.RescheduleEvent(EVENT_MORTAL_STRIKE, 10s);
                events.RescheduleEvent(EVENT_SHARED_SUFFERING, 18s);
                break;
            case ACTION_2:
                ride = true;
                events.Reset();
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_MORTAL_STRIKE:
                    ...
                    events.RescheduleEvent(EVENT_MORTAL_STRIKE, 16s);
                    break;
