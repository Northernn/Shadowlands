    ...
    public:
        ...
        struct boss_fengAI : public BossAI
        {
            ...
            void JustEngagedWith(Unit* attacker) override
            {
                ...
                Talk(TALK_AGGRO);
                events.ScheduleEvent(EVENT_SPIRIT_BOLTS, 25s);
            ...
            void DoAction(const int32 action) override
            {
                ...
                if (action == ACTION_SCHEDULE_SHIELD)
                    events.ScheduleEvent(EVENT_SIPHONING_SHIELD, 30s);
            }

            void PrepareNewPhase(uint8 newPhase)
            {
                events.Reset();
                events.ScheduleEvent(EVENT_DOT_ATTACK, 15s);
                events.ScheduleEvent(EVENT_RE_ATTACK,  5s);
                events.ScheduleEvent(EVENT_SPIRIT_BOLTS, 25s);
                ...
                switch (newPhase)
                {
                    case PHASE_FIST:
                    {
                        ...
                        events.ScheduleEvent(EVENT_LIGHTNING_FISTS,  20s, PHASE_FIST);
                        events.ScheduleEvent(EVENT_EPICENTER,        35s, PHASE_FIST);
                    ...
                    case PHASE_SPEAR:
                    {
                        ...
                        events.ScheduleEvent(EVENT_WILDFIRE_SPARK,   30s, PHASE_SPEAR);
                        events.ScheduleEvent(EVENT_DRAW_FLAME,       40s, PHASE_SPEAR);
                    ...
                    case PHASE_STAFF:
                    {
                        ...
                        events.ScheduleEvent(EVENT_ARCANE_VELOCITY,  25s, PHASE_STAFF);
                        events.ScheduleEvent(EVENT_ARCANE_RESONANCE, 40s, PHASE_STAFF);
                    ...
                    case PHASE_SHIELD:
                    {
                        ...
                        events.ScheduleEvent(EVENT_SIPHONING_SHIELD, 5s, PHASE_SHIELD);
                        events.ScheduleEvent(EVENT_CHAINS_OF_SHADOW, 45s, PHASE_SHIELD);
                        Talk(TALK_PHASE_4);
                        break;
                    }
                    default:
            ...
            void SpellHitTarget(WorldObject* target, SpellInfo const* spell) override
            {
                ...
                if (Aura* inversion = _target->GetAura(115911))
                {
              ...
              /*  if (pInstance)
                ...
                switch (events.ExecuteEvent())
                {
                    ...
                    case EVENT_DOT_ATTACK:
                    {
                        ...
                        events.ScheduleEvent(EVENT_DOT_ATTACK, 12s);
                        break;
                    }
                    ...
                    case EVENT_LIGHTNING_FISTS:
                    {
                        ...
                        events.ScheduleEvent(EVENT_LIGHTNING_FISTS, 20s);
                        break;
                    }
                    case EVENT_EPICENTER:
                    {
                        ...
                        events.ScheduleEvent(EVENT_EPICENTER, 35s);
                        break;
                    }
                    // Spear Phase
                    case EVENT_WILDFIRE_SPARK:
                    {
                        ...
                        events.ScheduleEvent(EVENT_WILDFIRE_SPARK, 25s);
                        break;
                    }
                    case EVENT_DRAW_FLAME:
                    {
                        ...
                        events.ScheduleEvent(EVENT_DRAW_FLAME, 60s);
                        break;
                    }
                    // Staff Phase
                    case EVENT_ARCANE_VELOCITY:
                    {
                        ...
                        events.ScheduleEvent(EVENT_ARCANE_VELOCITY_END, 1s);   // The eventmap don't update while the creature is casting
                        events.ScheduleEvent(EVENT_ARCANE_VELOCITY,     15s);
                        break;
                    }
                    ...
                    case EVENT_ARCANE_RESONANCE:
                    {
                        ...
                        events.ScheduleEvent(EVENT_ARCANE_RESONANCE, 40s);
                        break;
                    }
                    ...
                    case EVENT_CHAINS_OF_SHADOW:
                    {
                        ...
                        events.ScheduleEvent(EVENT_CHAINS_OF_SHADOW, 40s);
                        break;
                    }
                    default:
                        break;
    ...
    public :
        ...
        struct mob_siphon_shieldAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_SHIELD_BARRIER, 6s);
                events.ScheduleEvent(EVENT_SHIELD_CASTSOULS, 2s);
                ...
                while (uint32 eventID = events.ExecuteEvent())
                {
                    switch (eventID)
                    {
                        case EVENT_SHIELD_CASTSOULS:
                        {
                            ...
                            {
                                events.ScheduleEvent(EVENT_SHIELD_CHECKSOULS, 10s);
                                break;
                            }
                        ...
                        case EVENT_SHIELD_CHECKSOULS:
                        {
                            if (!soulsCount)
                            {
                                ...
                                events.ScheduleEvent(EVENT_SHIELD_BACK, 2s);
                            }
                            else
                                events.ScheduleEvent(EVENT_SHIELD_CHECKSOULS, 1s);
                            break;
                        }
                        case EVENT_SHIELD_BACK:
                        {
                            if (!pInstance)
                            {
                                events.ScheduleEvent(EVENT_SHIELD_DESTROY, 2s);
                                break;
                            }
    ...
    public:
        ...
        struct mob_soul_fragmentAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                me->AddAura(SPELL_FIST_BARRIER, me);
                events.ScheduleEvent(EVENT_SOUL_WALK, 2s);
                events.ScheduleEvent(EVENT_SOUL_GROW, 1s);
            }
