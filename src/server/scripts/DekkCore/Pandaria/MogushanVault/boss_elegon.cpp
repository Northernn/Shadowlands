    ...
    public:
        ...
        struct boss_elegonAI : public BossAI
        {
            boss_elegonAI(Creature* creature) : BossAI(creature, DATA_ELEGON)
            {
                ...
                creature->SetUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE|UNIT_FLAG_IMMUNE_TO_PC));
            }
            ...
            void JustEngagedWith(Unit* /*p_Attacker*/) override
            {
                ...
                events.ScheduleEvent(EVENT_CELESTIAL_BREATH, 10s);
                events.ScheduleEvent(EVENT_MATERIALIZE_PROTECTOR, 40s);
                events.ScheduleEvent(EVENT_ENRAGE_HARD, 57s); 
            }
            ...
            void DoAction(const int32 action) override
            {
                switch (action)
                {
                    ...
                    case ACTION_DESPAWN_ENERGY_CHARGES:
                    {
                        ...
                        {
                            Talk(TALK_C_TO_A_1);
                            events.ScheduleEvent(EVENT_DESPAWN_PLATFORM, 6s);
                            events.ScheduleEvent(EVENT_LAUNCH_COSMIC_SPARK, 6s);
                        }
                    ...
                    case ACTION_EMPYREAL_FOCUS_KILLED:
                    {
                        ...
                        events.ScheduleEvent(EVENT_END_OF_PHASE_3, 6s);
           ...
           void DamageTaken(Unit* attacker, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
            {
                if (phase == PHASE_1 && me->HealthBelowPctDamaged(nextPhase1EndingHealthPct, damage))
                {
                    ...
                    {
                        events.ScheduleEvent(EVENT_RADIATING_ENERGIES, 1s);
                        nextPhase1EndingHealthPct = 0.0f;
                    }

                    events.ScheduleEvent(EVENT_CHECK_MELEE, 2s);
                    events.ScheduleEvent(EVENT_DRAW_POWER, 1s);
                }
              ...
              /*  if (pInstance)
                ...
                switch (events.ExecuteEvent())
                {
                    ...
                    case EVENT_MATERIALIZE_PROTECTOR:
                    {
                        ...
                        events.ScheduleEvent(EVENT_MATERIALIZE_PROTECTOR, 35s);
                        break;
                    }
                    ...
                    case EVENT_DRAW_POWER:
                    {
                        ...
                        events.ScheduleEvent(EVENT_FOCUS_POWER, 1s); // We don't decount when casting
                        break;
                    }
                    case EVENT_FOCUS_POWER:
                    {
                        ...
                        events.ScheduleEvent(EVENT_DRAW_POWER, 1s); // We don't decount when casting
                        break;
                    }
                    // Phase 3
                    case EVENT_DESPAWN_PLATFORM:
                    {
                        ...
                        events.ScheduleEvent(EVENT_AFTER_DESPAWN_PLATFORM, 2s);
                    ...
                    case EVENT_LAUNCH_COSMIC_SPARK:
                    {
                        ...
                        events.ScheduleEvent(EVENT_LAUNCH_COSMIC_SPARK, 5s);
                        break;
                    }
                    // Others
            ...
            void DoAction(const int32 action) override
            {
                switch (action)
                {
                    case ACTION_ACTIVATE_EMPYREAL_FOCUS:
                    {
                        ...
                        events.ScheduleEvent(EVENT_ACTIVATE_EMPYREAL_FOCUS, 3s);
            ...
            void UpdateAI(const uint32 diff) override
            {
                ...
                switch (events.ExecuteEvent())
                {
                    case EVENT_ACTIVATE_EMPYREAL_FOCUS:
                        ...
                        events.ScheduleEvent(EVENT_APPEAR_WALL_OF_LIGHTNING, 3s);
                        break;
    ...
    public:
        ...
        struct mob_celestial_protectorAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_ARCING_ENERGY, 10s);
                events.ScheduleEvent(EVENT_CHECK_UNIT_ON_PLATFORM, 1s);

                stabilityFluxCasted     = false;
                totalAnnihilationCasted = false;

                if (Player* player = me->SelectNearestPlayer(105.0f))
                    AttackStart(player);
            }
            ...
            void DamageTaken(Unit* attacker, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
            {
                ...
                if (me->GetHealth() < damage)
                {
                    ...
                    if (!totalAnnihilationCasted)
                    {
                        ...
                        events.ScheduleEvent(EVENT_KILLED , 4s);
                    }
                }
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_ARCING_ENERGY:
                        {
                            ...
                            events.ScheduleEvent(EVENT_ARCING_ENERGY,      30s);
                            break;
                        }
                        case EVENT_KILLED:
                            me->KillSelf();
    ...
    public:
        ...
        struct mob_cosmic_sparkAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                if (Unit* player = SelectTarget(SelectTargetMethod::MinDistance))
                    AttackStart(player);

                events.ScheduleEvent(EVENT_CHECK_UNIT_ON_PLATFORM, 1s);
                events.ScheduleEvent(EVENT_ICE_TRAP, 10s);
                events.ScheduleEvent(EVENT_COSMICSPARK_ATTACK, 1s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_ICE_TRAP:
                        {
                            ...
                            events.ScheduleEvent(EVENT_ICE_TRAP,      60s);
                            break;
                        }
            ...
            void DoAction(const int32 action) override
            {
                switch (action)
                {
                    case ACTION_INFINITE_GO_DOWN:
                    {
                        ...
                        events.ScheduleEvent(EVENT_ACTIVATION_WEST, 3s);
                        break;
                    }
                    case ACTION_INFINITE_ACTIVATION_WEST:
                    {
                        ...
                        events.ScheduleEvent(EVENT_ACTIVATION, 1s);
                        break;
                    }
                    case ACTION_INFINITE_ACTIVATION:
                    {
                        ...
                        events.ScheduleEvent(EVENT_ACTIVATION_EAST, 1s);
                        break;
                    }
                    case ACTION_INFINITE_ACTIVATION_EAST:
                    {
                        ...
                        events.ScheduleEvent(EVENT_FLASH_SPAWN, 1s);
                        break;
                    }
                    ...
                    case ACTION_INFINITE_SPAWN_PLATFORM:
                    {
                        if (pInstance)
                        {
                            ...
                            events.ScheduleEvent(EVENT_CHECK_AURAS, 5s);
                        }
                        break;
                    }
                    case ACTION_INFINITE_SPAWN_BOSS:
                    {
                        if (pInstance)
                        {
                            if (Creature* elegon = pInstance->GetCreature(NPC_ELEGON))
                            {
                                ...
                                events.ScheduleEvent(EVENT_BOSS_INTRO_2,    5s);
                                events.ScheduleEvent(EVENT_BOSS_ACTIVATION, 8s);
                            }
                        }
                        break;
                    }
                    case ACTION_INFINITE_LOOT:
                    {
                        ...
                        // Loots chest
                        if (IsHeroic())
                            me->SummonGameObject(GOB_ELEGON_CHEST_HEROIC, middlePos.GetPositionX(), middlePos.GetPositionY(), middlePos.GetPositionZ(), 0.0f, QuaternionData(), 0s);
                        else
                            me->SummonGameObject(GOB_ELEGON_CHEST, middlePos.GetPositionX(), middlePos.GetPositionY(), middlePos.GetPositionZ(), 0.0f, QuaternionData(), 0s);
                        break;
                    }
                    default:
                        break;
            ...
            void UpdateAI(const uint32 diff) override
            {
                ...
                switch (events.ExecuteEvent())
                {
                    ...
                    case EVENT_BOSS_ACTIVATION:
                    {
                        if (pInstance)
                            if (Creature* elegon = pInstance->GetCreature(NPC_ELEGON))
                                elegon->RemoveUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE|UNIT_FLAG_IMMUNE_TO_PC));
                        break;
                    }
...
class go_celestial_control_console : public GameObjectScript
{
    public:
        ...
        struct go_celestial_control_consoleAI : public GameObjectAI
        {
            go_celestial_control_consoleAI(GameObject* go) : GameObjectAI(go) { }
        };
        GameObjectAI* GetAI(GameObject* go) const override
        {
            return new go_celestial_control_consoleAI(go);
        }
