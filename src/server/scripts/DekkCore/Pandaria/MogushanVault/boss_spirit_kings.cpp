                    ...
                    case ACTION_FLANKING_MOGU:
                    {
                        ...
                        for (uint8 i = moguBegin; i < moguBegin + 6; ++i)
                        {
                            ...
                            if (Creature* flankingMogu = pInstance->instance->GetCreature(flankingGuid[j]))
                            {
                                ...
                                flankingMogu->DespawnOrUnsummon();
                            ...
                            if (pInstance)
                            {
                                ...
                                for (auto entry: spiritKingsEntry)
                                {
                                    if (Creature* spirit = pInstance->GetCreature(entry))
                                    {
                                        ...
                                        if (Unit* killer = spirit->AI()->SelectTarget(SelectTargetMethod::Random))
                                            killer->KillSelf();
                                        else
                                            me->KillSelf();
                                    }
        ...
        struct boss_spirit_kingsAI : public ScriptedAI
        {
            ...
            void JustEngagedWith(Unit* /*attacker*/) override
            {
                ...
                switch (me->GetEntry())
                {
                    case NPC_ZIAN:
                        Talk(ZIAN_AGGRO);
                        events.ScheduleEvent(EVENT_UNDYING_SHADOWS, 30s);
                        events.ScheduleEvent(EVENT_SHADOW_BLAST, 15s);
                        events.ScheduleEvent(EVENT_CHARGED_SHADOWS, 10s);
                        if (IsHeroic())
                            events.ScheduleEvent(EVENT_SHIELD_OF_DARKNESS, 50s);
                        break;
                    case NPC_MENG:
                        Talk(MENG_AGGRO);
                        events.ScheduleEvent(EVENT_MADDENING_SHOUT, 21s);
                        events.ScheduleEvent(EVENT_CRAZED, 1s);
                        events.ScheduleEvent(EVENT_CRAZY_THOUGHT, 10s);
                        if (IsHeroic())
                            events.ScheduleEvent(EVENT_DELIRIOUS, 50s);
                    ...
                    {
                        Talk(QIANG_AGGRO);
                        events.ScheduleEvent(EVENT_FLANKING_MOGU, 40s);
                        events.ScheduleEvent(EVENT_MASSIVE_ATTACK, 3s);
                        events.ScheduleEvent(EVENT_ANNIHILATE, 15s);
                        if (IsHeroic())
                            events.ScheduleEvent(EVENT_IMPERVIOUS_SHIELD, 50s);
                        if (_introQiangDone)
                            me->RemoveAurasDueToSpell(SPELL_ACTIVATION_VISUAL);
                        else
                    ...
                    case NPC_SUBETAI:
                        Talk(SUBETAI_AGGRO);
                        events.ScheduleEvent(EVENT_PILLAGE, 30s);
                        events.ScheduleEvent(EVENT_VOLLEY_1, 20s);
                        events.ScheduleEvent(EVENT_RAIN_OF_ARROWS, 45s);
                        if (IsHeroic())
                            events.ScheduleEvent(EVENT_SLEIGHT_OF_HAND, 50s);
                        break;
                    default:
                        break;
                }
                ...
                switch (action)
                {
                    ...
                    case ACTION_CHECK_SPIRITKINGS:
                    {
                        if (GetClosestCreatureWithEntry(me, MOB_MENG, 200.0f, true))
                        {
                            ...
                            events.ScheduleEvent(EVENT_CHECK_SPIRITKINGS, 5s);
                            return;
                        }
                        else
                        {
                ...
                if (me->HealthBelowPctDamaged(5, damage) && !vanquished)
                {
                    ...
                    switch (me->GetEntry())
                    {
                        case NPC_QIANG:
                            ...
                            events.ScheduleEvent(EVENT_FLANKING_MOGU, 75s);
                            break;
                        case NPC_SUBETAI:
                            Talk(SUBETAI_DEATH);
                            events.ScheduleEvent(EVENT_PILLAGE, 30s);
                        ...
                        case NPC_MENG:
                            ...
                            events.ScheduleEvent(EVENT_MADDENING_SHOUT, 35s);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch(eventId)
                    {
                        ...
                        case EVENT_ANNIHILATE:
                        {
                            ...
                            events.ScheduleEvent(EVENT_ANNIHILATE, 20s);
                            break;
                        }
                        case EVENT_IMPERVIOUS_SHIELD:
                        {
                            ...
                            if (IsHeroic())
                                events.ScheduleEvent(EVENT_IMPERVIOUS_SHIELD, 45s);
                            break;
                        }
                        // Subetai
                        case EVENT_PILLAGE:
                        ...
                        case EVENT_VOLLEY_3:
                        {
                            ...
                            events.ScheduleEvent(eventId == EVENT_VOLLEY_3 ? EVENT_VOLLEY_1: eventId + 1, eventId == EVENT_VOLLEY_3 ? 15s: 50s);
                            break;
                        }
                        ...
                        case EVENT_SLEIGHT_OF_HAND:
                        {
                            ...
                            if (IsHeroic())
                                events.ScheduleEvent(EVENT_SLEIGHT_OF_HAND, 45s);
                            break;
                        }
                        // Zian
                        case EVENT_UNDYING_SHADOWS:
                        {
                            ...
                            if (shadowCount < maxShadowCount) // Max 3 undying shadow during the fight
                            {
                                ...
                                if (playerList.empty())
                                {
                                    events.ScheduleEvent(EVENT_UNDYING_SHADOWS, 10s);
                                    break;
                                }
                            ...
                            events.ScheduleEvent(EVENT_UNDYING_SHADOWS, 45s);
                            break;
                        }
                        ...
                        case EVENT_CHARGED_SHADOWS:
                        {
                            ...
                            events.ScheduleEvent(EVENT_CHARGED_SHADOWS, 15s);
                            break;
                        }
                        case EVENT_SHIELD_OF_DARKNESS:
                        {
                            ...
                            if (IsHeroic())
                                events.ScheduleEvent(EVENT_SHIELD_OF_DARKNESS, 45s);
                            break;
                        }
                        // Meng
                        case EVENT_MADDENING_SHOUT:
                        {
                            ...
                            Talk(MENG_SPELL);
                            events.ScheduleEvent(EVENT_MADDENING_SHOUT, 47s);
                            break;
                        }
                        case EVENT_CRAZED:
                        {
                        ...
                        case EVENT_CRAZY_THOUGHT:
                        {
                            ...
                            events.ScheduleEvent(EVENT_CRAZY_THOUGHT, 15s);
                            break;
                        }
                        case EVENT_DELIRIOUS:
                        {
                            ...
                            if (IsHeroic())
                                events.ScheduleEvent(EVENT_DELIRIOUS, 45s);
                            break;
                        }
...
class spell_massive_attacks : public SpellScriptLoader
{
    public:
        ...
        class spell_massive_attacks_SpellScript : public SpellScript
        {
            ...
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_massive_attacks_SpellScript::CheckTargets, EFFECT_0, TARGET_UNIT_CONE_ENEMY_24);
