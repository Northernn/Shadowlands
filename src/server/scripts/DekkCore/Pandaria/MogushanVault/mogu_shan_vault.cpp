...
class mob_cursed_mogu_sculpture : public CreatureScript
{
    public:
        ...
        struct mob_cursed_mogu_sculptureAI : public ScriptedAI
        {
            ...
            {
                events.Reset();
                events.ScheduleEvent(EVENT_CURSED_MOGU_SPIRIT_BOLT, 15s);
                events.ScheduleEvent(EVENT_CURSED_MOGU_GROUND_SLAM, 25s);
                if (me->GetEntry() == NPC_CURSED_MOGU_SCULPTURE_1)
                    events.ScheduleEvent(EVENT_CURSED_MOGU_ATTACK,  2s);
            }
...
class spell_ghost_essence : public SpellScript
{
    void HandleHitTarget(SpellEffIndex /*effIndex*/)
    {
        if (Creature* target = GetHitCreature())
        {
            ...
            target->RemoveUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE));
...
class mob_enormous_stone_quilen : public CreatureScript
{
    public:
        ...
        struct mob_enormous_stone_quilenAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                events.ScheduleEvent(EVENT_ENORMOUS_QUILEN_BITE, 5s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_ENORMOUS_QUILEN_BITE:
                        {
                            ...
                            events.ScheduleEvent(EVENT_ENORMOUS_QUILEN_BITE, 8s);
                            break;
                        }
                    }
                }
...
class mob_stone_quilen : public CreatureScript
{
    public:
        ...
        struct mob_stone_quilenAI : public ScriptedAI
        {
            ...
            {
                events.ScheduleEvent(EVENT_QUILEN_SUNDERING_BITE, 6s);
                events.ScheduleEvent(EVENT_QUILEN_SHATTERING_STONE, 12s);
                events.ScheduleEvent(EVENT_QUILEN_FOCUSED_ASSAULT, 5s);
        ...
        struct mob_zandalari_skullchargerAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                if (me->GetEntry() == NPC_ZANDALARI_SKULLCHARGER)
                    events.ScheduleEvent(EVENT_ZANDALARI_TROLL_RUSH, 6s);
            }
        ...
        struct npc_lorewalker_choAI : public EscortAI
        {
            ...
            void WaypointReached(uint32 waypointId, uint32 /*pathId*/) override
            {
                ...
                switch (waypointId)
                {
                                ...
                                for (uint8 i = 0; i < 4; ++i)
                                {
                                    ...
                                    for (auto itr : mobList)
                                    {
                                        ...
                                        if (itr->GetEntry() == NPC_SORCERER_MOGU)
                                        {
                                            ...
                                            events.ScheduleEvent(EVENT_START_FIRST_COMBAT, 4s);
                                        }
                                    }
                                }
                    ...
                    case 88:
                        events.ScheduleEvent(EVENT_TALK_6, 1s);
                        break;
                    default:
                        break;
                }
            ...
            void DoAction(const int32 action) override
            {
                switch (action)
                {
                    ...
                    {
                        events.ScheduleEvent(EVENT_TALK_11, 1s);
                        break;
                    }
            ...
            void UpdateAI(const uint32 diff) override
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_TALK_2:
                            Talk(30);
                            events.ScheduleEvent(EVENT_TALK_3, 5s);
                            break;
                        case EVENT_TALK_3:
                            Talk(31);
                            events.ScheduleEvent(EVENT_TALK_4, 4s);
                            break;
                        case EVENT_TALK_4:
                            Talk(32);
                            events.ScheduleEvent(EVENT_TALK_5, 7s);
                            break;
                        case EVENT_TALK_5:
                            Talk(33);
                            break;
                        case EVENT_TALK_6:
                            Talk(34);
                            events.ScheduleEvent(EVENT_TALK_7, 10s);
                            break;
                        case EVENT_TALK_7:
                            Talk(35);
                            events.ScheduleEvent(EVENT_TALK_8, 10s);
                            break;
                        case EVENT_TALK_8:
                            Talk(36);
                            events.ScheduleEvent(EVENT_TALK_9, 10s);
                            break;
                        case EVENT_TALK_9:
                            Talk(37);
                            events.ScheduleEvent(EVENT_TALK_10, 10s);
                            break;
                        case EVENT_TALK_10:
                            Talk(38);
                            break;
                        case EVENT_TALK_11:
                            Talk(40);
                            events.ScheduleEvent(EVENT_TALK_12, 10s);
                            break;
                        case EVENT_TALK_12:
                            Talk(41);
                            break;
            ...
            void DoAction(const int32 action) override
            {
                switch (action)
                {
                    ...
                    case ACTION_START_FIRST_COMBAT:
                        ...
                        me->SetReactState(REACT_AGGRESSIVE);
                        events.ScheduleEvent(EVENT_ZIAN_CHARGED_SHADOWS, 15s);
                        break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_ZIAN_CHARGED_SHADOWS:
                            ...
                            events.ScheduleEvent(EVENT_ZIAN_CHARGED_SHADOWS, 12s);
                            break;
                        default:
                            break;
                    }
            ...
            void DoAction(const int32 action) override
            {
                switch (action)
                {
                    ...
                    case ACTION_START_FIRST_COMBAT:
                        me->RemoveAurasDueToSpell(SPELL_ACTIVATION_VISUAL);
                        me->SetReactState(REACT_AGGRESSIVE);
                        events.ScheduleEvent(EVENT_SORCERER_SHADOW_BLAST, 5s);
                        break;
                    case ACTION_END_FIRST_COMBAT:
                        me->DespawnOrUnsummon();
                        break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_SORCERER_SHADOW_BLAST:
                            ...
                            events.ScheduleEvent(EVENT_SORCERER_SHADOW_BLAST, 17s);
                            break;
                        default:
                            break;
                    }
        ...
        struct mob_qiangAI : public ScriptedAI
        {
            ...
            void DoAction(const int32 action) override
            {
                switch (action)
                {
                    ...
                    case ACTION_BEFORE_COMBAT:
                        me->AddAura(SPELL_ACTIVATION_VISUAL, me);
                        events.ScheduleEvent(EVENT_QIANG_START_SECOND_FIGHT, 5s);
                        break;
                    case ACTION_START_SECOND_COMBAT:
                        me->RemoveAurasDueToSpell(SPELL_ACTIVATION_VISUAL);
                        me->SetReactState(REACT_AGGRESSIVE);
                        events.ScheduleEvent(EVENT_QIANG_ANNIHILATE, 15s);
                        break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_QIANG_ANNIHILATE:
                            ...
                            events.ScheduleEvent(EVENT_QIANG_ANNIHILATE, 20s);
                            break;
            ...
            void DoAction(const int32 action) override
            {
                switch (action)
                {
                    ...
                    case ACTION_START_SECOND_COMBAT:
                        me->RemoveAurasDueToSpell(SPELL_ACTIVATION_VISUAL);
                        me->SetReactState(REACT_AGGRESSIVE);
                        events.ScheduleEvent(EVENT_MOUNTED_MOGU_CRUSHING_ATTACKS, 12s);
                        break;
                    case ACTION_END_SECOND_COMBAT:
                        me->DespawnOrUnsummon();
                        break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_MOUNTED_MOGU_CRUSHING_ATTACKS:
                            ...
                            events.ScheduleEvent(EVENT_MOUNTED_MOGU_CRUSHING_ATTACKS, 25s);
                            break;
                        default:
                            break;
                    }
        ...
        struct mob_subetaiAI : public ScriptedAI
        {
            ...
            void DoAction(const int32 action) override
            {
                switch (action)
                {
                    ...
                    case ACTION_BEFORE_COMBAT:
                        me->AddAura(SPELL_ACTIVATION_VISUAL, me);
                        events.ScheduleEvent(EVENT_SUBETAI_START_THIRD_COMBAT, 5s);
                        break;
                    case ACTION_START_THIRD_COMBAT:
                        me->RemoveAurasDueToSpell(SPELL_ACTIVATION_VISUAL);
                        me->SetReactState(REACT_AGGRESSIVE);
                        events.ScheduleEvent(EVENT_SUBETAI_VOLLEY, 15s);
                        break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_SUBETAI_VOLLEY:
                            ...
                            events.ScheduleEvent(EVENT_SUBETAI_VOLLEY, 20s);
                            break;
            ...
            void DoAction(const int32 action) override
            {
                switch (action)
                {
                    ...
                    case ACTION_START_THIRD_COMBAT:
                        me->RemoveAurasDueToSpell(SPELL_ACTIVATION_VISUAL);
                        me->SetReactState(REACT_AGGRESSIVE);
                        events.ScheduleEvent(EVENT_MOGU_ARCHER_SHOOT, 12s);
                        break;
                    case ACTION_END_THIRD_COMBAT:
                        me->DespawnOrUnsummon();
                        break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_MOGU_ARCHER_SHOOT:
                            ...
                            events.ScheduleEvent(EVENT_MOGU_ARCHER_SHOOT,       25s);
                            break;
                        default:
                            break;
                    }
        ...
        struct mob_mengAI : public ScriptedAI
        {
            ...
            void DoAction(const int32 action) override
            {
                switch (action)
                {
                    ...
                    {
                        me->AddAura(SPELL_ACTIVATION_VISUAL, me);
                        events.ScheduleEvent(EVENT_MENG_START_FOURTH_COMBAT, 5s);
                        break;
                    }
                    case ACTION_START_FOURTH_COMBAT:
                    {
                        me->RemoveAurasDueToSpell(SPELL_ACTIVATION_VISUAL);
                        me->SetReactState(REACT_AGGRESSIVE);
                        events.ScheduleEvent(EVENT_MENG_COWARDICE, 25s);
                        break;
                    }
    ...
    public:
        ...
        struct mob_kingsguardAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.Reset();
                events.ScheduleEvent(EVENT_KINGS_GUARD_ENRAGE, 12s);
                events.ScheduleEvent(EVENT_KINGS_GUARD_REFLECTIVE_SHIELDS, 20s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_KINGS_GUARD_ENRAGE:
                            ...
                            events.ScheduleEvent(EVENT_KINGS_GUARD_ENRAGE, 25s);
                            break;
                        case EVENT_KINGS_GUARD_REFLECTIVE_SHIELDS:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_REFLECTIVE_SHIELDS, false);
                            events.ScheduleEvent(EVENT_KINGS_GUARD_REFLECTIVE_SHIELDS, 40s);
                            break;
                        default:
                            break;
                    }
...
class mob_mogu_secret_keeper : public CreatureScript
{
    public:
        ...
        struct mob_mogu_secret_keeperAI : public ScriptedAI
        {
            ...
            {
                events.Reset();
                events.ScheduleEvent(EVENT_SECRET_FLESH_TO_STONE, 12s);
                events.ScheduleEvent(EVENT_SECRET_STONE_BLOCK, 20s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_SECRET_FLESH_TO_STONE:
                            ...
                            events.ScheduleEvent(EVENT_SECRET_FLESH_TO_STONE,       25s);
                            break;
                        case EVENT_SECRET_STONE_BLOCK:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_STONE_BLOCK, false);
                            events.ScheduleEvent(EVENT_SECRET_STONE_BLOCK,       40s);
                            break;
                        default:
                            break;
                    }
    ...
    public:
        ...
        struct mob_mogu_wardenAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                {
                    events.ScheduleEvent(EVENT_WARDEN_FORCEFUL_SWING, 12s);
                    events.ScheduleEvent(EVENT_WARDEN_TOUCH_OF_NALAK_SHA, 20s);
                    events.ScheduleEvent(EVENT_WARDEN_WARDEN_S_FURY, 28s);
                }
            }
...
class mob_mogu_engine_keeper : public CreatureScript
{
    public:
        ...
        struct mob_mogu_engine_keeperAI : public ScriptedAI
        {
            ...
            {
                events.Reset();
                events.ScheduleEvent(EVENT_KEEPER_ENHANCED_RECONSTRUCTION, 12s);
                events.ScheduleEvent(EVENT_KEEPER_RECONSTRUCTING, 20s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_KEEPER_ENHANCED_RECONSTRUCTION:
                            ...
                            events.ScheduleEvent(EVENT_KEEPER_ENHANCED_RECONSTRUCTION,       30s);
                            break;
                        case EVENT_KEEPER_RECONSTRUCTING:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_RECONSTRUCTING, false);
                            events.ScheduleEvent(EVENT_KEEPER_RECONSTRUCTING,       30s);
                            break;
                        default:
                            break;
                    }
