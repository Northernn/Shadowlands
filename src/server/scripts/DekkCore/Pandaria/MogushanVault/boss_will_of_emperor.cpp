        ...
        struct boss_jin_qin_xiAI : public BossAI
        {
           ...
           // }
            ...
            void MovementInform(uint32 uiType, uint32 id) override
            {
                ...
                if (id == 2)
                {
                    me->RemoveUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_IMMUNE_TO_NPC | UNIT_FLAG_IMMUNE_TO_PC));
                    me->HandleEmoteCommand(EMOTE_ONESHOT_BOW);
                    events.ScheduleEvent(EVENT_BOSS_EMOTE, 2s);
                }
            }
            ...
            void JustDied(Unit* killer) override
            {
                ...
                if (me->GetEntry() == NPC_QIN_XI)
                {
                    if (Creature* anc_mogu_machine = GetClosestCreatureWithEntry(me, NPC_ANCIENT_MOGU_MACHINE, 200.0f))
                    {
                        ...
                        me->KillSelf(anc_mogu_machine->ToUnit());
                    }
            ...
            void DoAction(const int32 action) override
            {
                switch (action)
                {
                    case ACTION_ACTIVATE:
                    {
                        ...
                        // Appearing effect
                        isActive = true;
                        events.ScheduleEvent(EVENT_BOSS_CAST_SKYBEAM, 90s);
                        ...
                        // --- Summoning adds ---
                        events.ScheduleEvent(EVENT_SUMMON_RAGE, 11s);

                        // --- Attacks ---
                        events.ScheduleEvent(EVENT_DEVASTATING_COMBO, 115s);
                        events.ScheduleEvent(EVENT_CHECK_MAGNETIC_ARMOR, 112s);
                        break;
                    }
             ...
             /*   if (pInstance)
                ...
                switch(events.ExecuteEvent())
                {
                    case EVENT_BOSS_CAST_SKYBEAM:
                    {
                        ...
                        events.ScheduleEvent(EVENT_BOSS_CAST_SPAWNIN, 6s);
                        break;
                    }
                    case EVENT_BOSS_CAST_SPAWNIN:
                    {
                        ...
                        events.ScheduleEvent(EVENT_BOSS_WAIT, 5s);
                        break;
                    }
                    case EVENT_BOSS_WAIT:
                    {
                        ...
                        events.ScheduleEvent(EVENT_BOSS_WAIT_VISIBLE, 2s);
                        break;
                    }
                    ...
                    case EVENT_SUMMON_RAGE:
                    {
                        ...
                        if (me->GetEntry() == NPC_JAN_XI)
                        {
                            ...
                            events.ScheduleEvent(EVENT_SUMMON_STRENGTH + sumCourage, 5s);
                            ...
                            events.ScheduleEvent(EVENT_SUMMON_RAGE, 20s);
                        }
                        break;
                    }
                    ...
                    case EVENT_DEVASTATING_COMBO:
                    {
                        ...
                        if (!devastatingComboPhase)
                        {
                            ...
                            me->SetUnitFlag(UnitFlags(UNIT_FLAG_PACIFIED|UNIT_FLAG_REMOVE_CLIENT_CONTROL|UNIT_FLAG_STUNNED));
                        ...
                        if (!(devastatingComboPhase % 2))
                        {
                            ...
                            if (/*comboArc = */urand(0, 1))
                            {
                                ...
                                events.ScheduleEvent(EVENT_BOSS_FREEZE, 3s);
                            }
                            else
                            {
                                // Emote for stomp
                                ...
                                events.ScheduleEvent(EVENT_DEVASTATING_COMBO, 2s);
                            }
                        }
                        ...
                        else
                        {
                            ...
                            if (devastatingComboPhase < maxCombo && !aliveList.empty())
                            {
                                ...
                                events.ScheduleEvent(EVENT_DEVASTATING_COMBO, 7s);
                            }
                            else
                            {
                                ...
                                events.ScheduleEvent(EVENT_DEVASTATING_COMBO, 30s);
                            }
                        }
                        break;
                    }
                    ...
                    case EVENT_CHECK_MAGNETIC_ARMOR:
                    {
                        if (!me->GetVictim())
                        {
                            ...
                            {
                                events.ScheduleEvent(EVENT_CHECK_MAGNETIC_ARMOR, 5s);
                                break;
                            }
    ...
    public:
        ...
        struct mob_woe_add_genericAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                // Wait before casting
                events.ScheduleEvent(EVENT_CAST_SKYBEAM, 1s);
                ...
                if (id == 1)
                {
                    ...
                    switch (me->GetEntry())
                    {
                        case NPC_EMPEROR_RAGE:
                        {
                            ...
                            events.ScheduleEvent(EVENT_RAGE_FIRST_ATTACK, 2s);
                            break;
                        }
                        case NPC_EMPEROR_COURAGE:
                        {
                            ...
                            events.ScheduleEvent(EVENT_IMPEDING_THRUST, 5s);
                            events.ScheduleEvent(EVENT_PHALANX_WALL, 3s);
                            events.ScheduleEvent(EVENT_CHECK_FOCDEF, 3s);
                            break;
                        }
                        case NPC_EMPEROR_STRENGHT:
                        {
                            ...
                            events.ScheduleEvent(EVENT_ENERGIZING_SMASH, 10s);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_CAST_SKYBEAM:
                        {
                            ...
                            // Wait invisible
                            events.ScheduleEvent(EVENT_CAST_SPAWNIN, 6s);
                            break;
                        }
                        case EVENT_CAST_SPAWNIN:
                        {
                            ...
                            // Wait invisible
                            events.ScheduleEvent(EVENT_WAIT, 5s);
                            break;
                        }
                        case EVENT_WAIT:
                        {
                            ...
                            events.ScheduleEvent(EVENT_WAIT_VISIBLE, 2s);
                            break;
                        }
                        ...
                        case EVENT_IMPEDING_THRUST:
                        {
                            if (Unit* victim = me->GetVictim())
                            {
                                if (me->IsWithinMeleeRange(victim))
                                {
                                    ...
                                    events.ScheduleEvent(EVENT_IMPEDING_THRUST, 10s);
                                }
                                else
                                    events.ScheduleEvent(EVENT_IMPEDING_THRUST, 2s);
                            }
                            else
                                events.ScheduleEvent(EVENT_IMPEDING_THRUST, 2s);
                            break;
                        ...
                        case EVENT_CHECK_FOCDEF:
                        {
                            ...
                            if (!me->GetVictim())
                            {
                                    ...
                                    if (Creature* qinxi = pInstance->GetCreature(NPC_QIN_XI))
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        target = SelectTarget(SelectTargetMethod::MaxThreat);
                                        if (target)
                                        {
                                            targetGuid = target->GetGUID();
                                            AttackStart(target);
                            ...
                            events.ScheduleEvent(EVENT_CHECK_FOCDEF, 2s);
                            break;
                        }
                        // Strenght
                        case EVENT_ENERGIZING_SMASH:
                        {
                            ...
                            events.ScheduleEvent(EVENT_ENERGIZING_SMASH, 20s);
                            break;
                        }
                        default:
                            break;
    ...
    public:
        ...
        struct mob_woe_titan_sparkAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                targetGuid = target->GetGUID();
                me->AddAura(SPELL_FOCALISED_ENERGY, target);
                events.ScheduleEvent(EVENT_CHECK_DISTANCE, 2s);
...
class mob_ancient_mogu_machine : public CreatureScript
{
    public:
        ...
        struct mob_ancient_mogu_machineAI : public ScriptedAI
        {
            ...
            {
                pInstance = creature->GetInstanceScript();
                me->SetUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_IMMUNE_TO_NPC | UNIT_FLAG_IMMUNE_TO_PC));
            }
            ...
            void DoAction(const int32 action) override
            {
                switch (action)
                {
                    ...
                    {
                        events.ScheduleEvent(EVENT_TITAN_GAS, IsHeroic() ? 100s : 225s);
                        break;
                    }
                ...
                switch (events.ExecuteEvent())
                {
                    ...
                    case EVENT_TITAN_GAS:
                    {
                     ...
                     //   me->CastSpell(CENTER_X, CENTER_Y, CENTER_Z, IsHeroic() ? SPELL_TITAN_GAS_HEROIC : SPELL_TITAN_GAS, false);
                        ...
                        if (!IsHeroic())
                        {
                            events.ScheduleEvent(EVENT_END_TITAN_GAS, 30s);
                            events.ScheduleEvent(EVENT_TITAN_GAS, 210s);
                        }
                        break;
                    }
        ...
        struct mob_general_purpose_bunnyJMFAI : public ScriptedAI
        {
           ...
           void DamageTaken(Unit* attacker, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
            ...
            void Reset() override
            {
                ...
                me->SetUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_IMMUNE_TO_PC));
                me->SetReactState(REACT_PASSIVE);
                me->SetFullHealth();
...
class go_ancien_control_console : public GameObjectScript
{
    public:
        ...
        struct go_ancien_control_consoleAI : public GameObjectAI
        {
            go_ancien_control_consoleAI(GameObject* go) : GameObjectAI(go) { }

            bool OnGossipHello(Player* player) override
            {
                if (InstanceScript* pInstance = player->GetInstanceScript())
                {
                    if (pInstance->CheckRequiredBosses(DATA_WILL_OF_EMPEROR))
                    {
                        // Activate central mob
                        std::list<Creature*> bunny;
                        GetCreatureListWithEntryInGrid(bunny, me, NPC_GENERAL_PURPOSE_BUNNY_JMF, 100.0f);
                        ...
                        if (Creature* cho = GetClosestCreatureWithEntry(me, NPC_LOREWALKER_CHO, 20.0f, true))
        ...
        {
            return new go_ancien_control_consoleAI(go);
        }
};
