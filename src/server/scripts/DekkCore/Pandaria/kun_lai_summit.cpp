                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_VANISH:
                            ...
                            events.ScheduleEvent(EVENT_SMOKED_BLADE, 8s);
                            break;
    ...
    public:
        ...
        struct mob_havakAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_DEVASTATING_ARC,   50s);
                events.ScheduleEvent(EVENT_SUMMON_QUILEN,     15s);
                events.ScheduleEvent(EVENT_TITANIC_STRENGH,   32s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_TITANIC_STRENGH:
                            ...
                            events.ScheduleEvent(EVENT_TITANIC_STRENGH, 40s);
                            break;
    ...
    public:
        ...
        struct npc_xuenAI : public ScriptedAI
        {
            ...
            bool OnGossipHello(Player* player) override
            {
                ...
                {
                    if (!me->AI()->GetData(XUEN_PHASE_1))
                    {
                        me->AI()->DoAction(ACTION_CONVERSATION);
                        player->KilledMonsterCredit(KILLED_CREDIT_FIRST_PHASE);
                        me->AI()->SetGUID(player ? player->GetGUID() : ObjectGuid::Empty);
                        me->AI()->SetData(XUEN_PHASE_1, DONE);
                    }

                    if (me->AI()->GetData(XUEN_PHASE_2))
                    {
                        me->AI()->DoAction(ACTION_SECOND_CONVERSATION);
                        player->KilledMonsterCredit(KILLED_CREDIT_SECOND_PHASE);
                        me->AI()->SetData(XUEN_PHASE_2, DONE);
                    }

                    if (me->AI()->GetData(XUEN_PHASE_3))
                    {
                        player->KilledMonsterCredit(KILLED_CREDIT_THIRD_PHASE);
                        me->AI()->DoAction(ACTION_THIRD_CONVERSATION);
                        me->AI()->SetData(XUEN_PHASE_3, DONE);
                    }
                }
            ...
            void DoAction(int32 action) override
            {
                switch (action)
                {
                    case ACTION_CONVERSATION:
                        events.ScheduleEvent(EVENT_XUEN_TALK_1, 2s);
                        events.ScheduleEvent(EVENT_TARAN_ZHU_TALK_1, 7s);
                        events.ScheduleEvent(EVENT_ANDRUIN_TALK_1, 13s);
                        events.ScheduleEvent(EVENT_TARAN_ZHU_TALK_2, 20s);
                        events.ScheduleEvent(EVENT_XUEN_TALK_2, 30s);
                        events.ScheduleEvent(EVENT_PLAYER_TELEPORT, 31s);
                        events.ScheduleEvent(EVENT_SPAWN_SPIRIT_OF_VIOLENCE, 34s);
                        events.ScheduleEvent(EVENT_TARAN_ZHU_TALK_3, 45s);
                        events.ScheduleEvent(EVENT_ANDRUIN_TALK_2, 51s);
                        events.ScheduleEvent(EVENT_SPAWN_SPIRIT_OF_VIOLENCE, 54s);
                        events.ScheduleEvent(EVENT_ZHI_TALK_1, 63s);
                        break;
                    case ACTION_SECOND_CONVERSATION:
                        events.ScheduleEvent(EVENT_XUEN_TALK_3, 2s);
                        events.ScheduleEvent(EVENT_PLAYER_TELEPORT, 6s);
                        events.ScheduleEvent(EVENT_SPAWN_SPIRIT_OF_ANGER, 9s);
                        events.ScheduleEvent(EVENT_ANDRUIN_TALK_3, 15s);
                        events.ScheduleEvent(EVENT_TARAN_ZHU_TALK_4, 28s);
                        events.ScheduleEvent(EVENT_SPAWN_SPIRIT_OF_VIOLENCE, 30s);
                        events.ScheduleEvent(EVENT_ZHI_TALK_2, 36s);
                        break;
                    case ACTION_THIRD_CONVERSATION:
                        events.ScheduleEvent(EVENT_XUEN_TALK_4, 2s);
                        events.ScheduleEvent(EVENT_PLAYER_TELEPORT, 6s);
                        events.ScheduleEvent(EVENT_SPAWN_SPIRIT_OF_HATRED, 8s);
                        events.ScheduleEvent(EVENT_ANDRUIN_TALK_4, 20s);
                        break;
                    ...
                    case ACTION_FINAL_KILL_CREDIT:
                        events.ScheduleEvent(EVENT_FINAL_KILL_CREDIT, 1s);
                        break;
                    default:
                        break;
                }
    ...
    public:
        ...
        struct mob_spirit_of_violenceAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_UNTAMED_FURY, 3s);
                events.ScheduleEvent(EVENT_HATED_BLAST, 12s);
                events.ScheduleEvent(EVENT_SHA_CORRUPTION, 23s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_UNTAMED_FURY:
                            ...
                            events.ScheduleEvent(EVENT_UNTAMED_FURY,      20s);
                            break;
                        case EVENT_HATED_BLAST:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_HATED_BLAST, false);
                            events.ScheduleEvent(EVENT_HATED_BLAST, 20s);
                            break;
    ...
    public:
        ...
        struct mob_spirit_of_angerAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_DEVASTATION, 3s);
                events.ScheduleEvent(EVENT_HATED_BLAST, 12s);
                events.ScheduleEvent(EVENT_SHA_CORRUPTION, 23s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_DEVASTATION:
                            ...
                            events.ScheduleEvent(EVENT_DEVASTATION,      20s);
                            break;
                        case EVENT_HATED_BLAST:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_HATED_BLAST, false);
    ...
    public:
        ...
        struct mob_spirit_of_hatredAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_HATED_BLAST, 12s);
                events.ScheduleEvent(EVENT_SHA_CORRUPTION, 23s);
                events.ScheduleEvent(EVENT_WHIRLWIND_OF_ANGER, 32s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_WHIRLWIND_OF_ANGER:
                            ...
                            events.ScheduleEvent(EVENT_WHIRLWIND_OF_ANGER, 20s);
                            break;
                        default:
                            break;
                    }
...
class npc_questgiver_xuen : public CreatureScript
{
    public:
        ...
        struct npc_questgiver_xuenAI : public ScriptedAI
        {
            npc_questgiver_xuenAI(Creature* creature) : ScriptedAI(creature) { }
        };
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_questgiver_xuenAI(creature);
        }
    ...
    public:
        ...
        struct mob_lun_chiAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_CHI_TORPEDO, 3s);
                events.ScheduleEvent(EVENT_KNOCKDOWN, 12s);
                events.ScheduleEvent(EVENT_SPINNING_CRANE_KICK, 23s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_CHI_TORPEDO:
                            ...
                            events.ScheduleEvent(EVENT_CHI_TORPEDO, 28s);
                            break;
                        case EVENT_KNOCKDOWN:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_KNOCKDOWN, false);
                            events.ScheduleEvent(EVENT_KNOCKDOWN, 28s);
                            break;
                        case EVENT_SPINNING_CRANE_KICK:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_SPINNING_CRANE_KICK, false);
                            events.ScheduleEvent(EVENT_SPINNING_CRANE_KICK, 28s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
    ...
    public:
        ...
        struct mob_brewmaster_chaniAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_BITTER_BREW, 3s);
                events.ScheduleEvent(EVENT_THE_STEAMER, 12s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_BITTER_BREW:
                            ...
                            events.ScheduleEvent(EVENT_BITTER_BREW, 18s);
                            break;
                        case EVENT_THE_STEAMER:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_THE_STEAMER, false);
                            events.ScheduleEvent(EVENT_THE_STEAMER, 18s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
    ...
    public:
        ...
        struct mob_kang_bramblestaffAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_DEATH_FROM_ABOVE, 3s);
                events.ScheduleEvent(EVENT_KNOCKDOWN, 12s);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_DEATH_FROM_ABOVE:
                            ...
                            events.ScheduleEvent(EVENT_DEATH_FROM_ABOVE, 25s);
                            break;
                        case EVENT_KNOCKDOWN:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_KNOCKDOWN, false);
                            events.ScheduleEvent(EVENT_KNOCKDOWN, 25s);
                            break;
...
//                events.ScheduleEvent(EVENT_HEALING_SPHERE, 3s);
                events.ScheduleEvent(EVENT_WATER_SPOUT, 12s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_HEALING_SPHERE:
                            ...
                            events.ScheduleEvent(EVENT_HEALING_SPHERE, 18s);
                            break;
                        case EVENT_WATER_SPOUT:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_WATER_SPOUT, false);
                            events.ScheduleEvent(EVENT_WATER_SPOUT, 18s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
    ...
    public:
        ...
        struct mob_ken_kenAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_ENRAGE, 3s);
                events.ScheduleEvent(EVENT_KEN_KEN_RAMPAGE, 12s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_ENRAGE:
                            ...
                            events.ScheduleEvent(EVENT_ENRAGE, 18s);
                            break;
                        case EVENT_KEN_KEN_RAMPAGE:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_KEN_KEN_RAMPAGE, false);
                            events.ScheduleEvent(EVENT_KEN_KEN_RAMPAGE, 18s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
    ...
    public:
        ...
        struct mob_the_wrestlerAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_GRAPPLE_OPPONENT, 3s);
                events.ScheduleEvent(EVENT_SLING_SWEAT, 12s);
                events.ScheduleEvent(EVENT_VULNERABLE, 43s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_GRAPPLE_OPPONENT:
                            ...
                            events.ScheduleEvent(EVENT_GRAPPLE_OPPONENT, 25s);
                            break;
                        case EVENT_SLING_SWEAT:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_SLING_SWEAT, false);
                            events.ScheduleEvent(EVENT_SLING_SWEAT, 25s);
                            break;
                        case EVENT_VULNERABLE:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_VULNERABLE, false);
                            events.ScheduleEvent(EVENT_VULNERABLE, 50s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
    ...
    public:
        ...
        struct mob_master_boom_boomAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_HEAVY_DYNAMITE, 3s);
                events.ScheduleEvent(EVENT_TOSS_A_BOOM_BOOM, 12s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_HEAVY_DYNAMITE:
                            ...
                            events.ScheduleEvent(EVENT_HEAVY_DYNAMITE, 18s);
                            break;
                        case EVENT_TOSS_A_BOOM_BOOM:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_TOSS_A_BOOM_BOOM, false);
                            events.ScheduleEvent(EVENT_TOSS_A_BOOM_BOOM, 18s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
    ...
    public:
        ...
        struct mob_master_windfurAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_WIND_SWORD, 3s);
                // events.ScheduleEvent(EVENT_WINDFUR_PUNCH, 12s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_WIND_SWORD:
                            ...
                            events.ScheduleEvent(EVENT_WIND_SWORD, 18s);
                            break;
                        case EVENT_WINDFUR_PUNCH:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_WINDFUR_PUNCH, false);
                            events.ScheduleEvent(EVENT_WINDFUR_PUNCH, 18s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
    ...
    public:
        ...
        struct mob_tankissAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_FLAY, 3s);
                events.ScheduleEvent(EVENT_FULL_CONTACT_INTERVENE, 12s);
                events.ScheduleEvent(EVENT_GROUND_PUMMEL, 18s);
            }
    ...
    public:
        ...
        struct mob_healissAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                // events.ScheduleEvent(EVENT_HEALISS_OIL, 3s);
                // events.ScheduleEvent(EVENT_JUNGE_REMEDY, 12s);
                events.ScheduleEvent(EVENT_MIND_FLAY, 18s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_HEALISS_OIL:
                            ...
                            events.ScheduleEvent(EVENT_HEALISS_OIL, 25s);
                            break;
                        case EVENT_JUNGE_REMEDY:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_JUNGE_REMEDY, false);
                            events.ScheduleEvent(EVENT_JUNGE_REMEDY, 25s);
                            break;
                        case EVENT_MIND_FLAY:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_MIND_FLAY, false);
                            events.ScheduleEvent(EVENT_MIND_FLAY, 25s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_ACID_SPLIT:
                            ...
                            events.ScheduleEvent(EVENT_ACID_SPLIT, 25s);
                            break;
                        case EVENT_BACKSTAB:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_BACKSTAB, false);
                            events.ScheduleEvent(EVENT_BACKSTAB, 25s);
                            break;
                        case EVENT_VILE_SPITTLE:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_VILE_SPITTLE, false);
                            events.ScheduleEvent(EVENT_VILE_SPITTLE, 25s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
