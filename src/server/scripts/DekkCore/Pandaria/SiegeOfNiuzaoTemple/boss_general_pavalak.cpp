...
public:
    ...
    struct boss_general_pavalakAI : public BossAI
    {
        ...
        void JustEngagedWith(Unit* who)
        {
            ...
            events.ScheduleEvent(EVENT_CAST_BLADE_RUSH, 8s);
            events.ScheduleEvent(EVENT_CAST_TEMPEST, 15s);
        ...
        void MovementInform(uint32 type, uint32 pointId)
        {
            ...
            if (pointId == POINT_GENERAL_PAVALAK_CALL_IN_REINFORCEMENTS)
            {
                ...
                events.ScheduleEvent(EVENT_CALL_REINFORCEMENTS, 5s);
            }
            //! Charge
            else if (pointId == 1003)
            {
                me->ApplySpellImmune(0, IMMUNITY_STATE, SPELL_AURA_MOD_TAUNT, false);
                events.ScheduleEvent(EVENT_DO_CHARGE_DAMAGE_EFFECT, 2s);
            }
        }
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_CAST_BLADE_RUSH:
                    ...
                    events.ScheduleEvent(EVENT_CAST_BLADE_RUSH, 9s);
                    events.ScheduleEvent(EVENT_CHARGE_AT_BLADE_RUSH_POS, 1s);
                    break;
                ...
                case EVENT_DO_CHARGE_DAMAGE_EFFECT:
                    if (Creature* bladerush = me->FindNearestCreature(NPC_BLADE_RUSH, 150.0f))
                    {
                        ...
                        bladerush->DespawnOrUnsummon();
                    }

                    events.ScheduleEvent(EVENT_START_ATTACKING_AGAIN, 1s);
                    break;
                ...
                case EVENT_CALL_REINFORCEMENTS:
                    Talk(4);
                    events.ScheduleEvent(EVENT_SUMMON_SIEGE_EXPLOSIVE, 1s);
                    events.ScheduleEvent(EVENT_STOP_BULWARK, 60s); //! From videos
                ...
                case EVENT_SUMMON_SIEGE_EXPLOSIVE:
                    ...
                    events.ScheduleEvent(EVENT_SUMMON_SIEGE_EXPLOSIVE, 7s);
                    break;
                }
            }
        ...
        void StopBulwark()
        {
            ...
            events.ScheduleEvent(EVENT_CAST_BLADE_RUSH, 17s);
            events.ScheduleEvent(EVENT_CAST_TEMPEST, 15s);
        }
...
public:
    ...
    struct npc_general_pavalak_siege_explosiveAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            events.ScheduleEvent(EVENT_REPOSITION_EXPLOSIVE, 5s);
            events.ScheduleEvent(EVENT_ARM_BOMB, 6s);
            me->SetReactState(REACT_PASSIVE);
        }
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            case EVENT_ARM_BOMB:
                ...
                events.ScheduleEvent(EVENT_SIEGE_EXPLOSIVE_DETONATE, 3s);
                break;
