...
class instance_siege_of_niuzao_temple : public InstanceMapScript
{
    public:
        ...
        struct instance_siege_of_niuzao_temple_InstanceMapScript : public InstanceScript
        {
            ...
            // Bosses.
            ObjectGuid uiVizierJinbakGuid{};
            ObjectGuid uiCommanderVojakGuid{};
            ObjectGuid uiGeneralPavalakGuid{};
            ObjectGuid uiWingLeaderNeronokGuid{};
            ...
            void OnCreatureCreate(Creature* creature)
            {
                switch(creature->GetEntry())
                {
                    ...
                    case BOSS_VIZIER_JINBAK:
                        uiVizierJinbakGuid = creature->GetGUID();
                        break;
                    case BOSS_COMMANDER_VOJAK:
                        uiCommanderVojakGuid = creature->GetGUID();
                        break;
                    case BOSS_GENERAL_PAVALAK:
                        uiGeneralPavalakGuid = creature->GetGUID();
                        break;
                    case BOSS_WING_LEADER_NERONOK:
                        uiWingLeaderNeronokGuid = creature->GetGUID();
                        break;
