                ...
                switch (action)
                {
                    ...
                    case ACTION_CONVERSATION:
                        if (!conversationEngaged)
                        {
                            ...
                            events.ScheduleEvent(EVENT_PRINCE_TALK_1, 3s);
                            events.ScheduleEvent(EVENT_KAIROZ_TALK_1, 6s);
                            events.ScheduleEvent(EVENT_PRINCE_TALK_2, 11s);
                            events.ScheduleEvent(EVENT_KAIROZ_TALK_2, 18s);
                            events.ScheduleEvent(EVENT_PRINCE_TALK_3, 25s);
                            events.ScheduleEvent(EVENT_KAIROZ_TALK_3, 32s);
                            events.ScheduleEvent(EVENT_PRINCE_TALK_4, 39s);
                            events.ScheduleEvent(EVENT_KAIROZ_TALK_4, 46s);
                            events.ScheduleEvent(EVENT_KAIROZ_TALK_5, 54s);
                            events.ScheduleEvent(EVENT_PRINCE_TALK_5, 60s);
                        }
                        break;
                    default:
                        break;
...
public:
    ...
    struct npc_emperor_shaohaoAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            events.RescheduleEvent(urand(EVENT_CHIJI_START, EVENT_NIUZAO_START), 60s);
        }
        ...
        void DoAction(const int32 action)
        {
            ...
            case ACTION_CHIJI_END:
                events.RescheduleEvent(EVENT_CHIJI_END, 10s);
                break;
            case ACTION_CHIJI_FAIL:
                events.RescheduleEvent(EVENT_CHIJI_START, 30s);
                break;
            case ACTION_XUEN_END:
                events.RescheduleEvent(EVENT_XUEN_END, 10s);
                break;
            case ACTION_XUEN_FAIL:
                events.RescheduleEvent(EVENT_XUEN_START, 30s);
                break;
            case ACTION_YULON_END:
                events.RescheduleEvent(EVENT_YULON_END, 10s);
                break;
            case ACTION_YULON_FAIL:
                events.RescheduleEvent(EVENT_YULON_START, 30s);
                break;
            case ACTION_NIUZAO_END:
                events.RescheduleEvent(EVENT_NIUZAO_END, 10s);
                break;
            case ACTION_NIUZAO_FAIL:
                events.RescheduleEvent(EVENT_NIUZAO_START, 30s);
                break;
            }
        }
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_CHIJI_END:
                    ...
                    events.RescheduleEvent(EVENT_XUEN_START, 60s);
                    break;
                ...
                case EVENT_XUEN_END:
                    ...
                    events.RescheduleEvent(EVENT_YULON_START, 60s);
                    break;
                ...
                case EVENT_YULON_END:
                {
                    ...
                    events.RescheduleEvent(EVENT_NIUZAO_START, 60s);
                    break;
                }
                ...
                case EVENT_NIUZAO_END:
                {
                    ...
                    events.RescheduleEvent(EVENT_CHIJI_START, 60s);
                    break;
                }
                }
            }
