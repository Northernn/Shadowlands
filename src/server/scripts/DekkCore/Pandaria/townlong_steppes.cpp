    ...
    public:
        ...
        struct mob_kah_tirAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_DEVASTATING_ARC, 40s);
                events.ScheduleEvent(EVENT_SUMMON_QUILEN, 12s);
                events.ScheduleEvent(EVENT_TITANIC_STRENGTH, 20s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_BLADE_FURY:
                            ...
                            events.ScheduleEvent(EVENT_BLADE_FURY, 30s);
                            break;
                        case EVENT_WINDSONG:
                            me->CastSpell(me, SPELL_WINDSONG, false);
                            events.ScheduleEvent(EVENT_WINDSONG, 25s);
                            break;
                        default:
                            break;
                    }
    ...
    public:
        ...
        struct mob_darkwoods_faerieAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_DISGUISE, 5s);
                events.ScheduleEvent(EVENT_FAE_SPIRIT, 15s);
                events.ScheduleEvent(EVENT_NIGHT_SKY, 22s);
                events.ScheduleEvent(EVENT_STARSURGE, 30s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_DISGUISE:
                            ...
                            events.ScheduleEvent(EVENT_DISGUISE, 70s);
                            break;
    ...
    public:
        ...
        struct mob_hei_fengAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_DEEP_BREATH, 5s);
                events.ScheduleEvent(EVENT_SERPENT_SWEEP, 15s);
                events.ScheduleEvent(EVENT_SHADOW_DETONATION, 22s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_DEEP_BREATH:
                            ...
                            events.ScheduleEvent(EVENT_DEEP_BREATH, 30s);
                            break;
