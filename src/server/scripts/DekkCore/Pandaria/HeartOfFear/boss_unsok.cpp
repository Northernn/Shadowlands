    ...
    public:
        ...
        struct boss_unsokAI : public BossAI
        {
            ...
            void JustEngagedWith(Unit* /*p_Attacker*/) override
            {
                ...
                events.ScheduleEvent(EVENT_BERSERK, 54s); // 9 minutes timer naah
                events.ScheduleEvent(EVENT_AMBER_SCALPEL, 15s);
                events.ScheduleEvent(EVENT_PARASITIC_GROWTH, 10s);
                events.ScheduleEvent(EVENT_RESHAPE_LIFE, 40s);
            }
         ...
         void DamageTaken(Unit* attacker, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
            ...
            void DoAction(const int32 action) override
            {
                ...
                else if (action == ACTION_LAUNCH_LAST_PHASE)
                {
                    ...
                    events.RescheduleEvent(EVENT_RESHAPE_LIFE, 15s);
                    events.ScheduleEvent(EVENT_GROW, 2s);
                    if (IsHeroic())
                        events.ScheduleEvent(EVENT_AMBER_GLOBULE, 15s);
                }
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_AMBER_SCALPEL:
                        {
                            ...
                            events.ScheduleEvent(EVENT_AMBER_SCALPEL, phase == 3 ? 15s : 50s);
                            break;
                        }
                        case EVENT_PARASITIC_GROWTH:
                        {
                            ...
                            events.ScheduleEvent(EVENT_PARASITIC_GROWTH, 50s);
                            break;
                        }
                        case EVENT_RESHAPE_LIFE:
                        {
                            ...
                            if (canCast)
                            {
                                ...
                                do
                                {
                                    target = SelectTarget(SelectTargetMethod::Random, 0, 5000.0f, true);
                                    if (target != nullptr)
                                ...
                                events.ScheduleEvent(EVENT_RESHAPE_ACTIVE, 1s);
                            }

                            if (phase < 3)
                                events.ScheduleEvent(EVENT_RESHAPE_LIFE, 50s);
                            break;
                        }
                        case EVENT_RESHAPE_ACTIVE:
                        {
                            ...
                            if (!checkMutated)
                            {
                                events.ScheduleEvent(EVENT_CHECK_MUTATED, 1s);
                                checkMutated = true;
                            }
                            reshapedGuid = ObjectGuid::Empty;
                            break;
...
//                                        me->Kill(player, false);
                        ...
                        case EVENT_AMBER_EXPLOSION:
                        {
                            ...
                            events.ScheduleEvent(EVENT_AMBER_EXPLOSION, 5s);
                            break;
                        }
                        case EVENT_GROW:
                        {
                        ...
                        case EVENT_AMBER_GLOBULE:
                        {
                            ...
                            events.ScheduleEvent(EVENT_AMBER_GLOBULE, 30s);
                            break;
                        }
...
class mob_mutated_construct : public CreatureScript
{
    public:
        ...
        struct mob_mutated_constructAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                events.ScheduleEvent(EVENT_AMBER_EXPLOSION, 30s);
            }
    ...
    public:
        ...
        struct mob_amber_monstruosityAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_MASSIVE_STOMP,   5s);
                events.ScheduleEvent(EVENT_GRAB,            10s);
                events.ScheduleEvent(EVENT_AMBER_EXPLOSION, 20s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_MASSIVE_STOMP:
                        {
                            ...
                            events.ScheduleEvent(EVENT_MASSIVE_STOMP, 20s);
                            break;
                        }
                        case EVENT_AMBER_EXPLOSION:
                        {
                            DoCast(SPELL_MSTR_EXPLOSION);
                            events.ScheduleEvent(EVENT_MASSIVE_STOMP, 50s);
                            break;
                        }
                        case EVENT_GRAB:
                        {
                            ...
                            events.ScheduleEvent(EVENT_FLING, 4s);
                            events.ScheduleEvent(EVENT_GRAB, 40s);
                            break;
                        }
                        case EVENT_FLING:
                        {
       ...
       void DamageTaken(Unit* attacker, uint32& p_Damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
        {
            ...
            if (p_Damage > me->GetHealth())
            {
                ...
                if (IsHeroic())
                    events.ScheduleEvent(EVENT_AMBER_RESURRECT, 30s);
            }
        }
        ...
        struct mob_amber_pool_stalkerAI : public ScriptedAI
        {
            ...
            void DoAction(const int32 action) override
            {
                if (action == ACTION_AMBER_POOL)
                {
                    ...
                    events.ScheduleEvent(EVENT_DRAW_POWER, 2s);
                    events.ScheduleEvent(EVENT_VOLATILE_AMBER, 8s);
                }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_VOLATILE_AMBER:
                        {
                            ...
                            if (playerList.empty())
                            {
                                events.ScheduleEvent(EVENT_VOLATILE_AMBER, 3s);
                                break;
                            }
    ...
    public:
        ...
        struct mob_amber_scalpelAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                me->SetFaction(2577);
                me->SetUnitFlag(UNIT_FLAG_NON_ATTACKABLE);
                events.ScheduleEvent(EVENT_SCALPEL_DESPAWN, 11s);
