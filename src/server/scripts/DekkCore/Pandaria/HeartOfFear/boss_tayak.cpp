    ...
    public:
        ...
        struct boss_tayakAI : public BossAI
        {
            ...
            void JustEngagedWith(Unit* /*who*/) override
            {
                ...
                events.ScheduleEvent(EVENT_TEMPEST_SLASH, 9s);
                events.ScheduleEvent(EVENT_UNSEEN_STRIKE, 29s);
                events.ScheduleEvent(EVENT_TAYAK_WIND_STEP, 21s);
                events.ScheduleEvent(EVENT_OVERWHELMING_ASS, 14s);
                //events.ScheduleEvent(EVENT_INTENSIFY, 60000);
                if (IsHeroic())
                    events.ScheduleEvent(EVENT_BLADE_TEMPEST, 60s);

                me->AddAura(SPELL_INTENSIFY_NORMAL, me);

                // 8:15 minutes Enrage timer
                events.ScheduleEvent(EVENT_TAYAK_BERSERK, 49s);
            ...
            void MovementInform(uint32 type, uint32 id) override
            {
                ...
                switch (id)
                {
                    ...
                    case 2:
                    {
                        ...
                        TeleportPlayers();
                        events.ScheduleEvent(EVENT_STORM_UNLEASHED, 1s);
                    ...
                    case 3:
                    {
                      //  me->GetMotionMaster()->MovementExpired();
                        me->GetMotionMaster()->Clear();
                        events.ScheduleEvent(EVENT_SUMMON_TORNADOES, 1s);
                        break;
                    }
                    default:
                        break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_TEMPEST_SLASH:
                        {
                            ...
                            events.ScheduleEvent(EVENT_TEMPEST_SLASH, 14s);
                            break;
                        }
                        case EVENT_UNSEEN_STRIKE:
                        {
                            ...
                            events.ScheduleEvent(EVENT_UNSEEN_STRIKE_RETURN, 5s);
                            events.ScheduleEvent(EVENT_UNSEEN_STRIKE, 53s);
                            break;
                        }
                        ...
                        case EVENT_TAYAK_WIND_STEP:
                        {
                            ...
                            events.ScheduleEvent(EVENT_WIND_STEP_RETURN, 1s);
                            events.ScheduleEvent(EVENT_TAYAK_WIND_STEP, 24s);
                            break;
                        }
                        ...
                        case EVENT_OVERWHELMING_ASS:
                        {
                            ...
                            events.ScheduleEvent(EVENT_OVERWHELMING_ASS, 20s);
                            break;
                        }
                        // Heroic
                        ...
                        case EVENT_SUMMON_TORNADOES:
                        {
                          ...
                          //  if (Creature* storm = me->SummonCreature(NPC_US_TORNADO, !storm1Done ? Tornado1[choice] : Tornado2[choice]))
                            ...
                            events.ScheduleEvent(EVENT_SUMMON_TORNADOES, 3s);
                            break;
                        }
            ...
            void SetAggro()
            {
                if (Unit* victim = SelectTarget(SelectTargetMethod::MaxThreat))
                {
                    AttackStart(victim);
        ...
        struct npc_tempest_slash_tornadoAI : public ScriptedAI
        {
            ...
            void IsSummonedBy(WorldObject* summoner) override
            {
                ...
                if (summoner)
                {
                    ...
                    events.ScheduleEvent(EVENT_STORM_MOVE, 5s);
                }
            }
    ...
    public:
        ...
        struct npc_storm_unleashed_tornadoAI : public ScriptedAI
        {
            ...
            void IsSummonedBy(WorldObject* /*p_Summoner*/) override
            {
                ...
                m_Events.ScheduleEvent(EVENT_STORM_REMOVE, 24s);
            }
            ...
            void SetData(uint32 type, uint32 value) override
            {
                if (type == TYPE_STORM_POINT)
                {
                    ...
                    m_Events.ScheduleEvent(EVENT_STORM_MOVE, 5s);
                }
            }
...
class spell_unseen_strike_dmg : public SpellScriptLoader
{
    public :
        ...
        class spell_unseen_strike_dmgSpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_unseen_strike_dmgSpellScript::CountTargets, EFFECT_0, TARGET_UNIT_CONE_CASTER_TO_DEST_ENEMY);
