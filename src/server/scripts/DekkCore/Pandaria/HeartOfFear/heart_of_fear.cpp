    ...
    public:
        ...
        struct mob_kor_thik_slicerAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                if (IsHeroic())
                    events.ScheduleEvent(EVENT_SLOW, 3s);
                events.ScheduleEvent(EVENT_ARTERIAL_SPIRIT, 10s);
                events.ScheduleEvent(EVENT_VITAL_STRIKES, 5s);
           ...
           void DamageTaken(Unit* attacker, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
            {
                if(!eventScheduled)
                {
                    ...
                    {
                        events.ScheduleEvent(EVENT_GOUGE_THROAT, 12s);
                        eventScheduled = true;
                    }
                }
            }
    ...
    public:
        ...
        struct mob_kor_thik_extremistAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                if (IsHeroic())
                    events.ScheduleEvent(EVENT_SLOW, 3s);
                events.ScheduleEvent(EVENT_UNDYING_DEVOTION, 5s);
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    switch (id)
                    {
                        case EVENT_UNDYING_DEVOTION:
                            ...
                            events.ScheduleEvent(EVENT_UNDYING_DEVOTION, 2s);
                            break;
                        case EVENT_SLOW:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxDistance))
                                me->CastSpell(target, SPELL_SLOW, true);
    ...
    public:
        ...
        struct mob_sra_thik_shield_masterAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                if (IsHeroic())
                    events.ScheduleEvent(EVENT_SLOW, 3s);
                events.ScheduleEvent(EVENT_BRAIN_FREEZE, 7s);
                events.ScheduleEvent(EVENT_DISMANTLED_ARMOR, 12s);
                events.ScheduleEvent(EVENT_MASS_SPELL_REFLEXION, 19s);
                events.ScheduleEvent(EVENT_SHIELD_SLAM, 26s);
                events.ScheduleEvent(EVENT_STUNNING_STRIKE, 35s);
    ...
    public:
        ...
        struct mob_set_thik_swiftbladeAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                if (IsHeroic())
                    events.ScheduleEvent(EVENT_SLOW, 3s);
                events.ScheduleEvent(EVENT_BLURRING_SLASH, 7s);
                events.ScheduleEvent(EVENT_RIPOSTE, 12s);
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    switch (id)
                    {
                        case EVENT_BLURRING_SLASH:
                            ...
                            events.ScheduleEvent(EVENT_BLURRING_SLASH, 22s);
                            break;
                        case EVENT_RIPOSTE:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_RIPOSTE, true);
                            events.ScheduleEvent(EVENT_RIPOSTE, 22s);
                            break;
                        case EVENT_SLOW:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_SLOW, true);
        ...
        struct mob_zar_thik_supplicantAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                if (me->GetEntry() == NPC_ZARTHIK_SUPPLICANT_3 || me->GetEntry() == NPC_ZARTHIK_SUPPLICANT)
                    events.ScheduleEvent(EVENT_ICE_TRAP, 7s);
                events.ScheduleEvent(EVENT_MASH_AND_GNASH, 12s);
            }
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    switch (id)
                    {
                        case EVENT_ICE_TRAP:
                            ...
                            events.ScheduleEvent(EVENT_ICE_TRAP, 22s);
                            break;
                        case EVENT_MASH_AND_GNASH:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_MASH_AND_GNASH, true);
                            events.ScheduleEvent(EVENT_MASH_AND_GNASH, 22s);
                            break;
                        case EVENT_SLOW:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_SLOW, true);
    ...
    public:
        ...
        struct mob_enslaved_bonesmasherAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                if (IsHeroic())
                    events.ScheduleEvent(EVENT_SLOW, 3s);
                events.ScheduleEvent(EVENT_JAWBONE_SLAM, 7s);
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    switch (id)
                    {
                        case EVENT_JAWBONE_SLAM:
                            ...
                            events.ScheduleEvent(EVENT_JAWBONE_SLAM, 22s);
                            break;
                        case EVENT_SLOW:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_SLOW, true);
...
class mob_set_thik_tempest : public CreatureScript
{
    public:
        ...
        struct mob_set_thik_tempestAI : public ScriptedAI
        {
            ...
            {
                events.Reset();
                events.ScheduleEvent(EVENT_WIND_SLASH, 7s);
                me->SetVirtualItem(0, EQUIP_TRASH_4);
            }
            ...
            void UpdateAI(const uint32 diff) override
            {
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    if (id == EVENT_WIND_SLASH)
                    {
                        ...
                        events.ScheduleEvent(EVENT_WIND_SLASH, 4s);
                    }
                }
    ...
    public:
        ...
        struct mob_set_thik_fanaticAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                if (!IsHeroic())
                    events.ScheduleEvent(EVENT_SLOW, 3s);
                events.ScheduleEvent(EVENT_GALE_FORCE_WINDS, 7s);
                events.ScheduleEvent(EVENT_WINDBURST, 15s);
            }
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    switch (id)
                    {
                        case EVENT_GALE_FORCE_WINDS:
                            ...
                            events.ScheduleEvent(EVENT_GALE_FORCE_WINDS, 22s);
                            break;
                        case EVENT_WINDBURST:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_WINDBURST, true);
                            events.ScheduleEvent(EVENT_WINDBURST, 22s);
                            break;
                        case EVENT_SLOW:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_SLOW, true);
...
class mob_set_thik_zephyrian : public CreatureScript
{
    public:
        ...
        struct mob_set_thik_zephyrianAI : public ScriptedAI
        {
            ...
            {
                events.Reset();
                events.ScheduleEvent(EVENT_SUMMON_ZEPHYR, 4s);
            ...
            void UpdateAI(const uint32 diff) override
            {
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    if (id == EVENT_SUMMON_ZEPHYR)
                    {
                        ...
                        events.ScheduleEvent(EVENT_SUMMON_ZEPHYR, 22s);
                        break;
                    }
                }
...
class mob_set_thik_gale_slicer : public CreatureScript
{
    public:
        ...
        struct mob_set_thik_gale_slicerAI : public ScriptedAI
        {
            ...
            {
                events.Reset();
                events.ScheduleEvent(EVENT_SWIFT_STEP, 4s);
                me->SetVirtualItem(0, EQUIP_TRASH_7);
            }
            ...
            void UpdateAI(const uint32 diff) override
            {
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    if (id == EVENT_SWIFT_STEP)
                    {
                        ...
                        events.ScheduleEvent(EVENT_SWIFT_STEP, 22s);
                        break;
                    }
                }
...
class mob_instructor_kli_thak : public CreatureScript
{
    public:
        ...
        struct mob_instructor_kli_thakAI : public ScriptedAI
        {
            ...
            {
                events.Reset();
                events.ScheduleEvent(EVENT_WIND_STEP, 15s);
                me->SetVirtualItem(0, EQUIP_TRASH_7);
            }
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    switch (id)
                    {
                        case EVENT_WIND_STEP:
                        {
                            ...
                            events.ScheduleEvent(EVENT_WIND_STEP, 22s);
                            break;
                        }
                        default:
                            break;
...
class mob_instructor_tak_thok : public CreatureScript
{
    public:
        ...
        struct mob_instructor_tak_thokAI : public ScriptedAI
        {
            ...
            {
                events.Reset();
                events.ScheduleEvent(EVENT_OVERWHELMING_ASSAULT, 4s);
            ...
            void UpdateAI(const uint32 diff) override
            {
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    if (id == EVENT_OVERWHELMING_ASSAULT)
                    {
                        ...
                        events.ScheduleEvent(EVENT_OVERWHELMING_ASSAULT, 22s);
                        break;
                    }
                }
...
class mob_instructor_maltik : public CreatureScript
{
    public:
        ...
        struct mob_instructor_maltikAI : public ScriptedAI
        {
            ...
            {
                events.Reset();
                events.ScheduleEvent(EVENT_TRASH_UNSEEN_STRIKE, 15s);
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    switch (id)
                    {
                        case EVENT_TRASH_UNSEEN_STRIKE:
                        {
                            ...
                            events.ScheduleEvent(EVENT_TRASH_UNSEEN_STRIKE, 22s);
...
class mob_instructor_zarik : public CreatureScript
{
    public:
        ...
        struct mob_instructor_zarikAI : public ScriptedAI
        {
            ...
            {
                events.Reset();
                events.ScheduleEvent(EVENT_TRASH_TEMPEST_SLASH, 15s);
                me->SetVirtualItem(0, EQUIP_TRASH_4);
            }
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    switch (id)
                    {
                        case EVENT_TRASH_TEMPEST_SLASH:
                        {
                            ...
                            events.ScheduleEvent(EVENT_TRASH_TEMPEST_SLASH, 22s);
                            break;
                        }
                        default:
                            break;
    ...
    public:
        ...
        struct mob_zar_thik_zealotAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                if (IsHeroic())
                    events.ScheduleEvent(EVENT_SLOW, 3s);
                events.ScheduleEvent(EVENT_ZEALOUS_RUSH, 7s);
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    switch (id)
                    {
                        case EVENT_ZEALOUS_RUSH:
                            ...
                            events.ScheduleEvent(EVENT_ZEALOUS_RUSH, 22s);
                            break;
                        case EVENT_SLOW:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxDistance))
                                me->CastSpell(target, SPELL_SLOW, true);
...
class mob_kor_thik_swarmer : public CreatureScript
{
    public:
        ...
        struct mob_kor_thik_swarmerAI : public ScriptedAI
        {
            ...
            {
                events.Reset();
                events.ScheduleEvent(EVENT_UNDERWHELMING_ASSAULT, 4s);
            ...
            void UpdateAI(const uint32 diff) override
            {
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    if (id == EVENT_UNDERWHELMING_ASSAULT)
                    {
                        ...
                        events.ScheduleEvent(EVENT_UNDERWHELMING_ASSAULT, 22s);
                        break;
                    }
                }
    ...
    public:
        ...
        struct mob_set_thik_gustwingAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_GUST, 3s);
                events.ScheduleEvent(EVENT_ICE_TRAP, 7s);
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    switch (id)
                    {
                        case EVENT_GUST:
                            ...
                            events.ScheduleEvent(EVENT_GUST, 22s);
                            break;
                        case EVENT_ICE_TRAP:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxDistance))
                                me->CastSpell(target, SPELL_ICE_TRAP, true);
                            events.ScheduleEvent(EVENT_ICE_TRAP, 40s);
                            break;
                        default:
                            break;
                    }
    ...
    public:
        ...
        struct mob_kor_thik_silentwingAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                events.Reset();
                me->SetVirtualItem(0, EQUIP_TRASH_1);
                events.ScheduleEvent(EVENT_ALMOST_UNSEEN_STRIKE, 15s);
            }
                ...
                while (uint32 id = events.ExecuteEvent())
                {
                    switch (id)
                    {
                        case EVENT_ALMOST_UNSEEN_STRIKE:
                        {
                            ...
                            events.ScheduleEvent(EVENT_ALMOST_UNSEEN_STRIKE, 22s);
                            break;
                        }
                        default:
                            break;
    ...
    public:
        ...
        struct mob_zephyrAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                m_Events.ScheduleEvent(EVENT_ZEPHYR_MOVE, 5s);
            }
...
public:
    ...
    struct mob_korthik_swarmguardAI : public ScriptedAI
    {
       ...
       void DamageTaken(Unit* p_Attacker, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
        {
            if (!inCombat)
        ...
        void JustEngagedWith(Unit* /*p_Attacker*/) override
        {
            if (!inCombat)
            {
                events.ScheduleEvent(EVENT_CARAPACE, 2s);
                inCombat = true;
    ...
    struct mob_srathik_ambercallerAI : public ScriptedAI
    {
        ...
        void DoAction(int32 const action) override
        {
            if (action == ACTION_AMBER_VOLLEY)
            {
                ...
                isProtected = true;
                events.ScheduleEvent(EVENT_AMBER_VOLLEY, 2s);
            }
        }
         ...
         /*   if (pInstance)
            ...
            if (events.ExecuteEvent() == EVENT_AMBER_VOLLEY)
            {
                ...
                if (!playerList.empty())
                {
                    ...
                    events.ScheduleEvent(EVENT_AMBER_VOLLEY, IsLFR() ? 3s : Is25ManRaid() ? 2s : 5s);
                }
            }
            // No melee attack
        }
...
public:
    ...
    struct mob_korthik_fleshrenderAI : ScriptedAI
    {
        ...
        {
            events.ScheduleEvent(EVENT_GREVIOUS_WHIRL, 5s);
            events.ScheduleEvent(EVENT_MORTAL_REND,    12s);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_GREVIOUS_WHIRL:
                    {
                        ...
                        events.ScheduleEvent(EVENT_GREVIOUS_WHIRL, 2s);
                        break;
                    }
                    case EVENT_MORTAL_REND:
                    {
                        ...
                        events.ScheduleEvent(EVENT_MORTAL_REND, 2s);
                        break;
                    }
                    default:
                        break;
...
public:
    ...
    struct mob_amber_searstingAI : public ScriptedAI
    {
        ...
        {
            events.ScheduleEvent(EVENT_BURNING_STING, 8s);
            events.ScheduleEvent(EVENT_SEARING_SLASH, 4s);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_BURNING_STING:
                    {
                        ...
                        events.ScheduleEvent(EVENT_BURNING_STING, 15s);
                        break;
                    }
                    case EVENT_SEARING_SLASH:
                    {
                        DoCast(SPELL_SEARING_SLASH);
                        events.ScheduleEvent(EVENT_SEARING_SLASH, 12s);
                        break;
                    }
                    default:
                        break;
...
public:
    ...
    struct mob_amberridden_mushanAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
            events.ScheduleEvent(EVENT_AMBER_SPEW, 9s);
            events.ScheduleEvent(EVENT_SLAM,       4s);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_AMBER_SPEW:
                    {
                        ...
                        events.ScheduleEvent(EVENT_AMBER_SPEW, 1s);
                        break;
                    }
                    case EVENT_SLAM:
                    {
                        DoCast(SPELL_SLAM);
                        events.ScheduleEvent(EVENT_SLAM, 22s);
                        break;
                    }
                default:
                    break;
...
public:
    ...
    struct mob_srathik_pooltenderAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            events.ScheduleEvent(EVENT_AMBER_INFUSION, 2s);
        }
        ...
        void UpdateAI(const uint32 diff) override
        {
            ...
            if (events.ExecuteEvent() == EVENT_AMBER_INFUSION)
            {
                ...
                events.ScheduleEvent(EVENT_AMBER_INFUSION, 25s);
            }
...
public:
    ...
    struct mob_zarthik_augurerAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
            events.ScheduleEvent(EVENT_TOXIC_HIVEBOMB, 2s);
            events.ScheduleEvent(EVENT_TOXIC_SPEW, 15s);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_TOXIC_HIVEBOMB:
                    {
                        ...
                        events.ScheduleEvent(EVENT_TOXIC_HIVEBOMB, 4s);
                        break;
                    }
...
public:
    ...
    struct mob_setthik_windbladeAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
            events.ScheduleEvent(EVENT_DISPATCH, 7s);
            events.ScheduleEvent(EVENT_SONIC_BLADE, 15s);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_DISPATCH:
                    {
                        ...
                        events.ScheduleEvent(EVENT_DISPATCH, 3s);
                        break;
                    }
                    case EVENT_SONIC_BLADE:
                    {
                        ...
                        events.ScheduleEvent(EVENT_SONIC_BLADE, 3s);
                        break;
                    }
                    default:
                        break;
...
public:
    ...
    struct mob_korthik_warsingerAI : ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
            events.ScheduleEvent(EVENT_CRY_HAVOC, 6s);
            events.ScheduleEvent(EVENT_FRENZIED_ASSAULT, 12s);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_CRY_HAVOC:
                    {
                        ...
                        events.ScheduleEvent(EVENT_CRY_HAVOC, 15s);
                        break;
                    }
                    case EVENT_FRENZIED_ASSAULT:
                    {
                        ...
                        events.ScheduleEvent(EVENT_FRENZIED_ASSAULT, 3s);
                        break;
                    }
                    default:
                        break;
