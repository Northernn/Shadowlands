    ...
    public:
        ...
        struct boss_shekzeerAI : public BossAI
        {
            ...
            void JustEngagedWith(Unit* attacker) override
            {
                ...
                events.ScheduleEvent(EVENT_DREAD_SCREECH, 6s);
                events.ScheduleEvent(EVENT_EYES_OF_THE_EMPRESS, 10s); // Deactivated for test purpose
                events.ScheduleEvent(EVENT_DISSONANCE_FIELDS, 30s);
                events.ScheduleEvent(EVENT_CRY_OF_TERROR, 25s);
                events.ScheduleEvent(EVENT_BERSERK, IsHeroic() ? 90s : 48s); // 15 min in HM, 8 min in NM
                events.ScheduleEvent(EVENT_CLOSE_CHAMBER, 5s);
                events.ScheduleEvent(EVENT_CHANGE_PHASE, 150s);
                powerTimer = 1000;
            }
            ...
            void DamageTaken(Unit* attacker, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
            {
                ...
                if (me->HealthBelowPctDamaged(30, damage))
                {
                    ...
                    events.ScheduleEvent(EVENT_VISIONS_OF_DEMISE, 6s);
                    events.ScheduleEvent(EVENT_CALAMITY, 10s);
                    events.ScheduleEvent(EVENT_SHA_ENERGY, 15s);
                    events.ScheduleEvent(EVENT_AMASSING_DARKNESS, 2s);
                    if (IsHeroic())
                        events.ScheduleEvent(EVENT_SUMMON_HOF, 10s);
                ...
                switch (id)
                {
                    ...
                    case 2:
                    {
                        ...
                        if (phase)
                        {
                            ...
                            events.ScheduleEvent(EVENT_DREAD_SCREECH, 6s);
                            events.ScheduleEvent(EVENT_EYES_OF_THE_EMPRESS, 15s);
                            events.ScheduleEvent(EVENT_DISSONANCE_FIELDS, 30s);
                            events.ScheduleEvent(EVENT_CRY_OF_TERROR, 25s);
                            events.ScheduleEvent(EVENT_CLOSE_CHAMBER, 5s);
                            events.ScheduleEvent(EVENT_CHANGE_PHASE, 150s);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_CHANGE_PHASE:
                        {
                            ...
                            events.ScheduleEvent(EVENT_LOAD_PHASE, 5s);
                            break;
                        }
                        ...
                        case EVENT_EYES_OF_THE_EMPRESS:
                        {
                            ...
                            events.ScheduleEvent(EVENT_EYES_OF_THE_EMPRESS, 10s);
                            break;
                        }
                        // --- Phase 1 events ---
                        ...
                        case EVENT_DISSONANCE_FIELDS:
                        {
                            ...
                            if (!GetClosestCreatureWithEntry(me, NPC_DISSONANCE_FIELD, 200.0f))
                            {
                                ...
                                events.ScheduleEvent(EVENT_DISSONANCE_FIELDS, 30s);
                                if (IsHeroic())
                                    events.ScheduleEvent(EVENT_CORRUPT_FIELD, 10s);
                            }
                            else
                                events.ScheduleEvent(EVENT_DISSONANCE_FIELDS, 1s);
                            break;
                        }
                        // Heroic mode
                        ...
                        case EVENT_CONSUMING_TERROR:
                        {
                            ...
                            events.ScheduleEvent(EVENT_CONSUMING_TERROR, 30s);
                            break;
                        }
                        case EVENT_VISIONS_OF_DEMISE:
                        {
                            DoCast(SPELL_VISIONS_OF_DEMISE);
                            events.ScheduleEvent(EVENT_VISIONS_OF_DEMISE, 15s);
                            break;
                        }
                        case EVENT_CALAMITY:
                        {
                            DoCast(SPELL_CALAMITY);
                            events.ScheduleEvent(EVENT_CALAMITY, 6s);
                            break;
                        }
                        ...
                        case EVENT_SUMMON_HOF:
                        {
                            ...
                            if (!GetClosestCreatureWithEntry(me, NPC_HEART_OF_FEAR, 100.0f))
                            {
                                ...
                                events.ScheduleEvent(EVENT_SUMMON_HOF, 5s);
                            break;
                        }
                        case EVENT_BERSERK:
                        {
    ...
    public:
        ...
        struct mob_add_setthik_windbladeAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_SONIC_BLADE, 22s);
                events.ScheduleEvent(EVENT_STICKY_RESIN, 15s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_DISPATCH:
                        {
                            ...
                            events.ScheduleEvent(EVENT_DISPATCH, 14s);
                            break;
                        }
    ...
    public:
        ...
        struct mob_korthik_reaverAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_POISON_BOMB, 10s);
                events.ScheduleEvent(EVENT_TOXIC_SLIME, 14s);
                events.ScheduleEvent(EVENT_POISON_DRENCHED_ARMOR, 21s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_POISON_BOMB:
                        {
                            ...
                            events.ScheduleEvent(EVENT_POISON_BOMB, 7s);
                            break;
                        }
    ...
    public:
        ...
        struct mob_sticky_resinAI : ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                growth = 0;
                checkTrap = false;
                events.ScheduleEvent(EVENT_CHECK_INTERRACT, 1s);
            }
...
class mob_dissonance_field : public CreatureScript
{
    public:
        ...
        struct mob_dissonance_fieldAI : public ScriptedAI
        {
            ...
            {
                events.Reset();
                me->SetUnitFlag(UnitFlags(UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_IMMUNE_TO_NPC | UNIT_FLAG_NON_ATTACKABLE));
                me->SetReactState(REACT_PASSIVE);
                events.ScheduleEvent(EVENT_CHECK_CAST, 1s);
            ...
            void DoAction(const int32 action) override
            {
                switch (action)
                {
                    ...
                    case ACTION_RETREAT:
                    {
                        ...
                        events.ScheduleEvent(EVENT_CLOSE_CHAMBER, 2s);
                    }
                    ...
                    {
                        Talk(SAY_DEAD_QUEEN);
                        events.ScheduleEvent(EVENT_LEAVING, 3s);
                        break;
                    }
                    default:
                        break;
...
public:
    ...
    struct mob_heart_of_fearAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            events.ScheduleEvent(EVENT_HOF_ATTACK, 3s);
            events.ScheduleEvent(EVENT_HOF_DESTROY, 10s);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_HOF_ATTACK:
                    {
                        ...
                        events.ScheduleEvent(EVENT_HOF_ATTACK, 2s);
                        break;
                    }
