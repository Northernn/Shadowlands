    ...
    public:
        ...
        struct mob_shadow_of_doubtAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_DEAFENED, 30s);
                events.ScheduleEvent(EVENT_GROWING_DOUBT, 9s);
                events.ScheduleEvent(EVENT_SHA_BOLT, 15s);
            }
    ...
    public:
        ...
        struct mob_kor_nas_nightsavageAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_SHADOWBOLT, 50s);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_SHADOWBOLT:
                            ...
                            events.ScheduleEvent(EVENT_SHADOWBOLT, 70s);
                            break;
    ...
    public:
        ...
        struct mob_krax_ikAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_TORNADO, 5s);
                events.ScheduleEvent(EVENT_BLADE_FURY, 25s);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_TORNADO:
                            ...
                            events.ScheduleEvent(EVENT_TORNADO, 70s);
                            break;
                        case EVENT_BLADE_FURY:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_BLADE_FURY, false);
                            events.ScheduleEvent(EVENT_BLADE_FURY, 20s);
                            break;
                        case EVENT_WINDSONG:
    ...
    public:
        ...
        struct mob_akkalarAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_BOUCLIER_D_EAU, 10s);
                events.ScheduleEvent(EVENT_BOUCLIER_D_EAU_2, 20s);
                events.ScheduleEvent(EVENT_BOUCLIER_DE_TERRE, 30s);
                events.ScheduleEvent(EVENT_CARAPACE_BOUCLIER, 40s);
                events.ScheduleEvent(EVENT_MOT_DE_POUVOIR, 50s);
            }
    ...
    public:
        ...
        struct mob_grookin_outrunnerAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_SHOOT, 7s);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_SHOOT:
                            ...
                            events.ScheduleEvent(EVENT_SHOOT, 10s);
                            break;
                        case EVENT_CLEAVE:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
    ...
    public:
        ...
        struct mob_bamboo_pythonAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_SWAMP_FEVER, 7s);
            }
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    if (eventId == EVENT_SWAMP_FEVER)
                    {
                            ...
                            events.ScheduleEvent(EVENT_SWAMP_FEVER, 15s);
                    }
                }
    ...
    public:
        ...
        struct mob_rakiraAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_BLOODY_PREY, 8s);
                events.ScheduleEvent(EVENT_CLAW_RIP, 15s);
                events.ScheduleEvent(EVENT_GROWL, 22s);
                events.ScheduleEvent(EVENT_HOWL_OF_THE_DENMOTHER, 30s);
                events.ScheduleEvent(EVENT_ROAR_OF_COURAGE, 40s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_BLOODY_PREY:
                            ...
                            events.ScheduleEvent(EVENT_BLOODY_PREY, 10s);
                            break;
                        case EVENT_CLAW_RIP:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                        ...
                        case EVENT_ROAR_OF_COURAGE:
                            ...
                            events.ScheduleEvent(EVENT_ROAR_OF_COURAGE, 47s);
                            break;
                        default:
                            break;
                    }
    ...
    public:
        ...
        struct mob_ro_shenAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_CLAW_RIP, 15s);
                events.ScheduleEvent(EVENT_GROWL, 22s);
                events.ScheduleEvent(EVENT_ROAR_OF_COURAGE, 30s);
                events.ScheduleEvent(EVENT_BLOOD_CRAZED, 40s);
                events.ScheduleEvent(EVENT_BLOODTHIRST, 50s);
                events.ScheduleEvent(EVENT_CLAW_SLASH, 60s);
                events.ScheduleEvent(EVENT_FRENZY, 70s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_GROWL:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_GROWL, false);
                            events.ScheduleEvent(EVENT_GROWL, 28s);
                            break;
                        case EVENT_ROAR_OF_COURAGE:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_ROAR_OF_COURAGE, false);
                            events.ScheduleEvent(EVENT_ROAR_OF_COURAGE, 70s);
                            break;
                        case EVENT_BLOOD_CRAZED:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_BLOOD_CRAZED, false);
                            events.ScheduleEvent(EVENT_BLOOD_CRAZED, 31s);
                            break;
                        case EVENT_BLOODTHIRST:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_BLOODTHIRST, false);
                            events.ScheduleEvent(EVENT_BLOODTHIRST, 40s);
                            break;
                        case EVENT_CLAW_SLASH:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_CLAW_SLASH, false);
                            events.ScheduleEvent(EVENT_CLAW_SLASH, 25s);
                            break;
                        case EVENT_FRENZY:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_FRENZY, false);
                            events.ScheduleEvent(EVENT_FRENZY, 50s);
                            break;
                        default:
                            break;
                    }
    ...
    public:
        ...
        struct mob_sha_reminantAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_SHADOW_CLAW, 10s);
                events.ScheduleEvent(EVENT_OVERWHELMING_GUILT, 15s);
            }
    ...
    public:
        ...
        struct mob_big_baoAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_FORCE_BURST, 3s);
                events.ScheduleEvent(EVENT_KNOCK_AWAY, 8s);
                events.ScheduleEvent(EVENT_PULL_CLOSE, 13s);
                events.ScheduleEvent(EVENT_WAR_STOMP, 18s);
            }
            ...
            bool OnGossipHello(Player* player) override
            {
                AddGossipItemFor(player, GossipOptionNpc::None, GOSSIP_CHOICE_2, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                SendGossipMenuFor(player, 75012, me->GetGUID());
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_FORCE_BURST:
                            ...
                            events.ScheduleEvent(EVENT_FORCE_BURST, 10s);
                            break;
                        case EVENT_KNOCK_AWAY:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_KNOCK_AWAY, false);
                            events.ScheduleEvent(EVENT_KNOCK_AWAY, 10s);
                            break;
                        case EVENT_PULL_CLOSE:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_PULL_CLOSE, false);
                            events.ScheduleEvent(EVENT_PULL_CLOSE, 10s);
                            break;
                        case EVENT_WAR_STOMP:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_FIRE_ALE, false);
                            events.ScheduleEvent(SPELL_WAR_STOMP, 10s);
                            break;
                        default:
                            break;
                    }
    ...
    public:
        ...
        struct mob_hutiatAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_FRENZY_2, 7s);
                events.ScheduleEvent(EVENT_SPIRIT_BEAST_BLESSING, 12s);
                events.ScheduleEvent(EVENT_SPIRIT_HEAL, 19s);
            }
...
class npc_elder_anli : public CreatureScript
{
    public:
        ...
        struct npc_elder_anliAI : public ScriptedAI
        {
            npc_elder_anliAI(Creature* creature) : ScriptedAI(creature) { }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_elder_anliAI(creature);
        }
...
class mob_pearlfin_aqualyte : public CreatureScript
{
    public:
        ...
        struct mob_pearlfin_aqualyteAI : public ScriptedAI
        {
            mob_pearlfin_aqualyteAI(Creature* creature) : ScriptedAI(creature) { }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new mob_pearlfin_aqualyteAI(creature);
        }
};
...
class mob_pearlfin_villager : public CreatureScript
{
    public:
        ...
        struct mob_pearlfin_villagerAI : public ScriptedAI
        {
            mob_pearlfin_villagerAI(Creature* creature) : ScriptedAI(creature) { }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new mob_pearlfin_villagerAI(creature);
        }
};
...
class mob_pearlfin_situation : public CreatureScript
{
    public:
        ...
        struct mob_pearlfin_situationAI : public ScriptedAI
        {
            mob_pearlfin_situationAI(Creature* creature) : ScriptedAI(creature) { }
            ...
            bool OnGossipSelect(Player* player, uint32 sender, uint32 action) override
            {
                if (me->GetEntry() == 59058 || me->GetEntry() == 54960)
                    player->PlayerTalkClass->GetQuestMenu();
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new mob_pearlfin_situationAI(creature);
        }
...
class gob_hozen_cage : public GameObjectScript
{
    public:
        ...
        struct gob_hozen_cageAI : public GameObjectAI
        {
            gob_hozen_cageAI(GameObject* go) : GameObjectAI(go) { }
        ...
        {
            return new gob_hozen_cageAI(go);
        }
};
    ...
    public:
        ...
        struct npc_custom_npcAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_CHECK_PLAYER, 2s);
            }
    ...
    public:
        ...
        struct mob_jade_cloud_serpentAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_CHECK_TARGET, 2s);
            }
...
class mob_instructor_windblade : public CreatureScript
{
    public:
        ...
        struct mob_instructor_windbladeAI : public ScriptedAI
        {
            mob_instructor_windbladeAI(Creature* creature) : ScriptedAI(creature) { }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new mob_instructor_windbladeAI(creature);
        }
...
class mob_second_big_bao : public CreatureScript
{
    public:
        ...
        struct mob_second_big_baoAI : public ScriptedAI
        {
            ...
            void IsSummonedBy(WorldObject* /*summoner*/) override
            {
                events.ScheduleEvent(EVENT_DESPAWN, 60s);
            }
...
class npc_fei : public CreatureScript
{
    public:
        ...
        struct npc_feiAI : public ScriptedAI
        {
            npc_feiAI(Creature* creature) : ScriptedAI(creature) { }
        };
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_feiAI(creature);
        }
        ...
        bool OnQuestAccept(Player* player, Creature* creature, Quest const* quest) override
        {
            ...
            {
                player->GetSceneMgr().PlaySceneByPackageId(202, SceneFlag::None);
    ...
    public:
        ...
        struct mob_chi_ji_studentAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                {
                    case 60601:
                        events.ScheduleEvent(EVENT_GIFT_OF_CHI_JI, 3s);
                        events.ScheduleEvent(EVENT_BLESSING_OF_CHI_JI, 6s);
                        events.ScheduleEvent(EVENT_WRATH_OF_CHI_JI, 11s);
                        break;
                    case 60602:
                        events.ScheduleEvent(EVENT_BLACKOUT_KICK, 3s);
                        events.ScheduleEvent(EVENT_FLYING_SERPENT_KICK, 8s);
                        events.ScheduleEvent(EVENT_JAB, 13s);
                        break;
                    case 60603:
                        events.ScheduleEvent(EVENT_MIGHTY_CHOP, 3s);
                        events.ScheduleEvent(EVENT_STRIKE_FROM_THE_HEAVENS, 6s);
                        break;
                    default:
                        break;
                }
