                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_VANISH:
                            ...
                            events.ScheduleEvent(EVENT_VANISH, 40s);
                            break;
                        case EVENT_VICIOUS_REND:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_VICIOUS_REND, false);
                            events.ScheduleEvent(EVENT_VICIOUS_REND, 40s);
                            break;
                        default:
                            break;
                    }
    ...
    public:
        ...
        struct mob_gaarn_the_toxicAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_SHADOWBOLT, 15s);
                events.ScheduleEvent(EVENT_VOIDCLOUD, 70s);
            }
    ...
    public:
        ...
        struct mob_qu_nasAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_DEVASTATING_ARC, 25s);
                events.ScheduleEvent(EVENT_SUMMON_QUILEN, 15s);
                events.ScheduleEvent(EVENT_TITANIC_STRENGTH, 70s);
            }
    ...
    public:
        ...
        struct mob_champion_of_chi_jiAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_CHI_TORPEDO, 4s);
                events.ScheduleEvent(EVENT_HUNDRED_HAND_SLAP, 17s);
                events.ScheduleEvent(EVENT_SPINNING_CRANE_KICK, 27s);
                events.ScheduleEvent(EVENT_UPPERCUT, 35s);
            }
...
class mob_anduin_wrynn : public CreatureScript
{
    public:
        ...
        struct mob_anduin_wrynnAI : public ScriptedAI
        {
            mob_anduin_wrynnAI(Creature* creature) : ScriptedAI(creature) { }
        };
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new mob_anduin_wrynnAI(creature);
        }
...
class npc_chi_ji : public CreatureScript
{
    public:
        ...
        struct npc_chi_jiAI : public ScriptedAI
        {
            npc_chi_jiAI(Creature* creature) : ScriptedAI(creature) { }

            bool OnGossipHello(Player* player) override
            {
                if (player->GetQuestStatus(30273) == QUEST_STATUS_INCOMPLETE)
                {
                    AddGossipItemFor(player, GossipOptionNpc::None, GOSSIP_CHOICE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                    SendGossipMenuFor(player, 30003, me->GetGUID());
                }
            ...
            bool OnGossipSelect(Player* player, uint32 sender, uint32 action) override
            {
                ...
                if (action == GOSSIP_ACTION_INFO_DEF + 1)
                {
                    ...
                    me->DespawnOrUnsummon();
                    player->SummonCreature(59651, me->GetPositionX(), me->GetPositionY(), me->GetPositionZ()); // , 0.0f);
                }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_chi_jiAI(creature);
        }
};
...
class npc_thelonius : public CreatureScript
{
    public:
        ...
        struct npc_theloniusAI : public ScriptedAI
        {
            npc_theloniusAI(Creature* creature) : ScriptedAI(creature) { }
        };
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_theloniusAI(creature);
        }
    ...
    public:
        ...
        struct mob_ellia_ravenmaneAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                {
                    case 60530:
                        events.ScheduleEvent(EVENT_JAB, 3s);
                        events.ScheduleEvent(EVENT_KICK, 6s);
                        break;
                    case 60545:
                        events.ScheduleEvent(EVENT_CRY_OUT_IN_DESPAIR, 3s);
                        events.ScheduleEvent(EVENT_SHA_BLAST, 8s);
                        events.ScheduleEvent(EVENT_SHA_SPIKE, 13s);
                        break;
                    case 60533:
                        events.ScheduleEvent(EVENT_FIERCE_JAB, 3s);
                        events.ScheduleEvent(EVENT_FIERCE_KICK, 6s);
                        break;
                    case 60538:
                        events.ScheduleEvent(EVENT_FIERCE_JAB_2, 3s);
                        events.ScheduleEvent(EVENT_FISTS_OF_FURY, 8s);
                        events.ScheduleEvent(EVENT_VICIOUS_KICK, 13s);
                        break;
                    default:
                        break;
                }
            ...
            bool OnGossipHello(Player* player) override
            {
                ...
                SendGossipMenuFor(player, 69970, me->GetGUID());
            ...
            bool OnGossipSelect(Player* player, uint32 sender, uint32 action) override
            {
                ...
                if (action == GOSSIP_ACTION_INFO_DEF + 1)
                {
                    ...
                    {
                        me->AI()->SetGUID(player ? player->GetGUID() : ObjectGuid::Empty);
                        me->SetFaction(14);

                        if (me->GetAI())
                        {
                            me->AI()->Reset();
                            me->AI()->DoAction(ACTION_REMOVE_FLAG);
                        }
                    }
                }
                return true;
            ...
            {
                events.ScheduleEvent(EVENT_DESPAWN, 600s);
            }
    ...
    public:
        ...
        struct mob_fat_long_fatAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                {
                    case 60534:
                        events.ScheduleEvent(EVENT_BREATH_OF_FIRE, 3s);
                        events.ScheduleEvent(EVENT_STORM_STOUT, 6s);
                        break;
                    case 60543:
                        events.ScheduleEvent(EVENT_FAT_LONG_FLOP, 3s);
                        events.ScheduleEvent(EVENT_BREATH_OF_FIRE_2, 8s);
                        events.ScheduleEvent(EVENT_STORM_STOUT_2, 13s);
                        break;
                    default:
                        break;
                }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_BREATH_OF_FIRE:
                            ...
                            events.ScheduleEvent(EVENT_BREATH_OF_FIRE, 7s);
                            break;
                        case EVENT_STORM_STOUT:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_STORM_STOUT, false);
                            events.ScheduleEvent(EVENT_STORM_STOUT, 7s);
                            break;
                            // Entry 60543
                        case EVENT_FAT_LONG_FLOP:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_FAT_LONG_FLOP, false);
                            events.ScheduleEvent(EVENT_FAT_LONG_FLOP, 15s);
                            break;
                        case EVENT_BREATH_OF_FIRE_2:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_BREATH_OF_FIRE, false);
                            events.ScheduleEvent(EVENT_BREATH_OF_FIRE_2, 15s);
                            break;
                        case EVENT_STORM_STOUT_2:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_STORM_STOUT, false);
                            events.ScheduleEvent(EVENT_STORM_STOUT_2, 15s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
    ...
    public:
        ...
        struct mob_huck_wheelbarrowAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_WHEELBARROW_ROLL_2, 3s);
                events.ScheduleEvent(EVENT_WHEEL_PUNCH, 8s);
                events.ScheduleEvent(EVENT_ROLLING_THROW, 13s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_WHEELBARROW_ROLL_2:
                            ...
                            events.ScheduleEvent(EVENT_WHEELBARROW_ROLL_2, 18s);
                            break;
                        case EVENT_WHEEL_PUNCH:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_WHEEL_PUNCH, false);
                            events.ScheduleEvent(EVENT_WHEEL_PUNCH, 18s);
                            break;
                        case EVENT_ROLLING_THROW:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_ROLLING_THROW, false);
                            events.ScheduleEvent(EVENT_ROLLING_THROW, 18s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
    ...
    public:
        ...
        struct mob_dextrous_izisshaAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_EVASION, 3s);
                events.ScheduleEvent(EVENT_FLUID_LIKE_WATR, 8s);
                events.ScheduleEvent(EVENT_STILL_WATERS_RUN_DEEP, 13s);
            }
    ...
    public:
        ...
        struct mob_julia_batesAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_HUNDRED_HAND_SLAP, 3s);
                events.ScheduleEvent(EVENT_SOOTHING_MIST, 8s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_HUNDRED_HAND_SLAP:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_HUNDRED_HAND_SLAP, false);
                            events.ScheduleEvent(EVENT_HUNDRED_HAND_SLAP, 7s);
                            break;
                        case EVENT_SOOTHING_MIST:
                            me->CastSpell(me, SPELL_SOOTHING_MIST, false);
                            events.ScheduleEvent(EVENT_SOOTHING_MIST, 7s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
    ...
    public:
        ...
        struct mob_kuo_naAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_FLYING_SERPENT_KICK_2, 3s);
                events.ScheduleEvent(EVENT_PAW_PUNCH, 8s);
                events.ScheduleEvent(EVENT_UPPERCUT_2, 15s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_FLYING_SERPENT_KICK_2:
                            ...
                            events.ScheduleEvent(EVENT_FLYING_SERPENT_KICK_2, 21s);
                            break;
                        case EVENT_PAW_PUNCH:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_PAW_PUNCH, false);
                            events.ScheduleEvent(EVENT_PAW_PUNCH, 21s);
                            break;
                        case EVENT_UPPERCUT_2:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_UPPERCUT, false);
                            events.ScheduleEvent(EVENT_UPPERCUT_2, 21s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
    ...
    public:
        ...
        struct mob_mindel_sunspeakerAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_SUNFLARE_KICK, 3s);
                events.ScheduleEvent(EVENT_SUNSTRIKE, 8s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_SUNFLARE_KICK:
                            ...
                            events.ScheduleEvent(EVENT_SUNFLARE_KICK, 12s);
                            break;
                        case EVENT_SUNSTRIKE:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_SUNSTRIKE, false);
                            events.ScheduleEvent(EVENT_SUNSTRIKE, 12s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_SPINNING_CRANE_KICK:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_SPINNING_CRANE_KICK, false);
                            events.ScheduleEvent(EVENT_SPINNING_CRANE_KICK, 12s);
                            break;
                        case EVENT_VICIOUS_KICK:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_VICIOUS_KICK, false);
                            events.ScheduleEvent(EVENT_VICIOUS_KICK, 12s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
    ...
    public:
        ...
        struct mob_theloniusAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_UPPERCUT, 3s);
                events.ScheduleEvent(EVENT_SPINNING_CRANE_KICK, 8s);
                events.ScheduleEvent(EVENT_HUNDRED_HAND_SLAP, 13s);
                events.ScheduleEvent(EVENT_FLYING_SERPENT_KICK, 20s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_UPPERCUT:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_UPPERCUT, false);
                            events.ScheduleEvent(EVENT_UPPERCUT, 25s);
                            break;
                        case EVENT_SPINNING_CRANE_KICK:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_SPINNING_CRANE_KICK, false);
                            events.ScheduleEvent(EVENT_SPINNING_CRANE_KICK, 25s);
                            break;
                        case EVENT_HUNDRED_HAND_SLAP:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_HUNDRED_HAND_SLAP, false);
                            events.ScheduleEvent(EVENT_HUNDRED_HAND_SLAP, 25s);
                            break;
                        case EVENT_FLYING_SERPENT_KICK:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_FLYING_SERPENT_KICK, false);
                            events.ScheduleEvent(EVENT_FLYING_SERPENT_KICK, 25s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
    ...
    public:
        ...
        struct mob_tukka_tukAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_POUND_YOU, 3s);
                events.ScheduleEvent(EVENT_KICK_YOU, 8s);
                events.ScheduleEvent(EVENT_PUNCH_YOU, 13s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_POUND_YOU:
                            ...
                            events.ScheduleEvent(EVENT_POUND_YOU, 20s);
                            break;
                        case EVENT_KICK_YOU:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, SPELL_KICK_YOU, false);
                            events.ScheduleEvent(EVENT_KICK_YOU, 20s);
                            break;
                        case EVENT_PUNCH_YOU:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_PUNCH_YOU, false);
                            events.ScheduleEvent(EVENT_PUNCH_YOU, 20s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
    ...
    public:
        ...
        struct mob_yan_quillpawAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                events.ScheduleEvent(EVENT_UPPERCUT, 3s);
                events.ScheduleEvent(EVENT_FLYING_SERPENT_KICK, 8s);
                events.ScheduleEvent(EVENT_PAW_PUNCH, 13s);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_PAW_PUNCH:
                            if (Unit* target = SelectTarget(SelectTargetMethod::MaxThreat))
                                me->CastSpell(target, SPELL_PAW_PUNCH, false);
                            events.ScheduleEvent(EVENT_PAW_PUNCH, 20s);
                            break;
                        case EVENT_DESPAWN:
                            me->DespawnOrUnsummon();
                            break;
