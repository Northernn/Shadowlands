...
struct boss_ataldazar_volkaal : public BossAI
{
    ...
    void JustEngagedWith(Unit* who) override
    {
        Talk(TALK_AGGRO);
        // Events
        events.ScheduleEvent(EVENT_CLOSE_DOOR, 18s);
        events.ScheduleEvent(EVENT_TOXIC_LEAP, 2s);
        events.ScheduleEvent(EVENT_NOXIOUS_STENCH, 6s);
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        while (uint32 eventId = events.ExecuteEvent())
        {
            ...
            case EVENT_NOXIOUS_STENCH:
            {
                ...
                if (phase == 2)
                {
                    events.ScheduleEvent(EVENT_NOXIOUS_STENCH, 20s);
                }
                break;
            }
            case EVENT_TOXIC_LEAP:
            {
                ...
                events.ScheduleEvent(EVENT_JUMP_DAMAGE, 3s);
                events.ScheduleEvent(EVENT_TOXIC_LEAP, 6s);
                break;
            }
            case EVENT_TOXIC_POOL:
            {
                ...
                events.ScheduleEvent(EVENT_TOXIC_POOL, 1s);
                break;
            }
    ...
    void DoAction(int32 action) override
    {
        ...
        case ACTION_TOTEM_DIED:
        {
            ...
            if (totemsDead == 3)
            {
                ...
                events.ScheduleEvent(EVENT_TOXIC_POOL, 8s);
            }
            break;
        }
