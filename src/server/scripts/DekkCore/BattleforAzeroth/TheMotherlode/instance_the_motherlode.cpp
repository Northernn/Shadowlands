...
class instance_the_motherlode : public InstanceMapScript
{

public:
    instance_the_motherlode() : InstanceMapScript("instance_the_motherlode", 1594) {}

    InstanceScript* GetInstanceScript(InstanceMap* map) const override
    {
        return new instance_the_motherlode_InstanceMapScript(map);
    }

    struct instance_the_motherlode_InstanceMapScript : public InstanceScript
    {
        instance_the_motherlode_InstanceMapScript(InstanceMap* map) : InstanceScript(map)
        {
