...
class instance_siege_of_boralus : public InstanceMapScript
{
public:
    instance_siege_of_boralus() : InstanceMapScript("instance_siege_of_boralus", 1822) { }

    struct instance_siege_of_boralus_InstanceMapScript : public InstanceScript
    {
        instance_siege_of_boralus_InstanceMapScript(InstanceMap* map) : InstanceScript(map)
        {
