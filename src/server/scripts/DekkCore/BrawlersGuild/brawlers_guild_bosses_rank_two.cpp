        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case 1:
                    ...
                    events.RescheduleEvent(1, randtime(9s, 12s));
                    break;
                }
            }
            DoMeleeAttackIfReady();
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case 1:
                    ...
                    events.RescheduleEvent(1, randtime(17s, 18s));
                    break;
                case 2:
                    DoCast(SPELL_PYROBLAST);
                    events.RescheduleEvent(2, randtime(27s, 32s));
                    break;
                case 3:
                    DoCast(SPELL_FIREBALL);
                    events.RescheduleEvent(3, randtime(4s, 4s));
                    break;
                case 4:
                    DoCast(SPELL_FLAME_BUFFET);
                    events.RescheduleEvent(4, randtime(12s, 14s));
                    break;
                case 5:
                    DoCastVictim(132662);
                    DoCastVictim(132663);
