        ...
        public:
            ...
            struct boss_gugrokkAI : public BossAI
            {
                ...
                void JustEngagedWith(Unit* who) override
                {
                    ...
                    if (IsHeroic())
                        m_Events.ScheduleEvent(eEvents::EventFlameBuffet, 6s);

                    m_Events.ScheduleEvent(eEvents::EventMagmaEruption, 7s);
                    m_Events.ScheduleEvent(eEvents::EventMoltenBlast, 1s);
                    m_Events.ScheduleEvent(eEvents::EventSummonUnstableSlag, 20s);
                }
                ...
                void UpdateAI(uint32 const diff) override
                {
                    ...
                    switch (m_Events.ExecuteEvent())
                    {
                        case eEvents::EventMagmaEruption:
                        {
                            ...
                            m_Events.ScheduleEvent(eEvents::EventMagmaEruption, 28s);
    ...
    class npc_gugrokk_magma_eruption : public CreatureScript
    {
        public:
            ...
            struct npc_gugrokk_magma_eruptionAI : public ScriptedAI
            {
                ...
                void Reset() override
                {
                    m_Events.ScheduleEvent(eEvents::EventActivate, 3s);
                    m_Events.ScheduleEvent(eEvents::EventDespawn, 2s);
                ...
                void UpdateAI(uint32 const diff) override
                {
                    ...
                    switch (m_Events.ExecuteEvent())
                    {
                        case eEvents::EventCheckPlayers:
                        {
                            ...
                            m_Events.ScheduleEvent(eEvents::EventCheckPlayers, 1s);
                            break;
                        }
        ...
        public:
            ...
            struct npc_gugrokk_unstable_slagAI : public ScriptedAI
            {
                ...
                void Reset() override
                {
                    ...
                    m_Events.ScheduleEvent(eEvents::EventCheckSLG, 1s);
