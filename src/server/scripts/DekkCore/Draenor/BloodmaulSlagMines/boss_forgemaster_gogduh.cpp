            ...
            struct boss_AI : public BossAI
            {
               ...
               void DamageTaken(Unit* attacker, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
                ...
                void JustEngagedWith(Unit* who) override
                {
                    ...
                    events.ScheduleEvent((uint32)Events::MagmaBarrageCast, 4s);
                    events.ScheduleEvent((uint32)Events::SpawnRuination, 6s);
                    events.ScheduleEvent((uint32)Events::SpawnCalamity, 25s);
                }
                ...
                void UpdateAI(const uint32 diff) override
                {
                    ...
                    switch ((Events)events.ExecuteEvent())
                    {
                        case Events::MagmaBarrageCast:
                        {
                            ...
                            events.ScheduleEvent((uint32)Events::MagmaBarrageCast, 10s);
                            break;
                        }
            ...
            struct boss_AI : public BossAI
            {
                ...
                void MovementInform(uint32 type_Id, uint32 id) override
                {
                    if (id == 1 && (type_Id == POINT_MOTION_TYPE || type_Id == EFFECT_MOTION_TYPE))
                    {
                        ...
                        events.ScheduleEvent((uint32)Events::CastFlames, 5s);
                    }
                }
                ...
                void NextEvent()
                {
                    switch (urand(0, 2))
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            events.ScheduleEvent(uint32(Events::CastImpact), 10s);
                            break;
                        case 2:
                            events.ScheduleEvent(uint32(Events::CastSmash), 5s);
                            break;
                        default:
                            break;
    ...
    class npc_ruination : public CreatureScript
    {
        public:
            ...
            struct npc_ruinationAI : public ScriptedAI
            {
                ...
                {
                    events.Reset();
                    events.ScheduleEvent((uint32)Events::CastSpell, 6s);
                }
                ...
                void UpdateAI(const uint32 diff) override
                {
                    ...
                    if ((Events)events.ExecuteEvent() == Events::CastSpell)
                    {
                        ...
                        events.ScheduleEvent((uint32)Events::CastSpell, 5s);
                    }
    ...
    class npc_calamity : public CreatureScript
    {
        public:
            ...
            struct npc_calamityAI : public ScriptedAI
            {
                ...
                {
                    events.Reset();
                    events.ScheduleEvent((uint32)Events::CastSpell, 12s);
                    events.ScheduleEvent((uint32)Events::CastScorch, 3s);
                }
                ...
                void DoAction(int32 const action) override
                {
                    if (action == Action::ActionJumpFlames)
                        events.ScheduleEvent(Events::RefreshFlames, 1s);
                }
    ...
    class npc_gugdoh_molten_elemental : public CreatureScript
    {
        public:
            ...
            struct npc_gugdoh_molten_elementalAI : public ScriptedAI
            {
                ...
                {
                    events.Reset();
                    events.ScheduleEvent((uint32)Events::CastSpell, 1s);
                }
    ...
    class spell_rough_smash: public SpellScriptLoader
    {
        public:
            ...
            class spell_rough_smash_SpellScript : public SpellScript
            {
                ...
                void Register() override
                {
                    OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_rough_smash_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_CONE_ENEMY_24);
                    OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_rough_smash_SpellScript::FilterTargets, EFFECT_1, TARGET_UNIT_CONE_ENEMY_24);
