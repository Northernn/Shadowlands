        ...
        public:
            ...
            struct boss_roltallAI : public BossAI
            {
                ...
                void JustEngagedWith(Unit* who) override
                {
                    ...
                    m_Events.ScheduleEvent(eEvents::EventHeatWave, 20s);
                    m_Events.ScheduleEvent(eEvents::EventFieryBoulder, 7s);
                    m_Events.ScheduleEvent(eEvents::EventBurningSlag, 28s);
                ...
                void SpellHit(WorldObject*, SpellInfo const* spellInfo) override
                {
                    switch (spellInfo->Id)
                    {
                        ...
                        case eSpells::SpellHeatWaveAuraDummy:
                        {
                            ...
                            m_Events.ScheduleEvent(eEvents::EventHeatWaveEnd, 8s);
                            break;
                        }
                ...
                void UpdateAI(uint32 const diff) override
                {
                    ...
                    switch (m_Events.ExecuteEvent())
                    {
                        case eEvents::EventHeatWave:
                            ...
                            m_Events.ScheduleEvent(eEvents::EventHeatWave, 40s);
                            break;
                        ...
                        case eEvents::EventFieryBoulder:
                        {
                            ...
                            if (m_FieryBoulderCount < eDatas::MaxFieryBoulder)
                                m_Events.ScheduleEvent(eEvents::EventFieryBoulder, 1s);
                            else
                            {
                                m_FieryBoulderCount = 0;
                                m_Events.ScheduleEvent(eEvents::EventFieryBoulder, 30s);
                            }
                        ...
                        case eEvents::EventBurningSlag:
                        {
                            ...
                            else
                            {
                                ...
                                m_Events.ScheduleEvent(eEvents::EventBurningSlag, 5s);
                            }
                            break;
                        }
        ...
        public:
            ...
            struct npc_fiery_boulderAI : public ScriptedAI
            {
                ...
                void Reset() override
                {
                    ...
                    m_Events.ScheduleEvent(eEvents::EventMovePoint, 2s);
                }
                ...
                void UpdateAI(uint32 const diff) override
                {
                    ...
                    switch (m_Events.ExecuteEvent())
                    {
                        case eEvents::EventDealDamage:
                        {
                            ...
                            m_Events.ScheduleEvent(eEvents::EventDealDamage, 5s);
                            break;
                        }
