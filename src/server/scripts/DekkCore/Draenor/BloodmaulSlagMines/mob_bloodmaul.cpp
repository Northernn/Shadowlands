        ...
        public:
            ...
            struct mob_AI : public ScriptedAI
            {
                ...
                void Reset() override
                {
                    ...
                    me->SetUnitFlag(UnitFlags(UNIT_FLAG_UNK_6));
                }
                ...
                void JustEngagedWith(Unit* who) override
                {
                    ...
                    events.ScheduleEvent(uint32(Events::LavaSpit), 2s);
                }
                ...
                void UpdateAI(const uint32 diff) override
                {
                    ...
                    switch (events.ExecuteEvent())
                    {
                        case uint32(Events::LavaSpit):
                            if (Unit* l_Plr = SelectTarget(SelectTargetMethod::Random, 0))
        ...
        public:
            ...
            struct mob_AI : public ScriptedAI
            {
                ...
                void JustEngagedWith(Unit* target) override
                {
                    ...
                    m_Events.ScheduleEvent(eEvents::EventTraumaticStrike, 4s);
                }
    ...
    class mob_BloodmaulOgreMage : public CreatureScript
    {
        public:
            ...
            struct mob_AI : public ScriptedAI
            {
                ...
                {
                    events.ScheduleEvent(uint32(Events::BloodRage), 12s);
                }
    ...
    class mob_BloodmaulWarder : public CreatureScript
    {
        public:
            ...
            struct mob_AI : public ScriptedAI
            {
                ...
                void JustEngagedWith(Unit*) override
                {
                    events.ScheduleEvent(uint32(Events::Cleave), 1s);
                    events.ScheduleEvent(uint32(Events::FrighteningRoar), 16s);
                }
                ...
                void UpdateAI(const uint32 diff) override
                {
                    ...
                    switch (events.ExecuteEvent())
                    {
                        case uint32(Events::Cleave):
                            ...
                            events.ScheduleEvent(uint32(Events::Cleave), 9s);
                            break;
                        case uint32(Events::FrighteningRoar):
                            me->CastSpell(me, uint32(Spells::FrighteningRoar));
                            events.ScheduleEvent(uint32(Events::FrighteningRoar), 26s);
                            break;
                        default:
                            break;
                    }
    ...
    class mob_BloodmaulGeomancer : public CreatureScript
    {
        public:
            ...
            struct mob_AI : public ScriptedAI
            {
                ...
                void JustEngagedWith(Unit*) override
                {
                    events.ScheduleEvent(uint32(Events::StoneBulwark), 7s);
                }
                ...
                void UpdateAI(const uint32 diff) override
                {
                    ...
                    switch (events.ExecuteEvent())
                    {
                        case uint32(Events::StoneBulwark):
                        {
                            ...
                            events.ScheduleEvent(uint32(Events::StoneBulwark), 35s);
                            break;
                        }
                        default:
                            break;
        ...
        public:
            ...
            struct mob_AI : public ScriptedAI
            {
                ...
                void DoAction(const int32 /*action*/) override
                {
                    ...
                    events.ScheduleEvent((uint32)Events::EVENT_OVERSEER_TEXT,   2s);
                    events.ScheduleEvent((uint32)Events::EVENT_SLAVE_NO,        4s);
                    events.ScheduleEvent((uint32)Events::EVENT_LAUGH,           5s);
                    events.ScheduleEvent((uint32)Events::EVENT_MOVE,            7s);
                }

                void JustEngagedWith(Unit*) override
                {
                    events.ScheduleEvent(uint32(Events::SuppresionField), 1s);
                    events.ScheduleEvent(uint32(Events::Subjugate), 17s);
                }
                ...
                void UpdateAI(const uint32 diff) override
                {
                    ...
                    switch (eventId)
                    {
                        case uint32(Events::SuppresionField):
                        {
                            ...
                            events.ScheduleEvent(uint32(Events::SuppresionField), 18s);
                            break;
                        }
                        case uint32(Events::Subjugate):
                        {
                            me->CastSpell(me->GetVictim(), uint32(Spells::Subjugate));
                            events.ScheduleEvent(uint32(Events::Subjugate), 24s);
                            break;
                        }
                        default:
                            break;
                    ...
                    switch (eventId)
                    {
                        ...
                        case (uint32)Events::EVENT_SLAVE_NO:
                        {
                            if (Creature* enslavedMiner = me->GetMap()->GetCreature(slaveGuid))
                            {
                                ...
                                enslavedMiner->GetMotionMaster()->MoveKnockbackFrom(me->GetPositionX(), me->GetPositionY(), 10.0f);
                                if (enslavedMiner->IsAIEnabled())
                                    enslavedMiner->AI()->Talk((uint32)Texts::TEXT_SLAVE_NO);
                                enslavedMiner->DespawnOrUnsummon(1s);
                            }
                            return true;
                        }
    ...
    class mob_BloodmaulSlaver : public CreatureScript
    {
        public:
            ...
            struct mob_AI : public ScriptedAI
            {
                ...
                void JustEngagedWith(Unit*) override
                {
                    events.ScheduleEvent(uint32(Events::ChainGrip), 1s);
                    events.ScheduleEvent(uint32(Events::ShockBola), 17s);
                    events.ScheduleEvent(uint32(Events::SlaversRage), 6s);
                }
                ...
                void UpdateAI(const uint32 diff) override
                {
                    ...
                    switch (events.ExecuteEvent())
                    {
                        case uint32(Events::ChainGrip):
                            if (Unit* l_Plr = SelectTarget(SelectTargetMethod::Random, 0, 5.0f))
                                me->CastSpell(l_Plr, uint32(Spells::ChainGrip));
                            events.ScheduleEvent(uint32(Events::ChainGrip), 18s);
                            break;
                        case uint32(Events::SlaversRage):
                            me->CastSpell(me->GetVictim(), uint32(Spells::SlaversRage));
                            events.ScheduleEvent(uint32(Events::SlaversRage), 22s);
                            break;
                        case uint32(Events::ShockBola):
                            if (Unit* l_Plr = SelectTarget(SelectTargetMethod::Random, 0, 15.0f))
    ...
    class mob_BloodmaulEnforcer : public CreatureScript
    {
        public:
            ...
            struct mob_AI : public ScriptedAI
            {
                ...
                void JustEngagedWith(Unit*) override
                {
                    events.ScheduleEvent(uint32(Events::Beatdown), 1s);
                    events.ScheduleEvent(uint32(Events::Crush), 4s);
                    events.ScheduleEvent(uint32(Events::LumberingLeap), 17s);
                }
                            ...
                            if (Player* l_Plr = ObjectAccessor::FindPlayer(m_TargetGUID))
                            {
                                ...
                                for (Player* player : players)
                                    if (me->GetExactDist2d(player) <= 5.0f)
                                        player->GetMotionMaster()->MoveKnockbackFrom(me->GetPositionX(), me->GetPositionY(), 2.0f);
                            }
                            break;
                    }
                }
                ...
                void UpdateAI(const uint32 diff) override
                {
                    ...
                    switch (events.ExecuteEvent())
                    {
                        case uint32(Events::Beatdown):
                            ...
                            events.ScheduleEvent(uint32(Events::Beatdown), 26s);
                            break;
                        case uint32(Events::Crush):
                            me->CastSpell(me->GetVictim(), uint32(Spells::Crush));
                            events.ScheduleEvent(uint32(Events::Crush), 11s);
                            break;
                        case uint32(Events::LumberingLeap):
                            if (Unit* l_Plr = SelectTarget(SelectTargetMethod::Random, 0, 8.0f))
                            {
    ...
    class mob_bloodmaul_ogron : public CreatureScript
    {
        public:
            ...
            struct mob_bloodmaul_ogronAI : public ScriptedAI
            {
                ...
                void JustEngagedWith(Unit*) override
                {
                    m_Events.ScheduleEvent(eEvents::EventColossalRoar, 5s);
                    m_Events.ScheduleEvent(eEvents::EventMassiveStomp, 9s);
                }
                ...
                void UpdateAI(const uint32 diff) override
                {
                    ...
                    switch (m_Events.ExecuteEvent())
                    {
                        case eEvents::EventColossalRoar:
                            ...
                            m_Events.ScheduleEvent(eEvents::EventColossalRoar, 10s);
                            break;
                        case eEvents::EventMassiveStomp:
                            me->CastSpell(me, eSpells::SpellMassiveStomp, true);
                            m_Events.ScheduleEvent(eEvents::EventMassiveStomp, 15s);
                            break;
                        default:
                            break;
                    }
    ...
    class mob_bloodmaul_flamespeaker : public CreatureScript
    {
        public:
            ...
            struct mob_bloodmaul_flamespeakerAI : public ScriptedAI
            {
                ...
                void JustEngagedWith(Unit*) override
                {
                    m_Events.ScheduleEvent(eEvents::EventChannelFlames, 5s);
                    m_Events.ScheduleEvent(eEvents::EventExplodingFlames, 10s);
                }
                ...
                void UpdateAI(uint32 const diff) override
                {
                    ...
                    switch (m_Events.ExecuteEvent())
                    {
                        case eEvents::EventChannelFlames:
                            ...
                            m_Events.ScheduleEvent(eEvents::EventChannelFlames, 30s);
                            break;
                        case eEvents::EventExplodingFlames:
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                me->CastSpell(target, eSpells::SpellExplodingFlames, false);
                            m_Events.ScheduleEvent(eEvents::EventExplodingFlames, 20s);
                            break;
                        default:
                            break;
                    }
        ...
        public:
            ...
            struct mob_bloodmaul_exploding_flamesAI : public ScriptedAI
            {
                ...
                void Reset() override
                {
                    ...
                    me->SetUnitFlag(UnitFlags(UNIT_FLAG_REMOVE_CLIENT_CONTROL | UNIT_FLAG_NON_ATTACKABLE));
                }
    ...
    class mob_molten_earth_elemental : public CreatureScript
    {
        public:
            ...
            struct mob_molten_earth_elementalAI : public ScriptedAI
            {
                ...
                void JustEngagedWith(Unit*) override
                {
                    m_Events.ScheduleEvent(Events::EventLavaArc, 3s);
                }
                ...
                void UpdateAI(const uint32 diff) override
                {
                    ...
                    switch ((Events)m_Events.ExecuteEvent())
                    {
                        case Events::EventLavaArc:
                        {
                            ...
                            m_Events.ScheduleEvent(Events::EventLavaArc, 12s);*/
                            break;
                        }
                        default:
                            break;
    ...
    class mob_vengeful_magma_elemental : public CreatureScript
    {
        public:
            ...
            struct mob_vengeful_magma_elementalAI : public ScriptedAI
            {
                ...
                void JustEngagedWith(Unit*) override
                {
                    m_Events.ScheduleEvent(Events::EventArmorDent, 3s);
                }
                ...
                void UpdateAI(const uint32 diff) override
                {
                    ...
                    switch ((Events)m_Events.ExecuteEvent())
                    {
                        case Events::EventArmorDent:
                            ...
                            m_Events.ScheduleEvent(m_IsHC ? urand(Events::EventArmorDent, Events::EventCinderSplash) : Events::EventArmorDent, 6s);
                            break;
                        case Events::EventCinderSplash:
                            me->CastSpell(me->GetVictim(), Spells::SpellCinderSplash, false);
                            m_Events.ScheduleEvent(urand(Events::EventArmorDent, Events::EventCinderSplash), 6s);
                            break;
                        default:
                            break;
                    }
        ...
        public:
            ...
            struct mob_pillar_of_flameAI : public ScriptedAI
            {
                ...
                void Reset() override
                {
                    ...
                    me->SetUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_NON_ATTACKABLE));
                    m_Events.ScheduleEvent(Events::EventDamage, 3s);
