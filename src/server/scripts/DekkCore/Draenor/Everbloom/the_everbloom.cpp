...
public:
    ...
    struct npc_dreadpetalAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            me->HandleEmoteCommand(static_cast < Emote>(449));
        }
...
public:
    ...
    class spell_growth_SpellScript : public SpellScript
    {
        void HandleEffect(SpellEffIndex /*effIndex*/)
        {
            ...
            GetCaster()->CastSpell(targetarg, SPELL_GROWTH_2);
        }
...
public:
    ...
    class aura_barrier_AuraScript : public AuraScript
    {
        void HandlePeriodic(AuraEffect const* /*aurEff*/)
        {
            PreventDefaultAction();
            for (uint8 i = 0; i < 4; i++)
                GetCaster()->CastSpell(GetCaster(), 170663, true);
        }
...
public:
    ...
    struct go_everbloom_entrance_portalAI : public GameObjectAI
    {
        go_everbloom_entrance_portalAI(GameObject* go) : GameObjectAI(go) { }
    ...
    {
        return new go_everbloom_entrance_portalAI(go);
    }
};
...
public:
    ...
    struct go_everbloom_stormwind_portalAI : public GameObjectAI
    {
        go_everbloom_stormwind_portalAI(GameObject* go) : GameObjectAI(go) { }
    ...
    GameObjectAI* GetAI(GameObject* go) const override
    {
        return new go_everbloom_stormwind_portalAI(go);
    }
};
