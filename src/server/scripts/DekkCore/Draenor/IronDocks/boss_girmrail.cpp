        ...
        if (Creature* l_Duguru = p_Instance->instance->GetCreature(p_Instance->GetGuidData(eIronDocksDatas::DataGrimrailDuguru)))
        {
            if (Creature* l_Noxx = p_Instance->instance->GetCreature(p_Instance->GetGuidData(eIronDocksDatas::DataGrimrailNoxx)))
            {
                ...
                if (l_Duguru->isDead() && l_Noxx->isDead() && l_Makogg->isDead())
                {
                    ...
                    {
                        l_Player->KillSelf(l_Makogg);
                        l_Duguru->RemoveAllAuras();
                        l_Duguru->SetTappedBy(l_Player);
                        DespawnCreaturesInArea(eCreatures::CreatureOgreTrap, p_Me);
                        DespawnCreaturesInArea(eCreatures::CreatureBombsquad, p_Me);
                    ...
                    if (Creature* l_Koramar = l_Instance->instance->GetCreature(l_Instance->GetGuidData(eIronDocksDatas::DataKoramar)))
                    {
                        if (l_Koramar->IsAIEnabled() && l_Zoggosh->IsAIEnabled())
                        {
                            ...
                            case 0:
                                ...
                                l_Koramar->m_Events.AddEvent(new basicevent_aftergrimrail(l_Koramar, 1), l_Koramar->m_Events.CalculateTime(8s));
                                break;
                            case 1:
...
class iron_docks_grimrail_mob_train : public CreatureScript
{
    ...
    struct iron_docks_grimrail_mob_trainAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            me->SetUnitFlag(UnitFlags(UNIT_FLAG_IMMUNE_TO_PC  | UNIT_FLAG_NON_ATTACKABLE));
        }
        ...
        void DoAction(const int32 p_Action)
        {
            ...
            case eIronDocksActions::ActionTrainMoveWheels:
                ...
                if (Creature* l_NearestEngine = me->FindNearestCreature(eTrainCreatures::CreatureTrainEngine, 500.0f, true))
                {
                    ...
                    events.ScheduleEvent(eTrainEvents::EventTrainStartTrainJump, 7s);
                    events.ScheduleEvent(eTrainEvents::EventTrainStartMoving, 10s);
                }
                break;
            default:
                break;
...
class boss_grimrail_duguru : public CreatureScript
{
    ...
    struct boss_grimrail_duguruAI : public BossAI
    {
        ...
        void JustEngagedWith(Unit* p_Attacker) override
        {
            ...
            events.ScheduleEvent(eDuguruEvents::EventBloodBolt, 6s);
            events.ScheduleEvent(eDuguruEvents::EventSanguineSphere, 4s);
            events.ScheduleEvent(eDuguruEvents::EventTaintedBlood, 14s);
        }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case eDuguruEvents::EventSanguineSphere:
                {
                    ...
                    events.ScheduleEvent(eDuguruEvents::EventSanguineSphere, 26s);
                    break;
                }
    ...
    public:
        ...
        struct boss_grimrail_makoggAI : public BossAI
        {
            ...
            void OnSpellCasted(SpellInfo const* p_SpellInfo) override
            {
                ...
                {
                    if (Unit* l_Target = SelectTarget(SelectTargetMethod::MaxThreat, 0, 200.0f, true))
            ...
            void MovementInform(uint32 /*p_Type*/, uint32 p_Id) override
            {
                ...
                case eMovementInformeds::MovementInformFlamingSlash:
                    ...
                    if (Unit* l_Target = SelectTarget(SelectTargetMethod::MaxThreat, 0, 40.0f, true))
                    {
            ...
            void JustEngagedWith(Unit* p_Attacker) override
            {
                ...
                events.ScheduleEvent(eMakoggEvents::EventLavaSweep, 20s);
                events.ScheduleEvent(eMakoggEvents::EventFlamingSlash, 13s);
            }
                    ...
                    case eMakoggEvents::EventFlamingSlash:
                        {
                            ...
                            events.ScheduleEvent(eMakoggEvents::EventFlamingSlash, 25s);
                            break;
                        }
                    case eMakoggEvents::EventLavaSweep:
                        {
                            ...
                            me->SetReactState(ReactStates::REACT_PASSIVE);
                            me->SetUnitFlag(UnitFlags(UNIT_FLAG_REMOVE_CLIENT_CONTROL));
                            events.ScheduleEvent(eMakoggEvents::EventLavaSweepSpawn, 2s);
                            break;
                        }
                    case eMakoggEvents::EventLavaSweepSpawn:
                        {
                            ...
                            me->SummonCreature(eCreatures::CreatureLavaSweep, *me, TempSummonType::TEMPSUMMON_TIMED_DESPAWN, 8s);                       
                            if (m_LavaSweepers >= 2)
                            {
                                m_LavaSweepers = 0;     
                                m_LavaSweeping = true;                     
                                ...
                                events.ScheduleEvent(eMakoggEvents::EventLavaSweep, 50s);
                                events.ScheduleEvent(eMakoggEvents::EventMakoggClear, 7s);
                            }
                            else
                            events.ScheduleEvent(eMakoggEvents::EventLavaSweepSpawn, 3s);
                            break;
                        }
                        default:
                            break;
    ...
    public:
        ...
        struct boss_grimrail_noxxAI : public BossAI
        {
            ...
            void JustEngagedWith(Unit* p_Attacker) override
            {
                ...
                events.ScheduleEvent(eNoxxEvents::EventOgreTrap, 20s);
                events.ScheduleEvent(eNoxxEvents::EventJumperCables, 15s);
                events.ScheduleEvent(eNoxxEvents::EventGutShot, 4s);
                events.ScheduleEvent(eNoxxEvents::EventBombSquad, 30s);
            }
                ...
                switch (events.ExecuteEvent())
                {
                    case eNoxxEvents::EventGutShot:
                        {
                            ...
                            events.ScheduleEvent(eNoxxEvents::EventGutShot, 8s);
                            break;
                        }
                    case eNoxxEvents::EventOgreTrap:
                        {                  
                            ...
                            events.ScheduleEvent(eNoxxEvents::EventOgreTrap, 60s);
                            break;
                        }
                    case eNoxxEvents::EventJumperCables:
                        {                
                            ...
                            events.ScheduleEvent(eNoxxEvents::EventJumperCables, 27s);
                            break;
                        }
                    case eNoxxEvents::EventBombSquad:
                        {
                            me->CastSpell(me, eNoxxSpells::SpellBombSquad);
                            events.ScheduleEvent(eNoxxEvents::EventBombSquad, 50s);
                            break;
                        }
                        default:
                            break;
...
class iron_docks_grimrail_mob_ogre_trap : public CreatureScript
{
    public:
        ...
        struct iron_docks_grimrail_mob_ogre_trapAI : public ScriptedAI
        {
            iron_docks_grimrail_mob_ogre_trapAI(Creature* p_Creature) : ScriptedAI(p_Creature)
            {           
                m_Instance = me->GetInstanceScript();
            }
