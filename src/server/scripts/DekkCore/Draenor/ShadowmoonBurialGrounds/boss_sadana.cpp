...
public:
    ...
    struct boss_sadana_bloodfuryAI : public BossAI
    {
            ...
            if (summon)
            {
                switch (summon->GetEntry())
                {
                    case eSadanaCreatures::CreatureShadowRune:
                        summon->SetUnitFlag(UnitFlags(UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_REMOVE_CLIENT_CONTROL));
                        break;
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(eSadanaEvents::EventDeathSpike, 8s);
            events.ScheduleEvent(eSadanaEvents::EventDaggerFall, 12s);
            events.ScheduleEvent(eSadanaEvents::EventWhisperOfTheDarkStar, 20s);
            events.ScheduleEvent(eSadanaEvents::EventDarkCommunion, 37s);
            events.ScheduleEvent(eSadanaEvents::EventDarkEclipse, 60s);
        }
        ...
        void JustDied(Unit* /*killer*/) override
        {
            ...
            {
                if (Creature* l_WeepingSoul = me->SummonCreature(eShadowmoonBurialGroundsCreatures::CreatureWeepingSpirit, l_WorldTrigger->GetPositionX(), l_WorldTrigger->GetPositionY(), l_WorldTrigger->GetPositionZ(), l_WorldTrigger->GetOrientation(), TEMPSUMMON_TIMED_DESPAWN, 15s))
                {
            ...
            switch (events.ExecuteEvent())
            {
                case eSadanaEvents::EventDaggerFall:
                {
                  ...
                  //  me->GetAreatriggerListInRange(l_listAreaTriggers, 300.0f);
                    ...
                    {
                        if (Unit* target = SelectTarget(SelectTargetMethod::Random, 0, 100.0f, true, true, -eSadanaSpells::SpellDaggerFallGroundMarker))
                        {
                    ...
                    events.ScheduleEvent(eSadanaEvents::EventDaggerFall, 20s);
                    break;
                }
                case eSadanaEvents::EventWhisperOfTheDarkStar:
                    me->CastSpell(me, eSadanaSpells::SpellWhisperOfTheDarkStarTriggerSpell);

                    events.ScheduleEvent(eSadanaEvents::EventWhisperOfTheDarkStar, 30s);
                    break;
                case eSadanaEvents::EventDarkCommunion:
                    ...
                    events.ScheduleEvent(eSadanaEvents::EventDarkCommunion, 45s);
                    break;
                case eSadanaEvents::EventDeathSpike:
                    me->CastSpell(me, eSadanaSpells::SpellDeathSpikeFull);

                    events.ScheduleEvent(eSadanaEvents::EventDeathSpike, 15s);
                    break;
                case eSadanaEvents::EventDarkEclipse:
                {
                    me->NearTeleportTo(1795.788f, -26.7637f, 261.3088f, 4.629905f); // To the Middle.
                    me->SetUnitFlag(UnitFlags(UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_REMOVE_CLIENT_CONTROL));
                    ...
                    events.ScheduleEvent(eSadanaEvents::EventDarkEclipse, 60s);
                    events.ScheduleEvent(eSadanaEvents::EventDarkEclipseFinish, 17s);
                    break;
                }
...
public:
    ...
    struct shadowmoon_burial_grounds_creaturesAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            me->SetUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_REMOVE_CLIENT_CONTROL | UNIT_FLAG_IMMUNE_TO_PC));
...
public:
    ...
    struct shadowmoon_burial_grounds_creaturesAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            events.ScheduleEvent(eSadanaEvents::EventDaggerFallMovement, 4s);
        }
        ...
        void MovementInform(uint32 /*type*/, uint32 id) override
        {
            switch (id)
            {
                case eSadanaMovements::MovementDaggerFallReachedAlttitude: /// Damage starts ticking once dagger is in player's alttitude.
                    events.ScheduleEvent(eSadanaEvents::EventDaggerFallActivation, 1s);
                    break;
            }
        }
        ...
        void UpdateAI(uint32 const diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case eSadanaEvents::EventDaggerFallActivation:
                    ...
                    events.ScheduleEvent(eSadanaEvents::EventDaggerFall, 1s); /// Activates hardcoded damage intervals
                    break;
                ...
                case eSadanaEvents::EventDaggerFall: /// Responsible for damage ticking, disabling the automatic damage from spelldbc
                    ...
                    events.ScheduleEvent(eSadanaEvents::EventDaggerFall, 1s);
                    break;
                default:
                    break;
            }
...
public:
    ...
    struct shadowmoon_burial_grounds_creaturesAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            me->SetReactState(ReactStates::REACT_PASSIVE);
            me->SetUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_REMOVE_CLIENT_CONTROL | UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_IMMUNE_TO_NPC));
        }
...
public:
    ...
    class spell_shadowmoon_burial_grounds_dark_eclipse_AuraScript : public AuraScript
    {
        ...
        void OnApply(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
        {
            ...
            GetCaster()->SetUnitFlag(UNIT_FLAG_REMOVE_CLIENT_CONTROL);
        }
