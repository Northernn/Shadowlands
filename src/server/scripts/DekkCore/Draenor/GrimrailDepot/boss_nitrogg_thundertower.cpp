    ...
    struct boss_nitrogg_thundertowerAI : public BossAI
    {
        ...
        void Reset() override
        {
            ...
            if (!m_First)
            {
                ...
                me->SetUnitFlag(UnitFlags(UNIT_FLAG_REMOVE_CLIENT_CONTROL | UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_IMMUNE_TO_NPC));
            }
            else if (m_Phase > 2)
                m_Phase = 3;
        }
        ...
        void JustEngagedWith(Unit* p_Who) override
        {
            ...
            events.ScheduleEvent(eNitroggThundertowerEvents::EventOpenAssaultFlaps, 50s);
            events.ScheduleEvent(eNitroggThundertowerEvents::EventBlackrockGrenade, 8s);
            events.ScheduleEvent(eNitroggThundertowerEvents::EventBlackrockMortar, 15s);
        }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            if (m_Phase == 3 && me->GetHealthPct() < 80 && events.ExecuteEvent() == eNitroggThundertowerEvents::EventOpenAssaultFlaps)
            {
                ...
                if (m_Instance != nullptr)
                {
                    if (Creature* l_NitroggTurret = m_Instance->instance->GetCreature(m_Instance->GetGuidData(GrimrailDepotData::DataNitroggTurret)))
                    {
                        ...
                        events.Reset();
                        events.ScheduleEvent(eNitroggThundertowerEvents::EventReinforceBoomers, 30s);
                        events.ScheduleEvent(eNitroggThundertowerEvents::EventReinforceInfantry, 20s);
                    }
                }
            ...
            {
                events.ScheduleEvent(eNitroggThundertowerEvents::EventOpenAssaultFlaps, 10s);
            }
            ...
            case eNitroggThundertowerEvents::EventBlackrockGrenade:
                ...
                events.ScheduleEvent(eNitroggThundertowerEvents::EventBlackrockGrenade, 10s);
                break;
            case eNitroggThundertowerEvents::EventBlackrockMortar:
                ...
                events.ScheduleEvent(eNitroggThundertowerEvents::EventBlackrockMortar, 25s);
                break;
            case eNitroggThundertowerEvents::EventReinforceBoomers:
                ...
                events.ScheduleEvent(eNitroggThundertowerEvents::EventReinforceBoomers, 25s);
                break;
...
class grimrail_depot_nitrogg_thundertower_mob_iron_turret : public CreatureScript
{
    ...
    struct grimrail_depot_nitrogg_thundertower_mob_iron_turretAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* p_Who) override
        {    
            events.ScheduleEvent(eIronTowerEvents::EventSuppressiveFire, 8s);
            events.ScheduleEvent(eIronTowerEvents::EventSlagBlast, 20s);
        }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            case eIronTowerEvents::EventSuppressiveFire:
                if (Unit* l_Target = SelectTarget(SelectTargetMethod::Random, 0, 200.0f, true))
                    me->CastSpell(l_Target, eIronTowerSpells::SpellSuppressiveFirePeriodicDummy);

                me->Say("suppressive fire", LANG_UNIVERSAL, me);

                events.ScheduleEvent(eIronTowerEvents::EventSuppressiveFire, 15s);
                break;
            case eIronTowerEvents::EventSlagBlast:
                ...
                events.ScheduleEvent(eIronTowerEvents::EventSlagBlast, 30s);
                break;
            default:
                break;
            }
...
class grimrail_depot_nitrogg_thundertower_mob_gromkar_boomer : public CreatureScript
{
    ...
    struct grimrail_depot_nitrogg_thundertower_mob_gromkar_boomerAI : public ScriptedAI
    {
        ...
        {
            events.ScheduleEvent(eGromkarboomerEvents::EventBlackrockMortar, 8s);
        }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            case eGromkarboomerEvents::EventBlackrockMortar:
                ...
                events.ScheduleEvent(eGromkarboomerEvents::EventBlackrockMortarBombs, 2s);
                events.ScheduleEvent(eGromkarboomerEvents::EventBlackrockMortar, 25s);
                break;
...
public:
    ...
    struct grimrail_depot_nitrogg_thundertower_mob_gromkar_grenadierAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* p_Attacker) override
        {
            events.ScheduleEvent(eGromkarGrenadierEvents::EventBlackrockGrenade, 4s);
        }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            case eGromkarGrenadierEvents::EventBlackrockGrenade:
                if (Unit* l_Target = SelectTarget(SelectTargetMethod::Random, 0, 10.0f, true))
                    me->CastSpell(l_Target, eGromkarGrenadierSpells::SpellBlackRockGrenade);
                events.ScheduleEvent(eGromkarGrenadierEvents::EventBlackrockGrenade, 10s);
                break;
            default:
                break;
            }
            ...
            if (Unit* l_Caster = GetCaster())
            {
                if (Unit* l_Target = GetTarget())
                {
                    if (l_Target->IsWithinLOSInMap(l_Caster))
                    {
                        ...
                        if (Creature* l_NearestTrigger = l_Caster->SummonCreature(eSuppressiveFireCreatures::CreatureIronTurretNitroggSuppressiveFire, l_Position, TempSummonType::TEMPSUMMON_TIMED_DESPAWN, 1s))
                        {
