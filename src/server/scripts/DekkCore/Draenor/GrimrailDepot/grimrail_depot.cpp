...
class grimrail_depot_mob_grimrail_bombadier : public CreatureScript
{
    ...
    struct grimrail_depot_mob_grimrail_bombadierAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            events.ScheduleEvent(eGrimrailBombadierEvents::EventBlackrockBombs, 3s);
        }

        void JustEngagedWith(Unit* p_Attacker) override
        {         
            events.ScheduleEvent(eGrimrailBombadierEvents::EventDoubleSlash, 6s);
        }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            if (events.ExecuteEvent() == eGrimrailBombadierEvents::EventBlackrockBombs)
            {
                ...
                events.ScheduleEvent(eGrimrailBombadierEvents::EventBlackrockBombs, 10s);
            }
            ...
            case eGrimrailBombadierEvents::EventBlackrockBombs:
                if (Unit* l_Target = SelectTarget(SelectTargetMethod::Random, 0, 15.0f, true))
                ...
                events.ScheduleEvent(eGrimrailBombadierEvents::EventBlackrockBombs, 5s);
                break;
            case eGrimrailBombadierEvents::EventDoubleSlash:
                if (Unit* l_Victim = me->GetVictim())
                    me->CastSpell(l_Victim, eGrimrailBombadierSpells::SpellDoubleSlash);

                events.ScheduleEvent(eGrimrailBombadierEvents::EventDoubleSlash, 7s);
                break;
            default:
                break;
            }
...
class grimrail_depot_mob_grimrail_laborer : public CreatureScript
{
    ...
    struct grimrail_depot_mob_grimrail_laborerAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* p_Attacker) override
        {
            events.ScheduleEvent(eGrimrailLaborerEvents::EventHaymaker, 6s);
        }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            case eGrimrailLaborerEvents::EventHaymaker:
                if (Unit* l_Target = me->GetVictim())
                    events.ScheduleEvent(eGrimrailLaborerEvents::EventHaymaker, 8s);
                break;
            default:
                break;
            }
...
class grimrail_depot_mob_grimrail_overseer : public CreatureScript
{
    ...
    struct grimrail_depot_mob_grimrail_overseerAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* p_Attacker) override
        {
            events.ScheduleEvent(eGrimrailOverseerEvents::EventDash, 15s);
            events.ScheduleEvent(eGrimrailOverseerEvents::EventHewingSwipe, 6s);
        }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            case eGrimrailOverseerEvents::EventDash:
                if (Unit * l_Random = SelectTarget(SelectTargetMethod::MaxThreat, 0, 100.0f, true))
                {
...
class grimrail_depot_mob_grimrail_scout : public CreatureScript
{
    ...
    struct grimrail_depot_mob_grimrail_scoutAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* p_Attacker) override
        {
            events.ScheduleEvent(eGrimrailScoutEvents::EventArcaneBlitz, 0s);
        }
...
class grimrail_depot_mob_grimrail_technician : public CreatureScript
{
    ...
    struct grimrail_depot_mob_grimrail_technicianAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* p_Attacker) override
        {
            events.ScheduleEvent(eGrimrailTechnicianEvents::Event50kVolts, 8s);
            events.ScheduleEvent(eGrimrailTechnicianEvents::EventActivating, 20s);
        }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            case eGrimrailTechnicianEvents::Event50kVolts:
                ...
                events.ScheduleEvent(eGrimrailTechnicianEvents::Event50kVolts, 15s);
                break;
    ...
    struct grimrail_depot_iron_starAI : public ScriptedAI
    {
        ...
        void DoAction(const int32 p_Action) override
        {
            ...
            case eAction::ActionActivateEffect:
            {
                ...
                events.ScheduleEvent(eIronStarMkIIIEvents::IronStarMkIIIChargeEvent, 2s);
                break;
            }
            default:
                break;
...
class grimrail_depot_mob_gromkar_capitan : public CreatureScript
{
    ...
    struct grimrail_depot_mob_gromkar_capitanAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* p_Attacker) override
        {
            events.ScheduleEvent(eGromkarCapitanEvents::EventRecklessSlash, 0s);
        }
...
class grimrail_depot_mob_gromkar_cinderseer : public CreatureScript
{
    ...
    struct grimrail_depot_mob_gromkar_cinderseerAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* p_Attacker) override
        {
            events.ScheduleEvent(eGromkarCinderseerEvents::EventFlametongue, 10s);
            events.ScheduleEvent(eGromkarCinderseerEvents::EventLavaWreath, 15s);
        }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            case eGromkarCinderseerEvents::EventFlametongue:
                ...
                events.ScheduleEvent(eGromkarCinderseerEvents::EventFlametongue, 20s);
                break;
            case eGromkarCinderseerEvents::EventLavaWreath:
                if (Unit* l_Target = SelectTarget(SelectTargetMethod::Random, 0, 20.0f, true))
                    me->CastSpell(l_Target, eGromkarCinderseerSpells::SpellLavaWreathDummy);
                events.ScheduleEvent(eGromkarCinderseerEvents::EventLavaWreath, 30s);
                break;
            default:
                break;
            }
...
class grimrail_depot_mob_gromkar_farseer : public CreatureScript
{
    ...
    struct grimrail_depot_mob_gromkar_farseerAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* p_Attacker) override
        {
            events.ScheduleEvent(eGromkarFarSeerEvents::EventStormShield, 8s);
            events.ScheduleEvent(eGromkarFarSeerEvents::EventThunderZone, 15s);
            events.ScheduleEvent(eGromkarFarSeerEvents::EventHealingRain, 20s);
        }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            case eGromkarFarSeerEvents::EventStormShield:
                ...
                events.ScheduleEvent(eGromkarFarSeerEvents::EventStormShield, 16s);
                break;
            case eGromkarFarSeerEvents::EventHealingRain:
            {
                me->CastSpell(me, eGromkarFarSeerSpells::SpellHealingRainDummy);
                events.ScheduleEvent(eGromkarFarSeerEvents::EventHealingRain, 0s);
                break;
            }
            case eGromkarFarSeerEvents::EventThunderZone:
                events.ScheduleEvent(eGromkarFarSeerEvents::EventThunderZone, 0s);
                break;
            default:
                break;
            }
...
public:
    ...
    struct grimrail_depot_mob_gromkar_gunnerAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* p_Attacker) override
        {
            events.ScheduleEvent(eGromkarGunnerEvents::EventShrapnelBlast, 1s);
        }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            case eGromkarGunnerEvents::EventShrapnelBlast:
                ...
                events.ScheduleEvent(eGromkarGunnerEvents::EventShrapnelBlast, 4s);
                break;
            default:
                break;
            }
...
class grimrail_depot_thunder_zone : public SpellScriptLoader
{
    ...
    class grimrail_depot_thunder_zone_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectHitTarget += SpellEffectFn(grimrail_depot_thunder_zone_SpellScript::HandleDummy, SpellEffIndex::EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };
