...
class boss_skylord_torva : public CreatureScript
{
	...
	struct boss_skylord_torvaAI : public BossAI
	{
        ...
        void JustEngagedWith(Unit* p_Who) override
        {
            ...
            events.ScheduleEvent(eSkylordTorvaEvents::EventFreezingSnare, 8s);
            events.ScheduleEvent(eSkylordTorvaEvents::EventSpinningSpear, 12s);
        }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            case eSkylordTorvaEvents::EventSpinningSpear:
                if (Unit* l_Target = SelectTarget(SelectTargetMethod::Random, 0, 150.0f, true))
...
class grimrail_depot_skylord_tovra_creature_rkuna : public CreatureScript
{
    ...
    struct grimrail_depot_skylord_tovra_creature_rkunaAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
           ...
           // events.ScheduleEvent(eSkylordTorvaEvents::EventInstallAccessories, 2s);
        }
        ...
        void MovementInform(uint32 /*p_Type*/, uint32 p_Id) override
        {
            ...
            case eSkylordTorvaMovements::MovementFlyPoint:
                events.Reset();
                me->SetAIAnimKitId(eSkylordTorvaOneShotAnimKit::AnimKitFly);
                events.ScheduleEvent(eSkylordTorvaEvents::EventDiffusedEnergy, 3s);
                break;
...
class grimrail_depot_skylord_tovra_spell_diffused_lightning : public SpellScriptLoader
{
    ...
    class grimrail_depot_skylord_tovra_spell_diffused_lightning_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectLaunch += SpellEffectFn(grimrail_depot_skylord_tovra_spell_diffused_lightning_SpellScript::HandleDummy, SpellEffIndex::EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };
