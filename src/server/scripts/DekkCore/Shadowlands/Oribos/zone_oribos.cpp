...
public:
    ...
    struct npc_polemarch_adrestes_171787AI : public ScriptedAI
    {
        ...
        bool OnGossipHello(Player* player) override
        {
            ...
            {
                AddGossipItemFor(player, GossipOptionNpc::None, "Tell me again of the virtues of the Kyrian!", GOSSIP_SENDER_MAIN, 0);
                AddGossipItemFor(player, GossipOptionNpc::None, "Can I please test the Kyrian covenant abilities again?", GOSSIP_SENDER_MAIN, 1);
                AddGossipItemFor(player, GossipOptionNpc::None, "Could you please reset the cooldown on my ability so I can train further?", GOSSIP_SENDER_MAIN, 2);
                AddGossipItemFor(player, GossipOptionNpc::None, "What adventures await me if I join your covenant?", GOSSIP_SENDER_MAIN, 3);
...
public:
    ...
    struct npc_general_draven_171589AI : public ScriptedAI
    {
        ...
        bool OnGossipHello(Player* player) override
        {
            ...
            if (player->HasQuest(62000) || player->HasQuest(57878)) // This menu show only if u have Choosing Your Purpose quest.
            {
                AddGossipItemFor(player, GossipOptionNpc::None, "How could the Venthyr benefit me?", GOSSIP_SENDER_MAIN, 0);
                AddGossipItemFor(player, GossipOptionNpc::None, "Can I please test the Venthyr covenant abilities again?", GOSSIP_SENDER_MAIN, 1);
                AddGossipItemFor(player, GossipOptionNpc::None, "Could you please reset the cooldown on my ability so I can train further?", GOSSIP_SENDER_MAIN, 2);
                AddGossipItemFor(player, GossipOptionNpc::None, "What adventures await me if I join your covenant?", GOSSIP_SENDER_MAIN, 3);
                SendGossipMenuFor(player, DEFAULT_GOSSIP_MESSAGE, me->GetGUID());
            }
...
public:
    ...
    struct npc_lady_moonberry_171795AI : public ScriptedAI
    {
        ...
        bool OnGossipHello(Player* player) override
        {
            ...
            if (player->HasQuest(62000) || player->HasQuest(57878)) // This menu show only if u have Choosing Your Purpose quest.
            {
                AddGossipItemFor(player, GossipOptionNpc::None, "Remind me of the Night Fae!", GOSSIP_SENDER_MAIN, 0);
                AddGossipItemFor(player, GossipOptionNpc::None, "Can I please test the Night Fae covenant abilities again?", GOSSIP_SENDER_MAIN, 1);
                AddGossipItemFor(player, GossipOptionNpc::None, "Could you please reset the cooldown on my ability so I can train further?", GOSSIP_SENDER_MAIN, 2);
                AddGossipItemFor(player, GossipOptionNpc::None, "What adventures await me if I join your covenant?", GOSSIP_SENDER_MAIN, 3);
                SendGossipMenuFor(player, DEFAULT_GOSSIP_MESSAGE, me->GetGUID());
            }
...
public:
    ...
    struct npc_secutor_mevix_171821AI : public ScriptedAI
    {
        ...
        bool OnGossipHello(Player* player) override
        {
            ...
            if (player->HasQuest(62000) || player->HasQuest(57878)) // This menu show only if u have Choosing Your Purpose quest.
            {
                AddGossipItemFor(player, GossipOptionNpc::None, "What are the strengths of the Necrolords?", GOSSIP_SENDER_MAIN, 0);
                AddGossipItemFor(player, GossipOptionNpc::None, "Can I please test the Necrolord covenant abilities again?", GOSSIP_SENDER_MAIN, 1);
                AddGossipItemFor(player, GossipOptionNpc::None, "Could you please reset the cooldown on my ability so I can train further?", GOSSIP_SENDER_MAIN, 2);
                AddGossipItemFor(player, GossipOptionNpc::None, "What adventures await me if I join your covenant?", GOSSIP_SENDER_MAIN, 3);
                SendGossipMenuFor(player, DEFAULT_GOSSIP_MESSAGE, me->GetGUID());
            }
...
private:
    ...
    {
        if (!player->HasQuest(QUEST_INTO_THE_MAW))
            return;
