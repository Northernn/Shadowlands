...
private:
    ...
    { 
        ...
        case SPELL_CHARGED_STOMP:
            if (target->IsUnit())
                me->AddAura(SPELL_CHARGED_ANIMA, target->ToUnit());
            break;
        }
    }
    ...
    void OnSuccessfulSpellCast(SpellInfo const* spellInfo)
    {
        ...
        case SPELL_EMPYREAL_ORDNANCE_CAST:
            ...
            if (this->ordnanceCounter == 2)
            {
                ...
                {
                    animaOrbs->AddAura(SPELL_EMPYREAL_ORDNANCE_VISUAL, me);
...
private:
    ...
    {        
        ...
        me->AddAura(SPELL_ANIMA_FIELD_APPLY_AT, me);
    }
    ...
    { 
        ...
        if (Creature* oryphrion = me->FindNearestCreature(NPC_ORYPHRION, 100.0f, true))
            ...
            { 
                ...
                oryphrion->AddAura(SPELL_RECHARGE_ANIMA, oryphrion);
