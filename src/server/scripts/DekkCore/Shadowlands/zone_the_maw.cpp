...
//        {
//            if (player->GetQuestStatus(QUEST_BY_AND_DOWN_THE_RIVER))
//            {
//                if (!player->GetPhaseShift().HasPhase(10040)) PhasingHandler::AddPhase(player, 10040, true);
//            }
//        }
...
//        {
//            if (player->GetQuestObjectiveProgress(QUEST_BY_AND_DOWN_THE_RIVER, 2))
//            {
//                if (!player->GetPhaseShift().HasPhase(10040)) PhasingHandler::AddPhase(player, 10040, true);
//                if (!player->GetPhaseShift().HasPhase(10044)) PhasingHandler::AddPhase(player, 10044, true);
//            }
...
//                    if (!say59762)
//                    {
//                        if (player->HasQuest(QUEST_BY_AND_DOWN_THE_RIVER))
//                        {
...
//                                {
//                                    jaina->AI()->Talk(39);
//                                    me->AddDelayedEvent(1000, [this, thrall]()
//                                        {
//                                            thrall->AI()->Talk(9);
//                                        });
//                                    me->AddDelayedEvent(8000, [this]()
