        ...
        me->AddDelayedEvent(3000, [this, who]()
            {
                ...
                me->SummonCreature(167254, Position(76.064f, -2137.493f, -30.173f, 5.0f), TEMPSUMMON_MANUAL_DESPAWN, 5min, 0U);
            });
    }
...
void AddSC_zone_exiles_reach_horde()
{
  ...
  //  RegisterAreaTriggerAI(at_for_gutgruck_the_tough); custom at spawn it 
