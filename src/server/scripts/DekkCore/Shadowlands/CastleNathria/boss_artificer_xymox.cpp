...
void DamageTaken(Unit* attacker, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
    ...
    void OnSpellCast(SpellInfo const* spell) override
    {
        ...
        {
            UnitList targetList;
       //     SelectTargetList(targetList, 2, SelectTargetMethod::Random, 100.0f, true);
        ...
        {
            UnitList targetList;
       //     SelectTargetList(targetList, 3, SelectTargetMethod::Random, 100.0f, true);
            for (Unit* targets : targetList)
            {
    ...
    void JustSummoned(Creature* summon) override
    {
        ...
        case NPC_ROOT_OF_EXTINCTION:
            ...
            summon->SetUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_UNINTERACTIBLE));
            break;
        ...
        case NPC_EDGE_OF_ANNIHILATION:
            summon->SetUnitFlag(UnitFlags(UNIT_FLAG_IMMUNE_TO_NPC | UNIT_STATE_UNATTACKABLE));
            summon->SetReactState(REACT_PASSIVE);
