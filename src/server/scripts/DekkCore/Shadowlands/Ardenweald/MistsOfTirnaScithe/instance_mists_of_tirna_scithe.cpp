...
private:
    ...
    {
        entrancePosition.Relocate(-6893.227051f, 1836.504883f, 5544.251465f, 1.462570f);
        return true;
    }
    ...
    void SummonChallengeGameObject(bool door) override
    {
        if (door)
        {
            if (auto go = instance->SummonGameObject(MYTHIC_DOOR_4, { -6893.227051f, 1836.504883f, 5544.251465f, 1.462570f }, {}, 0))
            {
