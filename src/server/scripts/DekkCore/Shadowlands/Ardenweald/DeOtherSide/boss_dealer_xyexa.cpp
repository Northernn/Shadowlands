...
struct boss_dealer_xyexa : public BossAI
    {
        boss_dealer_xyexa(Creature* creature) : BossAI (creature, DATA_DEALER_XYEXA) { }
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            Talk(SAY_AGGRO);
            instance->SetBossState(DATA_DEALER_XYEXA, IN_PROGRESS);
        ...
        void JustDied(Unit* /*who*/) override
        {
            Talk(SAY_DEATH);
            _JustDied();
            instance->SetBossState(DATA_DEALER_XYEXA, DONE);
            me->RemoveAllAreaTriggers();
        }
                private:
                    EventMap _events;
