    ...
    void OnQuestAccept(Player* player, Quest const* quest) override
    {
        if (quest->GetQuestId() == QUEST_TO_DARKMAUL_CITADEL)
        {
            ...
            if (Creature* henry = me->FindNearestCreature(156887, 20.0f, true))
            {
                ...
                henry->SetWalk(false);
                henry->GetMotionMaster()->MoveFollow(me, -2.0f, henry->GetFollowAngle(), MOTION_SLOT_ACTIVE);
            }
            if (Creature* ralia = me->FindNearestCreature(156932, 20.0f, true))
            {
                ...
                ralia->GetMotionMaster()->MoveFollow(henry, -2.0f, ralia->GetFollowAngle(), MOTION_SLOT_ACTIVE);
            }
            if (Creature* meredy = me->FindNearestCreature(156886, 20.0f, true))
            {
                ...
                meredy->GetMotionMaster()->MoveFollow(ralia, -2.0f, meredy->GetFollowAngle(), MOTION_SLOT_ACTIVE);
            }
        }
    }
