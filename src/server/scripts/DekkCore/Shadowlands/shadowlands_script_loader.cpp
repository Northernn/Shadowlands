...
{
	//Zones
	AddSC_zone_exiles_reach_alliance();
	AddSC_zone_exiles_reach_horde();
	...
	AddSC_boss_ravnyr();
    //Theater of Pain
    AddSC_boss_an_affront_to_challengers();
    AddSC_boss_gorechop();
    AddSC_boss_kultharok();
    AddSC_boss_modretha_the_endless_empress();
    AddSC_boss_xav_the_unfallen();
    AddSC_instance_theater_of_pain();
	//Necrotic Wake
    ...
    AddSC_mists_of_tirna_scithe();
    AddSC_boss_ingra_maloch();
    AddSC_boss_mistcaller();
    AddSC_boss_tredova();
    //Ardenweald
    ...
    AddSC_boss_echelon();
    AddSC_boss_halkias();
    AddSC_boss_high_adjuticator_aleez();
    ...
    AddSC_boss_morgeth();
    AddSC_boss_mortanis();
    AddSC_boss_nurgash_muckformed();
    AddSC_boss_oranomonos_the_everbranching();
    AddSC_boss_valinor();
    //Sepulcher Of first Ones
