...
//162691
class boss_blightbone : public CreatureScript
{
public:
    boss_blightbone() : CreatureScript("boss_blightbone") { }

    struct boss_blightboneAI : public BossAI
    {
        boss_blightboneAI(Creature* creature) : BossAI(creature, DATA_BLIGHTBONE)
        {
    ...
    {
        return new boss_blightboneAI(creature);
    }
};
