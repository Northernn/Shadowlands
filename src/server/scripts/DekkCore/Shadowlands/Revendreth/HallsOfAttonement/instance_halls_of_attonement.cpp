...
struct instance_halls_of_attonement : public InstanceScript
{
    ...
    {
        entrancePosition.Relocate(-2209.113525f, 5032.425293f, 4140.520508f, 1.565634f);
        return true;
    }
    ...
    void SummonChallengeGameObject(bool door) override
    {
        if (door)
        {
            if (auto go = instance->SummonGameObject(MYTHIC_DOOR_4, { -2209.113525f, 5032.425293f, 4140.520508f, 1.565634f }, {}, 0))
            {
