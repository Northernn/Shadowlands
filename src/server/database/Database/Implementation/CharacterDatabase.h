...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_INS_WORLD_STAT,
    CHAR_SEL_COVENANT_COLLECTIONS,
    CHAR_REP_COVENANT_COLLECTIONS,
    CHAR_DEL_COVENANT_COLLECTIONS,

    CHAR_SEL_COVENANT_CONDUITS,
    CHAR_REP_COVENANT_CONDUITS,
    CHAR_DEL_COVENANT_CONDUITS,

    CHAR_SEL_COVENANT,
    CHAR_REP_COVENANT,
    CHAR_DEL_COVENANT,

    CHAR_SEL_COVENANT_SOULBIND,
    CHAR_REP_COVENANT_SOULBIND,
    CHAR_DEL_COVENANT_SOULBIND,

    CHAR_SEL_COVENANT_CLAIMED_RENOWN_REWARDS,
    CHAR_REP_COVENANT_CLAIMED_RENOWN_REWARDS,
    CHAR_DEL_COVENANT_CLAIMED_RENOWN_REWARDS,

    // Fluxurion >
    CHAR_SEL_CHROMIE_TIME,
    CHAR_UPD_CHROMIE_TIME,
    CHARACTERSERVICE_SEL_CLASS,
    CHARACTERSERVICE_SEL_RACE,
    CHARACTERSERVICE_DEL_INVENTORY,
    CHARACTERSERVICE_SEL_INVENTORY,
    CHARACTERSERVICE_SEL_GEARUPDATE,
    CHARACTERSERVICE_UPD_GEARUPDATE,
    CHAR_UPD_CHAR_PET_MODELID,
    CHAR_SEL_LAST_PET_NUMBER,
    // < Fluxurion
