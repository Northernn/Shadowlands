...
enum HotfixDatabaseStatements : uint32
{
    ...
    */
    ...
    HOTFIX_SEL_COVENANT,
    HOTFIX_SEL_COVENANT_MAX_ID,
    HOTFIX_SEL_COVENANT_LOCALE,
    ...
    HOTFIX_SEL_DISPLAY_SEASON,
    HOTFIX_SEL_DISPLAY_SEASON_MAX_ID,
    HOTFIX_SEL_DISPLAY_SEASON_LOCALE,
    ...
    HOTFIX_SEL_GARR_AUTO_COMBATANT,
    HOTFIX_SEL_GARR_AUTO_COMBATANT_MAX_ID,

    HOTFIX_SEL_GARR_AUTO_SPELL,
    HOTFIX_SEL_GARR_AUTO_SPELL_MAX_ID,
    HOTFIX_SEL_GARR_AUTO_SPELL_LOCALE,

    HOTFIX_SEL_GARR_AUTO_SPELL_EFFECT,
    HOTFIX_SEL_GARR_AUTO_SPELL_EFFECT_MAX_ID,
    ...
    HOTFIX_SEL_GARR_TALENT_COST,
    HOTFIX_SEL_GARR_TALENT_COST_MAX_ID,

    HOTFIX_SEL_GARR_TALENT_RANK,
    HOTFIX_SEL_GARR_TALENT_RANK_MAX_ID,
    ...
    HOTFIX_SEL_MAW_POWER_RARITY,
    HOTFIX_SEL_MAW_POWER_RARITY_MAX_ID,
    ...
    HOTFIX_SEL_MYTHIC_PLUS_SEASON_TRACKED_MAP,
    ...
    HOTFIX_SEL_RUNEFORGE_LEGENDARY_ABILITY,
    HOTFIX_SEL_RUNEFORGE_LEGENDARY_ABILITY_MAX_ID,
    HOTFIX_SEL_RUNEFORGE_LEGENDARY_ABILITY_LOCALE,
    ...
    HOTFIX_SEL_SOULBIND,
    HOTFIX_SEL_SOULBIND_MAX_ID,
    HOTFIX_SEL_SOULBIND_LOCALE,

    HOTFIX_SEL_RENOWN_REWARDS,
    HOTFIX_SEL_RENOWN_REWARDS_MAX_ID,
    HOTFIX_SEL_RENOWN_REWARDS_LOCALE,

    HOTFIX_SEL_SOULBIND_CONDUIT,
    HOTFIX_SEL_SOULBIND_CONDUIT_MAX_ID,

    HOTFIX_SEL_SOULBIND_CONDUIT_ENHANCED_SOCKET,
    HOTFIX_SEL_SOULBIND_CONDUIT_ENHANCED_SOCKET_MAX_ID,

    HOTFIX_SEL_SOULBIND_CONDUIT_ITEM,
    HOTFIX_SEL_SOULBIND_CONDUIT_ITEM_MAX_ID,

    HOTFIX_SEL_SOULBIND_CONDUIT_RANK,
    HOTFIX_SEL_SOULBIND_CONDUIT_RANK_MAX_ID,

    HOTFIX_SEL_SOULBIND_CONDUIT_RANK_PROPERTIES,
    HOTFIX_SEL_SOULBIND_CONDUIT_RANK_PROPERTIES_MAX_ID,

    HOTFIX_SEL_SOULBIND_UI_DISPLAY_INFO,
    HOTFIX_SEL_SOULBIND_UI_DISPLAY_INFO_MAX_ID,
    HOTFIX_SEL_SOULBIND_UI_DISPLAY_INFO_LOCALE,
    ...
    HOTFIX_SEL_U_I_COVENANT_ABILITY,
    HOTFIX_SEL_U_I_COVENANT_ABILITY_MAX_ID,
    ...
    HOTFIX_SEL_UI_WIDGET,
    HOTFIX_SEL_UI_WIDGET_MAX_ID,
    HOTFIX_SEL_UI_WIDGET_LOCALE,

    HOTFIX_SEL_UI_WIDGET_DATA_SOURCE,
    HOTFIX_SEL_UI_WIDGET_DATA_SOURCE_MAX_ID,

    HOTFIX_SEL_UI_WIDGET_MAP,
    HOTFIX_SEL_UI_WIDGET_MAP_MAX_ID,

    HOTFIX_SEL_UI_WIDGET_VISUALIZATION,
    HOTFIX_SEL_UI_WIDGET_VISUALIZATION_MAX_ID,
    ...
    HOTFIX_SEL_WEEKLY_REWARD_CHEST_THRESHOLD,
    ...
    HOTFIX_SEL_WORLD_PVP_AREA,
    HOTFIX_SEL_WORLD_PVP_AREA_MAX_ID,
    ...
    HOTFIX_SEL_WORLD_MAP_OVERLAY_TILE,
    HOTFIX_SEL_WORLD_MAP_OVERLAY_TILE_MAX_ID,
