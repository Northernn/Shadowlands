...
class TC_GAME_API Quest
{
    ...
    public:
        ...
        bool   IsCallingQuest() const { return _questInfoID == QUEST_INFO_CALLING_QUEST; }
        //dekkcore
        ...
        bool IsLegionInvasion() const { return _questInfoID == QUEST_INFO_LEGION_INVASION_WORLD_QUEST_WRAPPER; }
        bool IsLegionInvasionWorldQuest() const { return _questInfoID == QUEST_INFO_LEGION_INVASION_WORLD_QUEST || _questInfoID == QUEST_INFO_LEGION_INVASION_ELITE_WORLD_QUEST; }
        bool IsInvasionPoint() const { return _questInfoID == QUEST_INFO_LEGION_INVASION_WORLD_QUEST_WRAPPER || _questInfoID == QUEST_INFO_LEGION_INVASION_ELITE_WORLD_QUEST; }
