...
enum ConditionSourceType
{
    ...
    CONDITION_SOURCE_TYPE_VIGNETTE = 51,
    CONDITION_SOURCE_TYPE_PLAYER_CHOICE = 52,
    CONDITION_SOURCE_TYPE_PLAYER_CHOICE_RESPONSE = 53,
    CONDITION_SOURCE_TYPE_WORLD_STATE = 54,
    // < DekkCore
