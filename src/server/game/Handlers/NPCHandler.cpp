...
{
    // There are spells for quest launch but tc's check for the spelleffect quest launch don't always give the quest.
    // This version force add the right quest for each timeline.
    // Last updated in 10.1.5
    uint32 questId;
