...
class TC_GAME_API TeleportHomeEvent : public BasicEvent
{
    friend class bot_ai;
    protected:
...
class TC_GAME_API TeleportFinishEvent : public BasicEvent
{
    friend class bot_ai;
    friend class BotMgr;
    protected:
...
//Await state removal
class TC_GAME_API AwaitStateRemovalEvent : public BasicEvent
{
    friend class bot_ai;
    protected:
