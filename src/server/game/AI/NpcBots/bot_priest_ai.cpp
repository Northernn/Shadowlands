...
/*                if (IsSpellReady(VAMPIRIC_TOUCH_1, diff) && can_do_shadow && Rand() < 80 &&
  ...
  /*Talent*/lvl >= 60 && isShad ? InitSpellMap(DISPERSION_1) : RemoveSpell(DISPERSION_1);
        ...
        void InitHeals() override
        {
            ...
            {
                spellInfo = sSpellMgr->GetSpellInfo(InitSpell(me, HEAL), DIFFICULTY_NONE);
            ...
            {
                spellInfo = sSpellMgr->GetSpellInfo(InitSpell(me, FLASH_HEAL_1), DIFFICULTY_NONE);
            ...
            {
                spellInfo = sSpellMgr->GetSpellInfo(InitSpell(me, PENANCE_HEAL_1), DIFFICULTY_NONE);
            ...
            {
                spellInfo = sSpellMgr->GetSpellInfo(InitSpell(me, DESPERATE_PRAYER_1), DIFFICULTY_NONE);
