/*
*
*   DEKKCORE TEAM DEVS rewrited by Thordekk
*
*
*
*
...
public:
    ...
    struct bot_giver_AI : public CreatureAI
    {
        ...
        bool OnGossipHello(Player* player) override
        {
            ...
            AddGossipItemFor(player, GossipOptionNpc::None, bot_ai::LocalizedNpcText(player, BOT_TEXT_BOTGIVER_SERVICE), HIRE, GOSSIP_ACTION_INFO_DEF + 1);

            AddGossipItemFor(player, GossipOptionNpc::None, bot_ai::LocalizedNpcText(player, BOT_TEXT_NEVERMIND), 0, GOSSIP_ACTION_INFO_DEF + 2);
            ...
            switch (sender)
            {
                ...
                case HIRE:
                {
...

                    {
                        ...
                        for (Creature const* bot : BotDataMgr::GetExistingNPCBots())
                        {
                            ...
                            if (BotMgr::FilterRaces() && bot->GetBotClass() < BOT_CLASS_EX_START &&/* (bot->GetRaceMask() & RACEMASK_ALL_PLAYABLE) &&*/
                                !(bot->GetRaceMask() & ((player->GetRaceMask() & TEAM_ALLIANCE) ? TEAM_ALLIANCE : TEAM_HORDE)))
                                continue;
                    ...
                    for (uint8 botclass = BOT_CLASS_WARRIOR; botclass < BOT_CLASS_END; ++botclass)
                    {
                        ...
                        AddGossipItemFor(player, GossipOptionNpc::None, bclass.str(), HIRE_CLASS, GOSSIP_ACTION_INFO_DEF + botclass);
                    ...
                    AddGossipItemFor(player, GossipOptionNpc::None, bot_ai::LocalizedNpcText(player, BOT_TEXT_NEVERMIND), 0, GOSSIP_ACTION_INFO_DEF + 1);
                ...
                case HIRE_CLASS:
                {
                    ...
                    for (NpcBotRegistry::const_iterator ci = allBots.begin(); ci != allBots.end(); ++ci)
                    {
                       ...
                       // player->PlayerTalkClass->GetGossipMenu().AddMenuItem(-1, GossipOptionNpc::None, info_ostr.str(),
                    ...
                    AddGossipItemFor(player, GossipOptionNpc::None, bot_ai::LocalizedNpcText(player, BOT_TEXT_BACK), HIRE, GOSSIP_ACTION_INFO_DEF + 1);
