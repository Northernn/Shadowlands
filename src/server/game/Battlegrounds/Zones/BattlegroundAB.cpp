...
void BattlegroundAB::StartingEventOpenDoors()
{
    ...
    TriggerGameEvent(AB_EVENT_START_BATTLE, nullptr, nullptr);
}
...
//   //todo  if (!good_entry)
//        //todo    good_entry = sWorldSafeLocsStore.LookupEntry(BG_AB_GraveyardIds[teamIndex + 5]);
//
//   // return good_entry;
//}
//
...
//        return;
//
//    //todo Battleground::HandleBotKillPlayer(killer, victim);
...
//        return;
//
//    //todo Battleground::HandleBotKillBot(killer, victim);
//    //RewardKillScore(GetBotTeamId(killer->GetGUID()), BG_AB_TickPoints[1]);
//}
...
//        return;
//
//    //Battleground::HandlePlayerKillBot(victim, killer); todo
//    //RewardKillScore(GetBotTeamId(killer->GetGUID()), BG_AB_TickPoints[1]);
//}
//end npcbot
