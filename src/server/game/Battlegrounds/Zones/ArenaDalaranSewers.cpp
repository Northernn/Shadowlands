...
ArenaDalaranSewers::ArenaDalaranSewers(BattlegroundTemplate const* battlegroundTemplate) : Battleground(battlegroundTemplate)
{
...
void ArenaDalaranSewers::PostUpdateImpl(uint32 diff)
{
    ...
    ArenaDalaranSewers::PostUpdateImpl(diff);
}
