...
{
public:
    BrawlBattlegroundShadoPan(BattlegroundTemplate const* battlegroundTemplate);
...
protected:
    BrawlBattlegroundShadoPanScore(ObjectGuid playerGuid, uint32 team) : BattlegroundScore(playerGuid, team) { }
