...
enum SpellAttr8 : uint32
{
    ...
    SPELL_ATTR8_HASTE_AFFECTS_DURATION           = 0x00020000, // TITLE Unknown attribute 17@Attr8
...
enum LockType
{
    ...
    LOCKTYPE_PROFESSION_HERBALISM       = 166,
    LOCKTYPE_PROFESSION_MINING          = 167
};
...
enum HolidayIds
{
    ...
    HOLIDAY_WOW_17_ANIVERSARY                           = 1225,
    HOLIDAY_SANCTUM_OF_DOMINATION                       = 1226,
};
...
// Indexes of BattlemasterList.db2 (9.2.7.44444)
enum BattlegroundTypeId : uint32
{
    ...
    BATTLEGROUND_ANAG           = 809,      // Arena Nagrand 
    BATTLEGROUND_AF             = 816,      // Ashamane's Fall
    BATTLEGROUND_BE_L           = 844,      // ArenaBladesEdge legion
    ...
    BATTLEGROUND_MUGAMBALA      = 1047,     //New Arena BFA Mugambala 
    BATTLEGROUND_THE_ROBODROME  = 1048,     // The Robodrome
    BATTLEGROUND_HOOK_POINT     = 1049,     // Hook Point
    BATTLEGROUND_EMPYREAN       = 1050,     // Empyrean Domain
    BATTLEGROUND_MUG2           = 1053,     // Mugambala version?
    BATTLEGROUND_ASHF           = 1054,     // Ashamane's Fall	version ?
    BATTLEGROUND_TOLV_A         = 1055,     // Tol'Viron Arena	version ?
    BATTLEGROUND_THE_R_2        = 1056,     // The Robodrome version ?
    BATTLEGROUND_THE_TIGER2     = 1057,     // The Tiger's Peak	version ?
    BATTLEGROUND_RUINS_OF_L2    = 1058,     // Ruins of Lordaeron version ?
    BATTLEGROUND_NA_AR_2        = 1059,     // Nagrand Arena version ?
    BATTLEGROUND_HK_2           = 1060,     // Hook Point version?
    BATTLEGROUND_EMP_D_2        = 1061,     // Empyrean Domain
    BATTLEGROUND_DSW2           = 1062,     // Dalaran Sewers
    BATTLEGROUND_BEDGE_2        = 1063,     // Blade's Edge Arena
    BATTLEGROUND_BLACKR_HOLD_2  = 1064,     // Black Rook Hold Arena	
    BATTLEGROUND_ALL_AR_BRAWL   = 1065,     // All Arenas	Brawl
    BATTLEGROUND_MALDRAXXUS_COL = 1066,     // Maldraxxus Coliseum
    BATTLEGROUND_MAL_COL_2      = 1067,     // Maldraxxus Coliseum
    BATTLEGROUND_ENIGMA_ARENA   = 1068,     // 	Enigma Arena
    BATTLEGROUND_MAL_COL_BRAWL  = 1069,     // Maldraxxus Coliseum BRAWL
    BATTLEGROUND_ROFL_E         = 1070,     // Ruins of Lordaeron
    BATTLEGROUND_MAL_COL_3      = 1071,     // Maldraxxus Coliseum
    BATTLEGROUND_ENIGMA_A_BRAWL = 1073,     // 	Enigma Arena BRAWL
    BATTLEGROUND_ENIGMA_CRUCI   = 1076,     // Enigma Crucible
    BATTLEGROUND_ENIGMA_CRUCI_2 = 1077,     // Enigma Crucible
};

#define MAX_BATTLEGROUND_TYPE_ID 1077
...
// ChrSpecializations value is index in ChrSpecialization.db2
enum Specializations : uint16
{
    SPEC_PET_FEROCITY = 74,
    SPEC_PET_CUNNING = 79,
    SPEC_PET_TENACITY = 81,
    SPEC_PET_FEROCITY2 = 535,
    SPEC_PET_CUNNING2 = 536,
    SPEC_PET_TENACITY2 = 537,
    SPEC_WARRIOR_ARMS = 71,
    SPEC_WARRIOR_FURY = 72,
    SPEC_WARRIOR_PROTECTION = 73,
    SPEC_WARRIOR_INITIAL = 1446,
    SPEC_PALADIN_HOLY = 65,
    SPEC_PALADIN_PROTECTION = 66,
    SPEC_PALADIN_RETRIBUTION = 70,
    SPEC_PALADIN_INITIAL = 1451,
    SPEC_HUNTER_BEASTMASTER = 253,
    SPEC_HUNTER_MARKSMANSHIP = 254,
    SPEC_HUNTER_SURVIVAL = 255,
    SPEC_HUNTER_INITIAL = 1448,
    SPEC_ROGUE_ASSASINATION = 259,
    SPEC_ROGUE_OUTLAW = 260,
    SPEC_ROGUE_SUBTETLY = 261,
    SPEC_ROGUE_INITIAL = 1453,
    SPEC_PRIEST_DISCIPLINE = 256,
    SPEC_PRIEST_HOLY = 257,
    SPEC_PRIEST_SHADOW = 258,
    SPEC_PRIEST_INITIAL = 1452,
    SPEC_DEATHKNIGHT_BLOOD = 250,
    SPEC_DEATHKNIGHT_FROST = 251,
    SPEC_DEATHKNIGHT_UNHOLY = 252,
    SPEC_DEATHKNIGHT_INITIAL = 1455,
    SPEC_SHAMAN_ELEMENTAL = 262,
    SPEC_SHAMAN_ENHANCEMENT = 263,
    SPEC_SHAMAN_RESTORATION = 264,
    SPEC_SHAMAN_INITIAL = 1444,
    SPEC_MAGE_ARCANE = 62,
    SPEC_MAGE_FIRE = 63,
    SPEC_MAGE_FROST = 64,
    SPEC_MAGE_INITIAL = 1449,
    SPEC_WARLOCK_AFFLICTION = 265,
    SPEC_WARLOCK_DEMONOLOGY = 266,
    SPEC_WARLOCK_DESTRUCTION = 267,
    SPEC_WARLOCK_INITIAL = 1454,
    SPEC_MONK_BREWMASTER = 268,
    SPEC_MONK_WINDWALKER = 269,
    SPEC_MONK_MISTWEAVER = 270,
    SPEC_MONK_INITIAL = 1450,
    SPEC_DRUID_BALANCE = 102,
    SPEC_DRUID_FERAL = 103,
    SPEC_DRUID_GUARDIAN = 104,
    SPEC_DRUID_RESTORATION = 105,
    SPEC_DRUID_INITIAL = 1447,
    SPEC_DEMONHUNTER_HAVOC = 577,
    SPEC_DEMONHUNTER_VENGEANCE = 581,
    SPEC_DEMONHUNTER_INITIAL = 1456
};
...
struct Covenant
{
    ...
    enum CovenantSpells
    {
        Remove_TBYB_Auras = 342111,
        Create_Covenant_Garrison = 309391,
        Start_Oribos_Intro_Quests = 325773,
        Create_Garrison_Artifact_296 = 309389,
        Create_Garrison_Artifact_299 = 309390,
        Become_A_Kyrian = 337779,
        Become_A_Venthyr = 337782,
        Become_A_NightFae = 337784,
        Become_A_Necrolord = 337781,
        // CA = Covenant Ability
        CA_Opening_Kyrian = 340010, 
        CA_Kyrian = 321076,
        CA_Opening_Venthyr = 340013,
        CA_Venthyr = 321079,
        CA_Opening_NightFae = 340004,
        CA_NightFae = 321077,
        CA_Opening_Necrolord = 340014,
        CA_Necrolord = 321078,
    };

    enum CovenantQuests
    {
        ChoosingYourPurpose_fromOribos = 62000,
        ChoosingYourPurpose_fromNathria = 57878,
    };
};
