...
enum Anim
{
    ...
    ANIM_FLY_COMBAT_ABILITY_H02 = 822,
};
...
// CreatureFamily.dbc (10.1.7.51237)
enum CreatureFamily
{
...
enum HolidayIds
{
    ...
    HOLIDAY_WOW_17S_ANIVERSARY = 1225,
    HOLIDAY_SANCTUM_OF_DOMINATION = 1226,
    HOLIDAY_SANCTUM_OF_DOMINATION2 = 1227,
    HOLIDAY_SANCTUM_OF_DOMINATION3 = 1228,
    HOLIDAY_SANCTUM_OF_DOMINATION4 = 1229,
    HOLIDAY_SANCTUM_OF_DOMINATION5 = 1230,
    HOLIDAY_SHADOPAN_SHOWDOWN_BRAWL = 1232,
    HOLIDAY_SHADOPAN_SHOWDOWN_BRAWL2 = 1233,
    HOLIDAY_PVP_COMP_STOMP           = 1234,
    HOLIDAY_PVP_COMP_STOMP2          = 1235,
    HOLIDAY_PVP_COMP_STOMP3          = 1236,
    HOLIDAY_PVP_COMP_STOMP4          = 1237,
    HOLIDAY_PVP_COMP_STOMP5          = 1238,
};
...
enum QuestInfo
{
    ...
    QUEST_INFO_PVP_ELITE_WORLD_Q = 278,
	QUEST_INFO_FORBIDDEN_REACH_ENVOY_TASK = 279,
	QUEST_INFO_DRAGONRIDER_RACING = 281,
	QUEST_INFO_IMPORTANT_QUEST = 282,
	QUEST_INFO_BONUS_OJECTIVE_WITH_COMPLETION_TOAST = 283
};

// QuestSort.dbc (10.1.7.51237)
enum QuestSort
{
    QUEST_SORT_EPIC = 1,
	...
	QUEST_SORT_SUFFUSION_CAMPS = 618,
...
// TotemCategory.db2 (10.1.7.51237)
enum TotemCategory
{
...
enum DiminishingGroup : uint16
{
    ...
    DIMINISHING_SCATTER_SHOT        = 13,
    DIMINISHING_SLEEP               = 14,
    DIMINISHING_DRAGONS_BREATH      = 15,
    DIMINISHING_MAX
};
...
enum BattlegroundTypeId : uint32
{
    ...
    BATTLEGROUND_MG = 1047,    // MUGAMBALA
    BATTLEGROUND_ROB = 1048,    //The Robodrome
    BATTLEGROUND_HKPOINT = 1049, //Hook Point
    BATTLEGROUND_ED2 = 1050,     // Empyrean Domain
    BATTLEGROUND_MG2 = 1053,    // MUGAMBALA
    BATTLEGROUND_AF4 = 1054,      // Ashamane's Fall
    BATTLEGROUND_TVA4 = 1055,      // Tol'Viron Arena
    BATTLEGROUND_ROB2 = 1056,    //The Robodrome
    BATTLEGROUND_TTP4 = 1057,      // The Tiger's Peak
    BATTLEGROUND_RL4 = 1058,    // Ruins of Lordaeron
    BATTLEGROUND_NA4 = 1059,      // Nagrand Arena
    BATTLEGROUND_HKPOINT2 = 1060, //Hook Point
    BATTLEGROUND_ED3 = 1061,     // Empyrean Domain
    BATTLEGROUND_DS4 = 1062,      // Dalaran Sewers
    BATTLEGROUND_BE3 = 1063,      // Blade's Edge
    BATTLEGROUND_BRHA4 = 1064,      // Black Rook Hold Arena
    BATTLEGROUND_ALLA = 1065,      // All Arenas
    BATTLEGROUND_MAC = 1066, //Maldraxxus Coliseum
    BATTLEGROUND_EA  = 1068, //Enigma Arena
    BATTLEGROUND_RL5 = 1070,      // Ruins of Lordaeron
    BATTLEGROUND_MAC2 = 1071, //Maldraxxus Coliseum
    BATTLEGROUND_DDB = 1075, //Deepwind Detonation BRAWL
    BATTLEGROUND_EC = 1076, //Enigma Crucible
    BATTLEGROUND_EC2 = 1077, //Enigma Crucible
    BATTLEGROUND_NPG = 1088, //Nokhudon Proving Grounds
    BATTLEGROUND_NPG2 = 1092, //Nokhudon Proving Grounds
    BATTLEGROUND_ALLA2 = 1094,      // All Arenas
    BATTLEGROUND_ALLA3 = 1095,      // All Arenas
};

#define MAX_BATTLEGROUND_TYPE_ID 1096
