...
void SystemMgr::LoadScriptWaypoints()
{
    ...
    do
    {
        ...
        if (!info->ScriptID)
            TC_LOG_DEBUG("sql.sql", "SystemMgr: DB table script_waypoint has waypoint for creature entry %u, but creature does not have ScriptName defined and then useless.", entry);
