...
{
    _worldPacket << Rewards[(uint8)BracketType::BRACKET_TYPE_RATED_BG];
    ...
    _worldPacket << Rewards[(uint8)BracketType::BRACKET_TYPE_RATED_BG];
    _worldPacket << Rewards[(uint8)BracketType::BRACKET_TYPE_ARENA_2];
    _worldPacket << Rewards[(uint8)BracketType::BRACKET_TYPE_ARENA_5];
    _worldPacket << Rewards[(uint8)BracketType::BRACKET_TYPE_ARENA_3];
 //   _worldPacket << Rewards[(uint8)BracketType::BattlegroundBraw]; define later
 //   _worldPacket << Rewards[(uint8)BracketType::ArenaBraw];
//    _worldPacket << Rewards[(uint8)BracketType::EpicBattleground];
