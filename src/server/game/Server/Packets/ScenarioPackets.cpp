...
ByteBuffer& operator<<(ByteBuffer& data, WorldPackets::Scenario::ScenarioState::ScenarioSpellUpdate const& spell)
{
...
WorldPacket const* WorldPackets::Scenario::ScenarioState::Write()
{
   ...
   for (WorldPackets::Scenario::ScenarioState::ScenarioSpellUpdate const& spell : Spells)
       _worldPacket << spell;
