...
namespace WorldPackets
{
    namespace Battleground
    {
        ...
        public:
            ...
            int32 MythicPlusDisplaySeasonID = 21;
            int32 MythicPlusMilestoneSeasonID = 97;
            int32 PreviousArenaSeason = 35;
            int32 CurrentArenaSeason = 34;
            int32 PvpSeasonID = 29;
