...
namespace rbac
{
    ...
    enum RBACPermissions
    {
        ...
        // < Fluxurion
        // AzgathCore >
        RBAC_PERM_COMMAND_QUEST_BYPASS = 4000,
        // < AzgathCore
        // PlayerBot
        RBAC_PREM_COMMAND_PBOTACCOUNT_RESETLEVEL,
        RBAC_PREM_COMMAND_PBOTACCOUNT_LOGOUTALL,
        RBAC_PREM_COMMAND_PBOTACCOUNT_LOGINALL,
        RBAC_PREM_COMMAND_PBOTACCOUNT_BOTCREATE,
        RBAC_PREM_COMMAND_PBOTACCOUNT_LOGINCLASSES,
        RBAC_PREM_COMMAND_PBOTACCOUNT,
        RBAC_PREM_COMMAND_RESETCUSTOMGOSSIP,
