...
// DekkCore >
RBAC_PERM_COMMAND_MODIFY_BP_CREDITS = 2000,
RBAC_PERM_COMMAND_RELOAD_BATTLEPAY = 2001,
RBAC_PERM_COMMAND_RELOAD_PLAYERCHOICE = 3000,
RBAC_PERM_COMMAND_RELOAD_WORLDSAFELOCS = 3001,
