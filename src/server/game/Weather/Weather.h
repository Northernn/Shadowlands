...
enum WeatherState : uint32
{
    ...
    // DekkCore >
    //Shadowlands
    WEATHER_STATE_PURPLE_LIGHTNING = 426, //No sound
    WEATHER_STATE_EXILE_REACH = 429,
    WEATHER_STATE_VOLCANO = 433,
    WEATHER_STATE_BLUE_MAGICAL_RAIN = 434, //No sound
    WEATHER_STATE_LIGHT_MAGICAL_RAIN = 438,
    WEATHER_STATE_STORM_IN_SHIP = 442,
    WEATHER_STATE_EXILE_REACH_RAIN = 457,
    WEATHER_STATE_EXILE_REACH_HEAVY_RAIN = 458,
    // < DekkCore
};
