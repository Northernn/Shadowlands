...
void Pet::SavePetToDB(PetSaveMode mode)
{
    ...
    if (mode != PET_SAVE_AS_DELETED)
    {
       ...
       // ASSERT(owner->GetPetStable()->GetCurrentPet() && owner->GetPetStable()->GetCurrentPet()->PetNumber == m_charmInfo->GetPetNumber()); thiss assert crash need debug
        ...
        stmt->setUInt32(3, GetDisplayId()); // Fluxurion
...
void Pet::FillPetInfo(PetStable::PetInfo* petInfo, Optional<ReactStates> forcedReactState /*= {}*/) const
{
    ...
    petInfo->DisplayId = GetDisplayId(); // Fluxurion
...
bool Guardian::InitStatsForLevel(uint8 petlevel)
{
    ...
    Fluxurion::PetSizeCorrection(this); // < Fluxurion
