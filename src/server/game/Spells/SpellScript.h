...
class TC_GAME_API SpellScript : public _SpellScript
{
    ...
    public:
        ...
        class OnTakePowerHandlerFunction : public SpellScript::OnTakePowerHandler { public: explicit OnTakePowerHandlerFunction(SpellOnTakePowerFnType _onTakePowerHandlerScript) : SpellScript::OnTakePowerHandler((SpellScript::SpellOnTakePowerFnType)_onTakePowerHandlerScript) {} }; \
        class OnSummonHandlerFunction : public SpellScript::OnSummonHandler { public: explicit OnSummonHandlerFunction(SpellOnSummonFnType _onSummonHandlerScript) : SpellScript::OnSummonHandler((SpellScript::SpellOnSummonFnType)_onSummonHandlerScript) {} }; \
        class OnPrepareHandlerFunction : public SpellScript::OnPrepareHandler { public: explicit OnPrepareHandlerFunction(SpellOnPrepareFnType _onPrepareHandlerScript) : SpellScript::OnPrepareHandler((SpellScript::SpellOnPrepareFnType)_onPrepareHandlerScript) {} }; \
...
class TC_GAME_API AuraScript : public _SpellScript
{
    ...
    #define AURASCRIPT_FUNCTION_TYPE_DEFINES(CLASSNAME) \
        ...
        class EffectNameAbsorbFunction : public AuraScript::EffectNameAbsorbHandler { public: explicit EffectNameAbsorbFunction(AuraEffectNameAbsorbFnType _pEffectHandlerScript, uint8 _effIndex, uint16 _effName) : AuraScript::EffectNameAbsorbHandler((AuraScript::AuraEffectNameAbsorbFnType)_pEffectHandlerScript, _effIndex, _effName) { } }; \
