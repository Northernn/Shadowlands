...
#include "MovementDefines.h" // < DekkCore
...
class TC_GAME_API Spell
{
    ...
    public:
        ...
        void EffectCreateGarrisonShipment();
        void EffectAddGarrisonMission();
        void EffectForceEquipItem();
        void EffectTeleportToDigsite();
        void EffectChangeFollowerVitality();
        ...
        void EffectIncreaseFollowerExperience();
        void EffectRemovePhase();
        void EffectGieveExperience();
        ...
        uint8 m_diffMode;
        uint32 m_miscData[2];
        void StartEmpoweredSpell(uint32 duration);
        void UpdateEmpoweredSpell(uint32 difftime);
        void EndEmpoweredSpell();
        uint32 m_spellEmpowerStage;
        uint32 m_spellEmpowerTimer;
        std::vector<uint32> m_spellEmpowerStageDurations;
        bool m_spellEmpowerReleased;
        uint8 m_spellEmpowerReleasedStage;
        uint8 GetEmpowerReleasedStage() const { return m_spellEmpowerReleasedStage; }
        ...
        void SetTriggerCastFlags(TriggerCastFlags flags) { _triggeredCastFlags = flags; } // TrinityCore PR #29151 - Aquadeus
    ...
    protected:
        ...
        void CallScriptEmpowerEndHandlers();
