...
struct GarrTalentCostLoadInfo
{
    static constexpr DB2FieldMeta Fields[9] =
    {
        ...
        { true, FT_INT, "GarrTalentRankID" },
        { true, FT_INT, "CostType" },
        { true, FT_INT, "CurrencyTypesID" },
        { true, FT_INT, "CurrencyQuantity" },
    };

    static constexpr DB2LoadInfo Instance{ Fields, 9, &GarrTalentCostMeta::Instance, HOTFIX_SEL_GARR_TALENT_COST };
};
...
struct GarrTalentRankLoadInfo
{
    ...
    static constexpr DB2LoadInfo Instance{ Fields, 18, &GarrTalentRankMeta::Instance, HOTFIX_SEL_GARR_TALENT_RANK };
};
...
struct MawPowerRarityLoadInfo
{
    ...
    static constexpr DB2LoadInfo Instance{ Fields, 3, &MawPowerRarityMeta::Instance, HOTFIX_SEL_MAW_POWER_RARITY };
};
...
struct MythicPlusSeasonRewardLevelsLoadInfo
{
    static constexpr DB2FieldMeta Fields[5] =
    {
        ...
        { true, FT_INT, "WeeklyRewardLevel" },
        { true, FT_INT, "EndOfRunRewardLevel" },
        { false, FT_INT, "MythicPlusSeasonID" },
    };

    static constexpr DB2LoadInfo Instance{ Fields, 5, &MythicPlusSeasonRewardLevelsMeta::Instance, HOTFIX_SEL_MYTHIC_PLUS_SEASON_REWARD_LEVELS };
};
...
struct AlliedRaceLoadInfo
{
    static constexpr DB2FieldMeta Fields[9] =
        ...
        static constexpr DB2LoadInfo Instance{ Fields, 9, &AlliedRaceMeta::Instance, HOTFIX_SEL_ALLIED_RACE };
};
...
struct AnimKitBoneSetLoadInfo
{
    static constexpr DB2FieldMeta Fields[6] =
        ...
        static constexpr DB2LoadInfo Instance{ Fields, 6, &AnimKitBoneSetMeta::Instance, HOTFIX_SEL_ANIM_KIT_BONE_SET };
};
...
struct AnimKitBoneSetAliasLoadInfo
{
    static constexpr DB2FieldMeta Fields[3] =
        ...
        static constexpr DB2LoadInfo Instance{ Fields, 3, &AnimKitBoneSetAliasMeta::Instance, HOTFIX_SEL_ANIM_KIT_BONE_SET_ALIAS };
};
...
struct AreaPOILoadInfo
{
    static constexpr DB2FieldMeta Fields[23] =
    {
        ...
        { true, FT_INT, "Field_10_0_0_45141_012" },
        { false, FT_SHORT, "ContinentID" },
    ...
    static constexpr DB2LoadInfo Instance{ Fields, 23, &AreaPOIMeta::Instance, HOTFIX_SEL_AREA_P_O_I };
};
...
struct AreaPOIStateLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields, 6, &AreaPOIStateMeta::Instance, HOTFIX_SEL_AREA_P_O_I_STATE };
};
...
struct CharShipmentContainerLoadInfo
{
     static constexpr DB2FieldMeta Fields[17] =
        ...
        static constexpr DB2LoadInfo Instance{ Fields, 17, &CharShipmentContainerMeta::Instance, HOTFIX_SEL_CHAR_SHIPMENT_CONTAINER };
};
...
struct CovenantLoadInfo
{
    static constexpr DB2FieldMeta Fields[11] =
    {
        ...
        { true, FT_INT, "FactionID" },
        { true, FT_INT, "Field_10_0_0" },
        { true, FT_INT, "Field_10_0_1" },
    };
...
struct GarrAbilityCategoryLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields, 2, &GarrAbilityCategoryMeta::Instance, HOTFIX_SEL_GARR_ABILITY_CATEGORY };
...
struct GarrAbilityEffectLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields, 12, &GarrAbilityEffectMeta::Instance, HOTFIX_SEL_GARR_ABILITY_EFFECT };
};
...
struct GarrAutoCombatantLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields, 10, &GarrAutoCombatantMeta::Instance, HOTFIX_SEL_GARR_AUTO_COMBATANT };
};
...
struct GarrAutoSpellEffectLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields, 8, &GarrAutoSpellEffectMeta::Instance, HOTFIX_SEL_GARR_AUTO_SPELL_EFFECT };
};
...
struct GarrFollowerLevelXPLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields, 5, &GarrFollowerLevelXPMeta::Instance, HOTFIX_SEL_GARR_FOLLOWER_LEVEL_X_P };
};
...
struct GarrTalentLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields, 15, &GarrTalentMeta::Instance, HOTFIX_SEL_GARR_TALENT };
};
...
struct LfgDungeonGroupLoadInfo
{
       static constexpr DB2FieldMeta Fields[5] =
        ...
        static constexpr DB2LoadInfo Instance{ Fields, 5, &LFGDungeonGroupMeta::Instance, HOTFIX_SEL_LFG_DUNGEON_GROUP };
};
...
struct QuestObjectiveLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,9, &QuestObjectiveMeta::Instance, HOTFIX_SEL_QUEST_OBJECTIVE };
...
struct QuestPOIBlobLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,10, &QuestPOIBlobMeta::Instance, HOTFIX_SEL_QUEST_P_O_I_BLOB };
};
...
struct RuneforgeLegendaryAbilityLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,11, &RuneforgeLegendaryAbilityMeta::Instance, HOTFIX_SEL_RUNEFORGE_LEGENDARY_ABILITY };
};
...
struct SoulbindConduitEnhancedSocketLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,3, &SoulbindConduitEnhancedSocketMeta::Instance, HOTFIX_SEL_SOULBIND_CONDUIT_ENHANCED_SOCKET };
...
struct SoulbindUiDisplayInfoLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,9, &SoulbindUIDisplayInfoMeta::Instance, HOTFIX_SEL_SOULBIND_UI_DISPLAY_INFO };
};
...
struct RenownRewardsLoadInfo
{
    static constexpr DB2FieldMeta Fields[19] =
    {
        ...
        { false, FT_STRING, "Name" },
        { false, FT_STRING, "Description" },
        { false, FT_STRING, "ToastDescription" },
        { true, FT_INT, "CovenantID" },
        { true, FT_INT, "Level" },
        { true, FT_INT, "Icon" },
        { true, FT_INT, "Flags" },
    ...
    static constexpr DB2LoadInfo Instance{ Fields, 19, &RenownRewardsMeta::Instance, HOTFIX_SEL_RENOWN_REWARDS };
};
...
struct UICovenantAbilityLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,5, &UICovenantAbilityMeta::Instance, HOTFIX_SEL_U_I_COVENANT_ABILITY };
...
struct UiTextureAtlasLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,5, &UiTextureAtlasMeta::Instance, HOTFIX_SEL_UI_TEXTURE_ATLAS };
};
...
struct UiWidgetLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,9, &UiWidgetMeta::Instance, HOTFIX_SEL_UI_WIDGET };
};
...
struct UiWidgetDataSourceLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,5, &UiWidgetDataSourceMeta::Instance, HOTFIX_SEL_UI_WIDGET_DATA_SOURCE };
};
...
struct UiWidgetMapLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,3, &UiWidgetMapMeta::Instance, HOTFIX_SEL_UI_WIDGET_MAP };
};
...
struct UiWidgetVisualizationLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,11, &UiWidgetVisualizationMeta::Instance, HOTFIX_SEL_UI_WIDGET_VISUALIZATION };
};
...
struct WindSettingsLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,17, &WindSettingsMeta::Instance, HOTFIX_SEL_WIND_SETTINGS };
...
struct WmoMinimapTextureLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,5, &WMOMinimapTextureMeta::Instance, HOTFIX_SEL_WMO_MINIMAP_TEXTURE };
};
...
struct WorldPvpAreaLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,8, &World_PVP_AreaMeta::Instance, HOTFIX_SEL_WORLD_PVP_AREA };
};
...
struct WorldChunkSoundsLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,7, &WorldChunkSoundsMeta::Instance, HOTFIX_SEL_WORLD_CHUNK_SOUNDS };
};
...
struct WorldElapsedTimerLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,4, &WorldElapsedTimerMeta::Instance, HOTFIX_SEL_WORLD_ELAPSED_TIMER };
};
...
struct WorldMapOverlayTileLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,6, &WorldMapOverlayTileMeta::Instance, HOTFIX_SEL_WORLD_MAP_OVERLAY_TILE };
};
...
struct WorldStateZoneSoundsLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,10, &WorldStateZoneSoundsMeta::Instance, HOTFIX_SEL_WORLD_STATE_ZONE_SOUNDS };
};
...
struct ZoneIntroMusicTableLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,5, &ZoneIntroMusicTableMeta::Instance, HOTFIX_SEL_ZONE_INTRO_MUSIC_TABLE };
};
...
struct ZoneLightLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,9, &ZoneLightMeta::Instance, HOTFIX_SEL_ZONE_LIGHT };
};
...
struct ZoneLightPointLoadInfo
{
        ...
        static constexpr DB2LoadInfo Instance{ Fields,5, &ZoneLightPointMeta::Instance, HOTFIX_SEL_ZONE_LIGHT_POINT };
};
