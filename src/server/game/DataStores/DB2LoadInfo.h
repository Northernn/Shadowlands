...
// --------------------------------------------------------------
// DekkCore >
// last count 2022.08.20. -> 64 not TC db2 load
...
struct AlliedRaceLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), AlliedRaceMeta::Instance(), HOTFIX_SEL_ALLIED_RACE);
        return &loadInfo;
    }
};
...
struct AnimKitBoneSetLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static DB2FieldMeta const fields[] =
        {
            { false, FT_STRING_NOT_LOCALIZED, "Name" },
            { true, FT_INT, "ID" },
            { true, FT_INT, "BoneDataID" },
            { true, FT_BYTE, "ParentAnimKitBoneSetID" },
            { true, FT_BYTE, "AltAnimKitBoneSetID" },
            { true, FT_INT, "AltBoneDataID" },
        };
...
struct AreaPOILoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            ...
            { true, FT_INT, "PoiData" },
            { false, FT_INT, "Field_9_1_0" },
            { false, FT_SHORT, "ContinentID" },
            { true, FT_SHORT, "AreaID" },
            { false, FT_SHORT, "WorldStateID" },
            { false, FT_SHORT, "UiWidgetSetID" },
            { false, FT_SHORT, "UiTextureKitID" },
            { false, FT_SHORT, "Field_9_1_0_38783" },
            { false, FT_BYTE, "Importance" },
            { false, FT_BYTE, "Icon" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), AreaPOIMeta::Instance(), HOTFIX_SEL_AREA_P_O_I);
        return &loadInfo;
    }
};
...
struct AreaPOIStateLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), AreaPOIStateMeta::Instance(), HOTFIX_SEL_AREA_P_O_I_STATE);
        return &loadInfo;
    }
};
struct BattlePetAbilityLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), BattlePetAbilityMeta::Instance(), HOTFIX_SEL_BATTLE_PET_ABILITY);
        return &loadInfo;
    }
};
...
struct BattlePetStateLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), BattlePetStateMeta::Instance(), HOTFIX_SEL_BATTLE_PET_STATE);
        return &loadInfo;
    }
};
...
struct BattlePetAbilityEffectLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), BattlePetAbilityEffectMeta::Instance(), HOTFIX_SEL_BATTLE_PET_ABILITY_EFFECT);
        return &loadInfo;
    }
};
...
struct BattlePetAbilityStateLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), BattlePetAbilityStateMeta::Instance(), HOTFIX_SEL_BATTLE_PET_ABILITY_STATE);
        return &loadInfo;
    }
};
...
struct BattlePetAbilityTurnLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), BattlePetAbilityTurnMeta::Instance(), HOTFIX_SEL_BATTLE_PET_ABILITY_TURN);
        return &loadInfo;
    }
};
...
struct BattlePetSpeciesXAbilityLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), BattlePetSpeciesXAbilityMeta::Instance(), HOTFIX_SEL_BATTLE_PET_SPECIES_X_ABILITY);
        return &loadInfo;
    }
};
struct BountyLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), BountyMeta::Instance(), HOTFIX_SEL_BOUNTY);
        return &loadInfo;
    }
};
...
struct BountySetLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), BountySetMeta::Instance(), HOTFIX_SEL_BOUNTY_SET);
        return &loadInfo;
    }
};
...
struct ChallengeModeItemBonusOverrideLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        {
            { false, FT_INT, "ID" },
            { true, FT_INT, "OverrideItemBonusTreeID" },
            { true, FT_BYTE, "Type" },
            { true, FT_INT, "Level" },
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), ChallengeModeItemBonusOverrideMeta::Instance(), HOTFIX_SEL_CHALLENGE_MODE_ITEM_BONUS_OVERRIDE);
        return &loadInfo;
    }
};
...
struct CharShipmentContainerLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), CharShipmentContainerMeta::Instance(), HOTFIX_SEL_CHAR_SHIPMENT_CONTAINER);
        return &loadInfo;
    }
};
...
struct ContributionLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            ...
            { true, FT_INT, "OrderIndex" },
            { true, FT_INT, "ContributionStyleContainer" },
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), ContributionMeta::Instance(), HOTFIX_SEL_CONTRIBUTION);
        return &loadInfo;
    }
};
...
struct CovenantLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            ...
            { true, FT_INT, "DeathTeleportSpellID" },
            { true, FT_INT, "Field_9_0_2_1" },
            { true, FT_INT, "Field_9_0_2_3" },
            { true, FT_INT, "FactionID" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), CovenantMeta::Instance(), HOTFIX_SEL_COVENANT);
        return &loadInfo;
    }
};
...
struct GarrAbilityCategoryLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), GarrAbilityCategoryMeta::Instance(), HOTFIX_SEL_GARR_ABILITY_CATEGORY);
        return &loadInfo;
    }
};
...
struct GarrAbilityEffectLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            { false, FT_INT, "ID" },
            { false, FT_SHORT, "GarrAbilityID" },
            { true, FT_BYTE, "AbilityAction" },
            { false, FT_BYTE, "AbilityTargetType" },
            { true, FT_INT, "GarrMechanicTypeID" },
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), GarrAbilityEffectMeta::Instance(), HOTFIX_SEL_GARR_ABILITY_EFFECT);
        return &loadInfo;
    }
};

struct GarrAutoCombatantLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static DB2FieldMeta const fields[] =
        {
            { false, FT_INT, "ID" },
            { true, FT_INT, "HealthBase" },
            { true, FT_INT, "HealthGainPerLevel" },
            { true, FT_INT, "AttackBase" },
            { true, FT_INT, "AttackGainPerLevel" },
            { true, FT_INT, "AttackSpellID" },
            { true, FT_INT, "AbilitySpellID" },
            { true, FT_INT, "AbilitySpellID2" },
            { true, FT_INT, "PassiveSpellID" },
            { true, FT_INT, "Role" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::extent<decltype(fields)>::value, GarrAutoCombatantMeta::Instance(), HOTFIX_SEL_GARR_AUTO_COMBATANT);
        return &loadInfo;
    }
};

struct GarrAutoSpellLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static DB2FieldMeta const fields[] =
        {
            ...
            { true, FT_INT, "Duration" },
            { true, FT_INT, "Flags" },
            { true, FT_INT, "SchoolMask" },
            { true, FT_INT, "IconFileDataID" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::extent<decltype(fields)>::value, GarrAutoSpellMeta::Instance(), HOTFIX_SEL_GARR_AUTO_SPELL);
        return &loadInfo;
    }
};

struct GarrAutoSpellEffectLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static DB2FieldMeta const fields[] =
        {
            { false, FT_INT, "ID" },
            { true, FT_INT, "SpellID" },
            { false, FT_BYTE, "EffectIndex" },
            { true, FT_BYTE, "Effect" },
            { false, FT_FLOAT, "Points" },
            { true, FT_BYTE, "TargetType" },
            { true, FT_INT, "Flags" },
            { true, FT_INT, "Period" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::extent<decltype(fields)>::value, GarrAutoSpellEffectMeta::Instance(), HOTFIX_SEL_GARR_AUTO_SPELL_EFFECT);
        return &loadInfo;
    }
};
...
struct GarrFollowerTypeLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), GarrFollowerTypeMeta::Instance(), HOTFIX_SEL_GARR_FOLLOWER_TYPE);
        return &loadInfo;
    }
};
...
struct GarrFollowerLevelXPLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), GarrFollowerLevelXPMeta::Instance(), HOTFIX_SEL_GARR_FOLLOWER_LEVEL_X_P);
        return &loadInfo;
    }
};
...
struct GarrFollowerQualityLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), GarrFollowerQualityMeta::Instance(), HOTFIX_SEL_GARR_FOLLOWER_QUALITY);
        return &loadInfo;
    }
};
...
struct GarrTalentLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            ...
            { true, FT_INT, "Flags" },
            { true, FT_INT, "TalentType" },
            { true, FT_INT, "PrerequisiteTalentID" },
            { true, FT_INT, "ResearchCostSource" },
            { true, FT_INT, "ActiveDurationSecs" },
            { true, FT_INT, "GarrTalentSocketPropertiesID" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), GarrTalentMeta::Instance(), HOTFIX_SEL_GARR_TALENT);
        return &loadInfo;
    }
};
...
struct GroupFinderActivityLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), GroupFinderActivityMeta::Instance(), HOTFIX_SEL_GROUP_FINDER_ACTIVITY);
        return &loadInfo;
    }
};
...
struct JournalEncounterItemLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), JournalEncounterItemMeta::Instance(), HOTFIX_SEL_JOURNAL_ENCOUNTER_ITEM);
        return &loadInfo;
    }
};
...
struct LfgDungeonGroupLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), LFGDungeonGroupMeta::Instance(), HOTFIX_SEL_LFG_DUNGEON_GROUP);
        return &loadInfo;
    }
};
...
struct ManagedWorldStateLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            ...
            { false, FT_INT, "UpTimeSecs" },
            { false, FT_INT, "DownTimeSecs" },
            ...
            { true, FT_BYTE, "Field_8_1_5_29418_009" },
            { true, FT_INT, "OccurrencesWorldStateID1" },
            { true, FT_INT, "OccurrencesWorldStateID2" },
            { true, FT_INT, "OccurrencesWorldStateID3" },
            { true, FT_INT, "OccurrencesWorldStateID4" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), ManagedWorldStateMeta::Instance(), HOTFIX_SEL_MANAGED_WORLD_STATE);
        return &loadInfo;
    }
};
...
struct QuestObjectiveLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), QuestObjectiveMeta::Instance(), HOTFIX_SEL_QUEST_OBJECTIVE);
        return &loadInfo;
    }
};
...
struct QuestPOIBlobLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), QuestPOIBlobMeta::Instance(), HOTFIX_SEL_QUEST_P_O_I_BLOB);
        return &loadInfo;
    }
};
...
struct QuestPOIPointLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), QuestPOIPointMeta::Instance(), HOTFIX_SEL_QUEST_P_O_I_POINT);
        return &loadInfo;
    }
};
...
struct QuestV2CliTaskLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), QuestV2CliTaskMeta::Instance(), HOTFIX_SEL_QUEST_V2_CLI_TASK);
        return &loadInfo;
    }
};
...
struct QuestXGroupActivityLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), QuestXGroupActivityMeta::Instance(), HOTFIX_SEL_QUEST_X_GROUP_ACTIVITY);
        return &loadInfo;
    }
};
...
struct ResearchBranchLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), ResearchBranchMeta::Instance(), HOTFIX_SEL_RESEARCH_BRANCH);
        return &loadInfo;
    }
};
...
struct ResearchProjectLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), ResearchProjectMeta::Instance(), HOTFIX_SEL_RESEARCH_PROJECT);
        return &loadInfo;
    }
};
...
struct ResearchSiteLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), ResearchSiteMeta::Instance(), HOTFIX_SEL_RESEARCH_SITE);
        return &loadInfo;
    }
};
...
struct RuneforgeLegendaryAbilityLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            ...
            { true, FT_INT, "ItemBonusListID" },
            { true, FT_INT, "PlayerConditionID" },
            { true, FT_INT, "Field_9_0_1_1" },
            { true, FT_INT, "UnlockItemID" },
            { true, FT_INT, "CovenantID" },
            { true, FT_INT, "Field_9_1_0_2" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), RuneforgeLegendaryAbilityMeta::Instance(), HOTFIX_SEL_RUNEFORGE_LEGENDARY_ABILITY);
        return &loadInfo;
    }
};
...
struct SoulbindLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), SoulbindMeta::Instance(), HOTFIX_SEL_SOULBIND);
        return &loadInfo;
    }
};
...
struct SoulbindConduitLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), SoulbindConduitMeta::Instance(), HOTFIX_SEL_SOULBIND_CONDUIT);
        return &loadInfo;
    }
};

struct SoulbindConduitEnhancedSocketLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), SoulbindConduitEnhancedSocketMeta::Instance(), HOTFIX_SEL_SOULBIND_CONDUIT_ENHANCED_SOCKET);
        return &loadInfo;
    }
};
...
struct SoulbindConduitItemLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), SoulbindConduitItemMeta::Instance(), HOTFIX_SEL_SOULBIND_CONDUIT_ITEM);
        return &loadInfo;
    }
};
...
struct SoulbindConduitRankPropertiesLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), SoulbindConduitRankPropertiesMeta::Instance(), HOTFIX_SEL_SOULBIND_CONDUIT_RANK_PROPERTIES);
        return &loadInfo;
    }
};

struct SoulbindUiDisplayInfoLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            { false, FT_INT, "ID" },
            { false, FT_STRING, "Description" },
            { true, FT_INT, "SoulbindID" },
            { true, FT_INT, "CreatureDisplayInfoID" },
            { true, FT_INT, "ModelSceneActorID" },
            { true, FT_INT, "TextureKitID" },
            { true, FT_INT, "OrderIndex" },
            { true, FT_INT, "GlobalOrderIndex" },
            { true, FT_INT, "ActivationSoundKitID" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), SoulbindUIDisplayInfoMeta::Instance(), HOTFIX_SEL_SOULBIND_UI_DISPLAY_INFO);
        return &loadInfo;
    }
};
...
struct UICovenantAbilityLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            ...
            { true, FT_INT, "SpellID" },
            { true, FT_BYTE, "AbilityType" },
            { true, FT_INT, "SoulbindDisplayInfoID" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), UICovenantAbilityMeta::Instance(), HOTFIX_SEL_U_I_COVENANT_ABILITY);
        return &loadInfo;
    }
};
...
struct UiTextureAtlasLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            ...
            { false, FT_BYTE, "UiCanvasID" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), UiTextureAtlasMeta::Instance(), HOTFIX_SEL_UI_TEXTURE_ATLAS);
        return &loadInfo;
    }
};

struct UiWidgetLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            { false, FT_STRING_NOT_LOCALIZED, "WidgetTag" },
            { false, FT_INT, "ID" },
            { true, FT_INT, "ParentSetID" },
            { true, FT_INT, "VisID" },
            { true, FT_INT, "MapID" },
            { true, FT_INT, "PlayerConditionID" },
            { true, FT_INT, "OrderIndex" },
            { true, FT_BYTE, "LayoutDirection" },
            { true, FT_INT, "Field_8_2_5" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), UiWidgetMeta::Instance(), HOTFIX_SEL_UI_WIDGET);
        return &loadInfo;
    }
};

struct UiWidgetDataSourceLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            { false, FT_INT, "ID" },
            { false, FT_SHORT, "ReqID" },
            { true, FT_BYTE, "SourceType" },
            { true, FT_INT, "SourceID" },
            { false, FT_INT, "ParentWidgetID" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), UiWidgetDataSourceMeta::Instance(), HOTFIX_SEL_UI_WIDGET_DATA_SOURCE);
        return &loadInfo;
    }
};

struct UiWidgetMapLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            { false, FT_INT, "ID" },
            { true, FT_INT, "ParentWidgetID" },
            { false, FT_INT, "MapID" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), UiWidgetMapMeta::Instance(), HOTFIX_SEL_UI_WIDGET_MAP);
        return &loadInfo;
    }
};

struct UiWidgetVisualizationLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            { false, FT_INT, "ID" },
            { false, FT_STRING_NOT_LOCALIZED, "Name" },
            { false, FT_BYTE, "VisType" },
            { true, FT_INT, "TextureKit" },
            { true, FT_INT, "FrameTextureKit" },
            { true, FT_SHORT, "SizeSetting" },
            { true, FT_INT, "InAnimType" },
            { true, FT_INT, "OutAnimType" },
            { true, FT_BYTE, "WidgetScale" },
            { true, FT_INT, "ScriptedAnimationEffectID" },
            { true, FT_BYTE, "ModelSceneLayer" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), UiWidgetVisualizationMeta::Instance(), HOTFIX_SEL_UI_WIDGET_VISUALIZATION);
        return &loadInfo;
    }
};
...
struct WeeklyRewardChestThresholdLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            { false, FT_INT, "ID" },
            { true, FT_INT, "Type" },
            { true, FT_INT, "Threshold" },
            { true, FT_INT, "Index" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), WeeklyRewardChestThresholdMeta::Instance(), HOTFIX_SEL_WEEKLY_REWARD_CHEST_THRESHOLD);
        return &loadInfo;
    }
};
...
struct WindSettingsLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), WindSettingsMeta::Instance(), HOTFIX_SEL_WIND_SETTINGS);
        return &loadInfo;
    }
};
...
struct VignetteLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), VignetteMeta::Instance(), HOTFIX_SEL_VIGNETTE);
        return &loadInfo;
    }
};
...
struct WmoMinimapTextureLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), WMOMinimapTextureMeta::Instance(), HOTFIX_SEL_WMO_MINIMAP_TEXTURE);
        return &loadInfo;
    }
};

struct WorldPvpAreaLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), World_PVP_AreaMeta::Instance(), HOTFIX_SEL_WORLD_PVP_AREA);
        return &loadInfo;
    }
};
...
struct WorldBossLockoutLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), WorldBossLockoutMeta::Instance(), HOTFIX_SEL_WORLD_BOSS_LOCKOUT);
        return &loadInfo;
    }
};
...
struct WorldChunkSoundsLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            { false, FT_INT, "ID" },
            { false, FT_SHORT, "MapID" },
            { true, FT_INT, "SoundOverrideID" },
            { false, FT_BYTE, "ChunkX" },
            { false, FT_BYTE, "ChunkY" },
            { false, FT_BYTE, "SubChunkX" },
            { false, FT_BYTE, "SubChunkY" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), WorldChunkSoundsMeta::Instance(), HOTFIX_SEL_WORLD_CHUNK_SOUNDS);
        return &loadInfo;
    }
};
...
struct WorldElapsedTimerLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), WorldElapsedTimerMeta::Instance(), HOTFIX_SEL_WORLD_ELAPSED_TIMER);
        return &loadInfo;
    }
};

struct WorldMapOverlayTileLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            { false, FT_INT, "ID" },
            { false, FT_BYTE, "RowIndex" },
            { false, FT_BYTE, "ColIndex" },
            { false, FT_BYTE, "LayerIndex" },
            { true, FT_INT, "FileDataID" },
            { false, FT_INT, "WorldMapOverlayID" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), WorldMapOverlayTileMeta::Instance(), HOTFIX_SEL_WORLD_MAP_OVERLAY_TILE);
        return &loadInfo;
    }
};
...
struct CharShipmentLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), CharShipmentMeta::Instance(), HOTFIX_SEL_CHAR_SHIPMENT);
        return &loadInfo;
    }
};
...
struct WorldStateZoneSoundsLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), WorldStateZoneSoundsMeta::Instance(), HOTFIX_SEL_WORLD_STATE_ZONE_SOUNDS);
        return &loadInfo;
    }
};
...
struct ZoneIntroMusicTableLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), ZoneIntroMusicTableMeta::Instance(), HOTFIX_SEL_ZONE_INTRO_MUSIC_TABLE);
        return &loadInfo;
    }
};
...
struct ZoneLightLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            ...
            { false, FT_FLOAT, "Zmin" },
            { false, FT_FLOAT, "Zmax" },
            { true, FT_INT, "TransitionType" },
            { true, FT_INT, "PlayerConditionID" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), ZoneLightMeta::Instance(), HOTFIX_SEL_ZONE_LIGHT);
        return &loadInfo;
    }
};
...
struct ZoneLightPointLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            ...
            { false, FT_INT, "ZoneLightID" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), ZoneLightPointMeta::Instance(), HOTFIX_SEL_ZONE_LIGHT_POINT);
        return &loadInfo;
    }
};
...
struct ZoneMusicLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), ZoneMusicMeta::Instance(), HOTFIX_SEL_ZONE_MUSIC);
        return &loadInfo;
    }
};
...
struct ZoneStoryLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::size(fields), ZoneStoryMeta::Instance(), HOTFIX_SEL_ZONE_STORY);
        return &loadInfo;
    }
};
