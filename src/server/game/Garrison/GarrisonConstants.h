...
enum GarrisonSite
{
    ...
    GARRISON_SITE_COVENANT_CAMPAIGN_ALLIANCE  = 296,
    GARRISON_SITE_COVENANT_CAMPAIGN_HORDE = 299,
};
...
enum GarrisonType : int32
{
    ...
    GARRISON_TYPE_MAX = GARRISON_TYPE_COVENANT + 1,
};
...
namespace GarrisonMission
{
    ...
    enum Type
    {
        ...
        WarCampagnTreasureMap = 185,
        HollidayMission       = 186,
        DeepSea               = 187,
        AzeriteEssenceTreasure = 188,
        CovenantMaldraxxus     = 189,
        CovenantArdenweald     = 190,
        CovenantRevendreth     = 191,
        CovenantBastion        = 192,
        CovenantTazavesh       = 193,
        CovenantMawAssault     = 194,
        CovenantEncounterTreasure = 195,
        CovenantZerethMorthis   = 196,
    };
