...
bool CriteriaData::IsValid(Criteria const* criteria)
{
    ...
    {
        TC_LOG_DEBUG("sql.sql", "Table `criteria_data` for criteria (Entry: {}) contains a wrong data type ({}), ignored.", criteria->ID, DataType);
        return false;
    }
    ...
    default:
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` contains data for a non-supported criteria type (Entry: {} Type: {}), ignored.", criteria->ID, criteria->Entry->Type);
            return false;
        }
        break;
    }
    ...
    case CRITERIA_DATA_TYPE_T_CREATURE:
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_CREATURE ({}) contains a non-existing creature id in value1 ({}), ignored.",
    ...
    case CRITERIA_DATA_TYPE_T_PLAYER_CLASS_RACE:
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_T_PLAYER_CLASS_RACE ({}) must not have 0 in either value field, ignored.",
                criteria->ID, criteria->Entry->Type, DataType);
            return false;
        }
        if (ClassRace.Class && ((1 << (ClassRace.Class - 1)) & CLASSMASK_ALL_PLAYABLE) == 0)
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_T_PLAYER_CLASS_RACE ({}) contains a non-existing class in value1 ({}), ignored.",
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_T_PLAYER_CLASS_RACE ({}) contains a non-existing race in value2 ({}), ignored.",
    ...
    case CRITERIA_DATA_TYPE_T_PLAYER_LESS_HEALTH:
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_PLAYER_LESS_HEALTH ({}) contains a wrong percent value in value1 ({}), ignored.",
    ...
    case CRITERIA_DATA_TYPE_T_AURA:
    {
        ...
        if (!spellEntry)
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type {} ({}) contains a wrong spell id in value1 ({}), ignored.",
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type {} ({}) contains a wrong spell effect index in value2 ({}), ignored.",
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type {} ({}) contains a non-aura spell effect (ID: {} Effect: {}), ignored.",
    ...
    case CRITERIA_DATA_TYPE_VALUE:
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_VALUE ({}) contains a wrong ComparisionType in value2 ({}), ignored.",
    ...
    case CRITERIA_DATA_TYPE_T_LEVEL:
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `CRITERIA_DATA` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_T_LEVEL ({}) contains a wrong minlevel in value1 ({}), ignored.",
    ...
    case CRITERIA_DATA_TYPE_T_GENDER:
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_T_GENDER ({}) contains a wrong gender value in value1 ({}), ignored.",
    ...
    case CRITERIA_DATA_TYPE_SCRIPT:
        if (!ScriptId)
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_SCRIPT ({}) does not have a ScriptName set, ignored.",
                criteria->ID, criteria->Entry->Type, DataType);
            return false;
        }
        return true;
    case CRITERIA_DATA_TYPE_MAP_PLAYER_COUNT:
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_MAP_PLAYER_COUNT ({}) contains a wrong max players count in value1 ({}), ignored.",
    ...
    case CRITERIA_DATA_TYPE_T_TEAM:
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_T_TEAM ({}) contains an unknown team value in value1 ({}), ignored.",
    ...
    case CRITERIA_DATA_TYPE_S_DRUNK:
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_S_DRUNK ({}) contains an unknown drunken state value in value1 ({}), ignored.",
    ...
    case CRITERIA_DATA_TYPE_HOLIDAY:
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_HOLIDAY ({}) contains an unknown holiday entry in value1 ({}), ignored.",
    ...
    case CRITERIA_DATA_TYPE_GAME_EVENT:
    {
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_GAME_EVENT ({}) has unknown game_event in value1 ({}), ignored.",
    ...
    case CRITERIA_DATA_TYPE_S_EQUIPPED_ITEM:
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_S_EQUIPPED_ITEM ({}) contains an unknown quality state value in value2 ({}), ignored.",
    ...
    case CRITERIA_DATA_TYPE_MAP_ID:
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_MAP_ID ({}) contains an unknown map entry in value1 ({}), ignored.",
    ...
    case CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE:
        if (!ClassRace.Class && !ClassRace.Race)
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE ({}) should not have 0 in either value field. Ignored.",
                criteria->ID, criteria->Entry->Type, DataType);
            return false;
        }
        if (ClassRace.Class && ((1 << (ClassRace.Class - 1)) & CLASSMASK_ALL_PLAYABLE) == 0)
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE ({}) contains a non-existing class entry in value1 ({}), ignored.",
                criteria->ID, criteria->Entry->Type, DataType, ClassRace.Class);
            return false;
        }
        if (ClassRace.Race && !RACEMASK_ALL_PLAYABLE.HasRace(ClassRace.Race))
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE ({}) contains a non-existing race entry in value2 ({}), ignored.",
                criteria->ID, criteria->Entry->Type, DataType, ClassRace.Race);
            return false;
        }
        return true;
    case CRITERIA_DATA_TYPE_S_KNOWN_TITLE:
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_S_KNOWN_TITLE ({}) contains an unknown title_id in value1 ({}), ignore.",
    ...
    case CRITERIA_DATA_TYPE_S_ITEM_QUALITY:
        ...
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) for data type CRITERIA_DATA_TYPE_S_ITEM_QUALITY ({}) contains an unknown quality state value in value1 ({}), ignored.",
                criteria->ID, criteria->Entry->Type, DataType, ItemQuality.Quality);
            return false;
        }
        return true;
    default:
        TC_LOG_DEBUG("sql.sql", "Table `criteria_data` (Entry: {} Type: {}) contains data of a non-supported data type ({}), ignored.", criteria->ID, criteria->Entry->Type, DataType);
        return false;
    }
}
...
bool CriteriaData::Meets(uint32 criteriaId, Player const* source, WorldObject const* target, uint32 miscValue1 /*= 0*/, uint32 miscValue2 /*= 0*/) const
{
    ...
    case CRITERIA_DATA_TYPE_INSTANCE_SCRIPT:
    {
        ...
        if (!map->IsDungeon())
        {
            TC_LOG_DEBUG("criteria", "Criteria system call CRITERIA_DATA_TYPE_INSTANCE_SCRIPT ({}) for criteria {} in a non-dungeon/non-raid map {}",
        ...
        if (!instance)
        {
            TC_LOG_DEBUG("criteria", "Criteria system call CRITERIA_DATA_TYPE_INSTANCE_SCRIPT ({}) for criteria {} in map {}, but the map does not have an instance script.",
                DataType, criteriaId, map->GetId());
            return false;
        }
    ...
    for (Criteria const* criteria : criteriaList)
    {
        ...
        for (CriteriaTree const* tree : *trees)
        {
            while (tree)
            {
                ...
                tree = sCriteriaMgr->GetCriteriaTree(tree->Entry->Parent);
            }
        }
    }
}
...
bool CriteriaHandler::ModifierSatisfied(ModifierTreeEntry const* modifier, uint64 miscValue1, uint64 miscValue2, WorldObject const* ref, Player* referencePlayer) const
{
    ...
    {
        Garrison const* garrison = referencePlayer->GetGarrison(GARRISON_TYPE_GARRISON);
...
void CriteriaMgr::LoadCriteriaList()
{
    ...
    {
        ASSERT(criteriaEntry->Type < uint8(CriteriaType::Count), "CRITERIA_TYPE_TOTAL must be greater than or equal to {} but is currently equal to {}",
            criteriaEntry->Type + 1, uint32(CriteriaType::Count));
        ASSERT(criteriaEntry->StartEvent < uint8(CriteriaStartEvent::Count), "CriteriaStartEvent::Count must be greater than or equal to {} but is currently equal to {}",
            criteriaEntry->StartEvent + 1, uint32(CriteriaStartEvent::Count));
        ASSERT(criteriaEntry->FailEvent < uint8(CriteriaFailEvent::Count), "CriteriaFailEvent::Count must be greater than or equal to {} but is currently equal to {}",
...
void CriteriaMgr::LoadCriteriaData()
{
    ...
    do
    {
        ...
        if (!criteria)
        {
            TC_LOG_DEBUG("sql.sql", "Table `criteria_data` contains data for non-existing criteria (Entry: {}). Ignored.", criteria_id);
            continue;
        }
        ...
        {
            if (dataType != CRITERIA_DATA_TYPE_SCRIPT)
                TC_LOG_DEBUG("sql.sql", "Table `criteria_data` contains a ScriptName for non-scripted data type (Entry: {}, type {}), useless data.", criteria_id, dataType);
            else
